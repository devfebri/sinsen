...
class CustomPenyerahanBPKB extends FPDF{
...

{
    ...
    $this->Cell(60, 5, ': PENYERAHAN BPKB HONDA', 0, 0);
    ...
    $this->Multicell(190,6,'Dengan ini kami serahkan kepada Bapak/Ibu, BPKB HONDA penjualan '.$nama_dealer.' sebanyak '.$lamp.' buku dengan keterangan sbb :',0);
...
{    
    ...
    $this->Cell(65,6,'(Admin BPKB)',0,0,'C');
...
public function getInstance(){
    ...
    return new CustomPenyerahanBPKB();
