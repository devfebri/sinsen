  ...
  <section class="content">
    <div class="box box-default">
      <div class="box-header with-border">        
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" id="frm" method="post" action= "h2/h2_md_report_h23/downloadExcel" enctype="multipart/form-data">
              <div class="box-body">                                                              
                  ...
                  <div class="col-sm-4">
                    <select class="form-control select2" name="type" id="type">
                      ...
                      <optgroup label="Data Revenue">
                        ...
                        <option value="peformance_fd_sa">Data Detail Peformance Frontdesk & SA</option>
                      ...
                      <optgroup label="Data Mekanik">
                        ...
                        <option value="insentif_mekanik">Data Insentif Mekanik</option>
                      </optgroup>
