...
header("Content-Disposition: attachment; filename=Reporting H23 Detail Revenue Parts dan Oli Main Dealer_".$no." WIB.xls");
...
<table>
	<tr>
		<caption><b>Reporting H23 Data Detail Revenue Parts dan Oli AHASS Main Dealer <?php echo $start_date." s/d ".$end_date?> - <?php echo date('H:i')?> WIB<b></caption>
		<td colspan="17"></td>
	</tr>
</table>
