...
header("Content-Disposition: attachment; filename=Reporting H23 Per SA Main Dealer_".$no." WIB.xls");
header("Pragma: no-cache");
header("Expires: 0");
?>

<h4><b>Reporting H23 Per SA Main Dealer <?php echo $start_date." s/d ".$end_date?> - <?php echo date('H:i')?> WIB</b></h4>
...
$filter_dealer = '';
			...
			LEFT JOIN ms_karyawan_dealer i on c.created_by = i.id_karyawan_dealer
 		...
 		echo "
 			<tr>
 				<td>$nom</td>
 				<td>$row->id_sa_flp - $row->nama_sa</td>
