  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">            
            <form class="form-horizontal" action="h1/terima_stnk/save" method="post" enctype="multipart/form-data">              
              <div class="box-body">                                 
                <div>
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">            
            <form class="form-horizontal" action="h1/terima_stnk/save" method="post" enctype="multipart/form-data">              
              <input type="hidden" name="no_kirim_stnk" value="<?php echo $no_kirim_stnk ?>">
              <div class="box-body">                                 
                <div>
                  <table id="example2" class="table table-bordered table-hover">
                    <thead>
                        ...
                        echo "
                          <tr>
                            ...
                            <td>
                              ...
                              <input class='data-check' type='checkbox' name='cek_stnk_$no' $cek>
                            </td>
                          </tr>
                        ";
                        $no++;
      ...
      <div class="box-body">
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          foreach($dt_stnk->result() as $row) { 
            $jum = $this->db->query("SELECT COUNT(no_stnk) AS jum FROM tr_kirim_stnk_detail WHERE no_kirim_stnk = '$row->no_kirim_stnk'")->row();                                        
            $cek = $this->m_admin->getByID("tr_kirim_stnk_detail","no_kirim_stnk",$row->no_kirim_stnk);
            $tomb='';$arr=array();
          ...
          echo "          
            <tr>
              <td>$no</td>
              <td>
                <a href='h1/terima_stnk/detail?id=$row->no_kirim_stnk'>
                  $row->no_kirim_stnk
                </a>
              </td>
              <td>$row->tgl_kirim_stnk</td>                                         
              <td>$tgl_awal s/d $tgl_akhir</td>                                         
              <td>$jum->jum item</td>              
              <td>$row->status_stnk</td>              
              <td>$tomb</td>";                                      
          $no++;
          }
          ?>
	...
	<script type="text/javascript">
              $(document).ready(function(e){
                ...
                $('#datatable').DataTable({
                   ...
                   "ajax":{
                            url :  base_url+'h1/terima_stnk/getAllData',
                            type : 'POST'
                          },
                }); // End of DataTable
              }); 
