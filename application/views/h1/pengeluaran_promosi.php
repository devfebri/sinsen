  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">            
            <form class="form-horizontal" action="h1/pengeluaran_promosi/save" method="post" enctype="multipart/form-data">              
              <div class="box-body">       
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">
          <a href="h1/pengeluaran_promosi/add">            
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          echo "          
            <tr>
              ...
              <td align='center'>
                <a href='h1/pengeluaran_promosi/edit?id=$row->id_pengeluaran_promosi' $edit type='button' class='btn btn-flat btn-warning btn-xs'><i class='fa fa-edit'></i> Edit</a>                
              </td>";                                      
           $no++;
           }
          ?>
    ...
    ?>
    <body onload="getDetail(<?=$row->id_pengeluaran_promosi?>)">
    <div class="box box-default">
      <div class="box-header with-border">
        <h3 class="box-title">
          <a href="h1/pengeluaran_promosi">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">            
            <form class="form-horizontal" action="h1/pengeluaran_promosi/save_edit" method="post" enctype="multipart/form-data">   
            <input type="hidden" name="id_pengeluaran_promosi" value="<?= $row->id_pengeluaran_promosi?>">           
              <div class="box-body">       
                <div class="form-group">                  
                  <label for="inputEmail3" class="col-sm-2 control-label">No DO</label>
                  <div class="col-sm-4">
  ...
  function getDetail(a)
{
  ...
  $.ajax({
       ...
       url:"<?php echo site_url('h1/pengeluaran_promosi/getDetail')?>",
       type:"POST",
       data:value,
       cache:false,
