  ...
  <section class="content">
    ...
    <div class="box box-default">
      <div class="box-header with-border">
        <h3 class="box-title">
          <a href="h1/claim_proposal_dealer">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="h1/claim_proposal_dealer/save_approval" method="post" enctype="multipart/form-data">
              <div class="box-body">                    
                <div class="form-group">
                  <input type="hidden" name="id_claim" value="<?php echo $row->id_claim ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <div class="input-group date">
                      ...
                      <input type="text" class="form-control pull-right" disabled <?php if($row->ahm=='on') echo "value='$row->ahm_text'" ?> name="ahm_text">
                    </div>
                    <div class="input-group date">
                      <div class="input-group-addon">
                        <input type="checkbox" <?php if($row->md=='on') echo 'checked' ?> disabled name="md"> MD
                      </div>
                      <input type="text" class="form-control pull-right" disabled <?php if($row->md=='on') echo " value='$row->md_text'" ?> name="md_text">
                    </div>
                    <div class="input-group date">
                      <div class="input-group-addon">
                        <input type="checkbox" <?php if($row->dealer=='on') echo 'checked' ?> disabled name="dealer"> Dealer
                      </div>
                      <input type="text" class="form-control pull-right" disabled <?php if($row->dealer=='on') echo " value='$row->dealer_text'" ?> name="dealer_text">
                    </div>
                    <div class="input-group date">
                      <div class="input-group-addon">
                        <input type="checkbox" <?php if($row->lainnya=='on') echo 'checked' ?> disabled name="lainnya"> Lainnya
                      </div>
                      <input type="text" disabled <?php if($row->lainnya=='on') echo " value='$row->lainnya_text'" ?> class="form-control pull-right" name="lainnya_text">
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    $file='';
                    if($row->file_lpj != ''){
                      $file = "<a target='_blank' href='assets/panel/files/$row->file_lpj' class='btn btn-flat btn-primary btn-sm'><i class='fa fa-download'></i> Download File</a>"; 
                    }
                    echo $file;
                    ?>
                 </div>                  
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="h1/claim_proposal_dealer/save_reject" method="post" enctype="multipart/form-data">
              <div class="box-body">                    
                <div class="form-group">
                  <input type="hidden" name="id_claim" value="<?php echo $row->id_claim ?>">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nama Program</label>
          ...
          foreach($dt_claim->result() as $row) {                                         
            ...
            if($row->status_claim != 'approved'){
              ...
              <tr>
                ...
                <td>$status</td>                                          
                <td>
                    <a $akses href='h1/claim_proposal_dealer/approve?id=$row->id_proposal' class='btn btn-primary btn-flat btn-xs'>Approve</a>
                    <a $akses href='h1/claim_proposal_dealer/reject?id=$row->id_proposal' class='btn btn-danger btn-flat btn-xs'>Reject</a>                  
                </td>                                         
                ";                                      
              $no++;
            }
