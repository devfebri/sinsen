  ...
  <section class="content">    
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div id="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="h1/ssu_md/save" method="post" enctype="multipart/form-data">
              <div class="box-body">              
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">ID List Appointment</label>
                  <div class="col-sm-4">
                    <input type="text"  class="form-control" id="id_list_appointment" readonly placeholder="ID List Appointment" name="id_list_appointment">                    
                  </div>
                ...
                <div class="form-group">                  
                  ...
                  <div class="col-sm-4">
                    <select class="form-control" name="jenis_pembelian">
                      ...
                      <option>Join Promo</option>
                      <option>Grup Perusahaan</option>
                    </select>
                  </div>                
                  <label for="inputEmail3" class="col-sm-2 control-label">Tgl Surat Jalan</label>
                  <div class="col-sm-4">
                    <input type="text"  class="form-control" id="tanggal" placeholder="Tgl Surat Jalan" name="tgl_surat_jalan">                    
                  </div>
                </div>
                ...
                <div class="form-group">                  
                  <label for="inputEmail3" class="col-sm-2 control-label">ID KTP</label>
                  <div class="col-sm-4">
                    <input type="text"  class="form-control" placeholder="ID KTP" name="id_ktp">                    
                  </div>
                ...
                <div class="form-group">                                    
                  ...
                  <div class="col-sm-4">
                    <select class="form-control select2" name="id_kelurahan" id="id_kelurahan" onchange="cek_kecamatan()">
                      <option value="">- choose -</option> 
                      <?php                       
                ...
                <div class="form-group">                                    
                  ...
                  <div class="col-sm-4">
                    <select class="form-control" name="status_ssu">
                      <option value="">- choose -</option>
                      <option>Lunas</option>                      
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div id="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="h1/ssu_md/update" method="post" enctype="multipart/form-data">
              <div class="box-body">              
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">ID List Appointment</label>
                  <div class="col-sm-4">
                ...
                <div class="form-group">                  
                  ...
                  <label for="inputEmail3" class="col-sm-2 control-label">Tgl Surat Jalan</label>
                  <div class="col-sm-4">
                    <input type="text"  class="form-control" id="tanggal" value="<?php echo $row->tgl_surat_jalan ?>" placeholder="Tgl Surat Jalan" name="tgl_surat_jalan">                    
                  </div>
                </div>
                ...
                <div class="form-group">                  
                  <label for="inputEmail3" class="col-sm-2 control-label">ID KTP</label>
                  <div class="col-sm-4">                    
                    <input type="text" class="form-control" value="<?php echo $row->id_ktp ?>" placeholder="ID KTP" name="id_ktp">                    
                  </div>
                  <label for="inputEmail3" class="col-sm-2 control-label">Pengeluaran 1 Bulan</label>
                  <div class="col-sm-4">
                    <select class="form-control" name="pengeluaran_bulan">
                ...
                <div class="form-group">                                    
                  ...
                  <div class="col-sm-4">
                    <select class="form-control select2" name="id_kelurahan" id="id_kelurahan" onchange="cek_kecamatan()">
                      ...
                      <?php 
                      $dt_kelurahan = $this->db->query("SELECT * FROM ms_kelurahan WHERE id_kelurahan != '$row->id_kelurahan'");                                                
                      foreach ($dt_kelurahan->result() as $isi) {
                        echo "<option value='$isi->id_kelurahan'>$isi->kelurahan</option>";
                      }
                      ?>                     
                ...
                <div class="form-group">                                    
                  ...
                  <div class="col-sm-4">
                    <select class="form-control" name="id_karyawan_dealer">
                      ...
                      <?php 
                      $dt_karyawan_dealer = $this->m_admin->kondisiCond("ms_karyawan_dealer","id_karyawan_dealer != '$row->id_karyawan_dealer'");                                                
                      foreach ($dt_karyawan_dealer->result() as $isi) {
                          echo "<option value='$isi->id_karyawan_dealer'>$isi->id_karyawan_dealer</option>";
                        }
                       ?>                                                                  
                ...
                <div class="form-group">                                    
                  ...
                  <div class="col-sm-4">
                    <select class="form-control" name="status_ssu">
                      <option value="<?php echo $row->status_ssu ?>"><?php echo $row->status_ssu ?></option>
                      <option>Lunas</option>                      
                      <option>Belum Lunas</option>
                    </select> 
                  </div>
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <table id="example4" class="table table-bordered table-hover">
          ...
          <?php 
          $no=1; 
          foreach($dt_ssu_konsumen->result() as $row) {                 
            echo "
            <tr>
              <td>$no</td>
              ...
              <td>$row->no_telp</td>                                                                    
              <td>                                
                <a href='h1/ssu_md/edit?id=$row->id_list_appointment'>
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          foreach ($dt_item->result() as $ve2) {
            ...
            <tr>
              ...
              ?>
              <td class="center">
                <button title="Choose" data-dismiss="modal" onclick="chooseitem('<?php echo $ve2->no_mesin; ?>','<?php echo $ve2->no_rangka; ?>','<?php echo $ve2->id_item; ?>')" class="btn btn-flat btn-success btn-sm"><i class="fa fa-check"></i></button>                 
              </td>           
            </tr>
            <?php
            $no++;
...
function auto(){
  ...
  $.ajax({
      url : "<?php echo site_url('h1/ssu_md/cari_id')?>",
      type:"POST",
      data:"tgl="+tgl_js,   
      cache:false,   
  ...
  if (window.XMLHttpRequest) { // Mozilla, Safari, ...
   ...
   //var data = "birthday1="+birthday1_js;          
    var data = "id_list_appointment="+id_list_appointment;                           
     xhr.open("POST", "h1/ssu_md/t_keluarga", true); 
...
function kirim_data_kendaraan(){    
  ...
  if (window.XMLHttpRequest) { // Mozilla, Safari, ...
   ...
   //var data = "birthday1="+birthday1_js;          
    var data = "id_list_appointment="+id_list_appointment;                           
     xhr.open("POST", "h1/ssu_md/t_kendaraan", true); 
     xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");                  
     xhr.send(data);
     xhr.onreadystatechange = display_data;
     function display_data() {
...
function chooseitem(no_mesin,no_rangka,id_item){
...
function simpan_kendaraan(){
  ...
  if (no_mesin == "" || id_list_appointment == "") {    
      ...
      $.ajax({
          url : "<?php echo site_url('h1/ssu_md/save_kendaraan')?>",
          type:"POST",
...
function hapus_kendaraan(a,b){ 
    ...
    var id_ssu_kendaraan  = b;       
    $.ajax({
        url : "<?php echo site_url('h1/ssu_md/delete_kendaraan')?>",
        type:"POST",
        data:"id_ssu_kendaraan="+id_ssu_kendaraan+"&id_list_appointment="+id_list_appointment,
        cache:false,
        success:function(msg){            
            data=msg.split("|");
            if(data[0]=="nihil"){
...
function cek_kecamatan(){
  ...
  $.ajax({
      url: "<?php echo site_url('h1/ssu_md/cek_kecamatan')?>",
      type:"POST",
...
function simpan_keluarga(){  
  ...
  if (nik == "" || id_list_appointment == "") {    
      ...
      $.ajax({
          url : "<?php echo site_url('h1/ssu_md/save_keluarga')?>",
          type:"POST",
...
function hapus_keluarga(a,b){ 
    var id_list_appointment  = a;       
    var id_ssu_keluarga  = b;       
    $.ajax({
        url : "<?php echo site_url('h1/ssu_md/delete_keluarga')?>",
        type:"POST",
        data:"id_ssu_keluarga="+id_ssu_keluarga+"&id_list_appointment="+id_list_appointment,
        cache:false,
        success:function(msg){            
            data=msg.split("|");
            if(data[0]=="nihil"){
