  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="h1/ustk/create_fix" method="post" enctype="multipart/form-data">
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <div class="col-sm-10">
                  <button type="submit" onclick="return confirm('Are you sure to create this data?')" name="process" value="edit" class="btn btn-info btn-flat"><i class="fa fa-edit"></i> Create File .USTK dan .CDB</button>                                  
                </div>
              </div><!-- /.box-footer -->
            </form>
          </div>
        ...
        <table id="example4" class="table table-bordered table-hover">
          ...
          echo "          
            <tr>
              ...
              <td>$row->nama_file</td>              
              <td>
                <a href='h1/ustk/download?id=$row->id_ustk' class='btn btn-primary btn-flat btn-sm'><i class='fa fa-download'></i> Download</button>
              </td>              
            </tr>";                        
          $no++;
          }
  ...
  if (window.XMLHttpRequest) { // Mozilla, Safari, ...
   ...
   //var data = "birthday1="+birthday1_js;          
    var data = "start_date="+start_date+"&end_date="+end_date;                           
     xhr.open("POST", "h1/ustk/t_detail", true); 
     ...
     function display_data() {
        if (xhr.readyState == 4) {
            if (xhr.status == 200) {       
                document.getElementById("tampil_ustk").innerHTML = xhr.responseText;                
            }else{
