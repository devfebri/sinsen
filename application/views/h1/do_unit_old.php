              ...
              <div class="box-body">                          
                ...
                <table id="example2" class="table myTable1 table-bordered table-hover">
                  ...
                  foreach($dt_do_reg->result() as $row) {           
                    ...
                    //   AND tr_quotation_tipe.id_tipe_kendaraan = '$row->id_tipe_kendaraan'");
                    ...
                    // cek scp                    
                    // $cek_scp = $this->db->query("SELECT ahm_kredit+dealer_kredit+other_kredit+md_kredit AS nilai FROM tr_sales_program INNER JOIN tr_sales_program_dealer ON tr_sales_program.id_program_md = tr_sales_program_dealer.id_program_md
                    ...
                    //   WHERE '$row->tgl_do' BETWEEN tr_sales_program.periode_awal AND tr_sales_program.periode_akhir
                    //   AND ms_jenis_sales_program.jenis_sales_program = 'SCP' AND tr_sales_program_dealer.id_dealer = '$row->id_dealer'
                    //   AND tr_sales_program_tipe.id_tipe_kendaraan = '$row->id_tipe_kendaraan' AND FIND_IN_SET('$row->id_warna',tr_sales_program_tipe.id_warna)");
                    // $n=0;
        ...
        <table id="example4" class="table table-bordered table-hover">
          ...
          echo "          
            <tr>
              ...
              <td>$row->tgl_do</td>
              <td align='right'>".mata_uang($harga)."</td>              
              <td>$unit</td>              
              <td>$status</td>              
              <td>";
              if($row->status=='input'){
