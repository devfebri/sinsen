            ...
            <form class="form-horizontal" action="h1/pengajuan_bbn_md/update" method="post" enctype="multipart/form-data">              
              <div class="box-body">       
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="Nama Gadis Ibu Kandung" value="<?php echo isset($row->nama_ibu)?strtoupper($row->nama_ibu):'-'; ?>" name="nama_ibu">                                        
                  </div>
                  <label for="inputEmail3" class="col-sm-2 control-label">Tgl Lahir Ibu Kandung</label>
                  <div class="col-sm-4">
                    <input id="tanggal3" type="text" class="form-control" placeholder="Tgl Lahir Ibu Kandung" value="<?php echo isset($row->tgl_ibu)?$row->tgl_ibu:'-'; ?>" name="tgl_ibu">                                        
                  </div>
                </div>
                <div class="form-group">
