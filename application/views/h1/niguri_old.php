                    ...
                    <tbody>                      
                      <tr>
                        <td width="7%" rowspan="4">
                          ...
                          <input id="id_tipe_kendaraan" readonly type="text" onclick="tampil_id()" name="id_tipe_kendaraan" class="form-control isi" placeholder="ID Tipe">
                        </td>
          ...
          echo "          
            <tr>
              ...
              ?>
                ...
                <a data-toggle='tooltip' title="Edit Data" class='btn btn-primary btn-sm btn-flat' href='h1/niguri/edit?id=<?php echo $row->id_niguri ?>&v=e'><i class='fa fa-edit'></i></a>
              </td>
            </tr>
          <?php
          $no++;
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table id="example2" class="table table-bordered table-hover">
          ...
          <?php          
          $no = 1; 
          $dt_tipe = $this->db->query("SELECT DISTINCT(ms_tipe_kendaraan.id_tipe_kendaraan),ms_tipe_kendaraan.tipe_ahm,ms_tipe_kendaraan.deskripsi_ahm FROM ms_tipe_kendaraan INNER JOIN ms_item ON ms_tipe_kendaraan.id_tipe_kendaraan=ms_item.id_tipe_kendaraan 
            WHERE ms_tipe_kendaraan.active = 1");           
          foreach ($dt_tipe->result() as $ve2) {
            echo "
            <tr>
              <td>$no</td>
...
function cek_niguri(){  
  ...
  $.ajax({
    ...
    type:"POST",
    data:"id_niguri="+id_niguri+"&tahun="+tahun+"&bulan="+bulan+"&id_tipe_kendaraan="+id_tipe_kendaraan,
    cache:false,
    success:function(msg){
      data = msg.split("|");
      if(data[0] == "ok"){
...
function save_niguri(){
    ...
    //alert(active);
    if (id_niguri=="" || id_tipe_kendaraan=="") {    
        ...
        $.ajax({
            ...
            type:"POST",
            data:"id_niguri="+id_niguri+"&id_tipe_kendaraan="+id_tipe_kendaraan+"&a_m1="+a_m1+"&a_m="+a_m+"&a_fix="+a_fix+"&a_t1="+a_t1+"&a_t2="+a_t2+
