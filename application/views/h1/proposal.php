          ...
          <div class="col-md-12">
              <div class="box-body">    
                ...
                <table class="table" style="width: 60%">
                  ...
                  <tr>
                    <td><b>Sumber Dana</b></td><td>:</td><td><?php echo $row->sumber_dana ?></td>
                  </tr>
                  <tr>
                ...
                <table class="table" style="width: 60%">
                  <tr>
                    <td>Leasing</td><td>:</td>
                    <td>
                      <?php if ($row->id_leasing_pendukung!=null) {
                        $leasing = $this->db->query("SELECT GROUP_CONCAT(finance_company) as leasing  FROM ms_finance_company where id_finance_company in($row->id_leasing_pendukung)")->row()->leasing;
                        echo $leasing;
                      }
                       ?>
                    </td>
      ...
      <div class="box-body">
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          foreach($dt_proposal->result() as $row) {         
            ...
            <tr>
              <td>$no</td>
              <td>Motor Sejuta Umat</td>
              <td>Pemberian diskon besar-besaran untuk konsumen</td>
              <td>12-01-2018</td>
              <td>12-04-2018</td>                            
              <td>Langsung</td>              
              <td>                
                <a href='dealer/proposal/ajukan?id=19'>
                  <button class='btn btn-flat btn-xs btn-success'><i class='fa fa-print'></i> Cetak Proposal</button>                
                </a>                
                <a href='dealer/proposal/ajukan?id=19'>
                  <button class='btn btn-flat btn-xs btn-primary'><i class='fa fa-print'></i> Cetak PO</button>                
                </a>                
              </td>
            </tr>
            ";*/
