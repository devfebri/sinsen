  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">            
            <form class="form-horizontal" id="myForm" action="h1/penyerahan_stnk/save" method="post" enctype="multipart/form-data">              
              <div class="box-body">       
                <br>
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">            
            <form class="form-horizontal" action="h1/penyerahan_stnk/save" method="post" enctype="multipart/form-data">              
              <div class="box-body">       
                <br>
                <div class="form-group">                  
                  <label for="inputEmail3" class="col-sm-2 control-label">Tgl Serah Terima</label>
                  ...
                  <table id="example2" class="table myTable1 table-bordered table-hover">
                    ...
                    <tbody>                    
                      ...
                      foreach($dt_b->result() as $isi) {                             
                        $rt = $this->db->query("SELECT tr_terima_bj.*,tr_pengajuan_bbn_detail.id_tipe_kendaraan, tr_pengajuan_bbn_detail.nama_konsumen,tr_pengajuan_bbn_detail.no_rangka,
                            tr_pengajuan_bbn_detail.tahun,tr_pengajuan_bbn.id_dealer,ms_tipe_kendaraan.deskripsi_ahm FROM tr_terima_bj 
                            RIGHT JOIN tr_pengajuan_bbn_detail ON tr_terima_bj.no_mesin = tr_pengajuan_bbn_detail.no_mesin
                            ...
                            WHERE tr_pengajuan_bbn_detail.no_mesin = '$isi->no_mesin'")->row();
                        echo "
                        <tr>                     
                          <td>$isi->no_mesin</td> 
                          <td>$rt->no_rangka</td> 
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        ?>
        <table id="table_penyerahan_stnk" class="table table-bordered table-hover">
          <thead>
            <tr>
            <th width="5%">No</th>                          
  ...
  if (window.XMLHttpRequest) { // Mozilla, Safari, ...
   ...
   //var data = "birthday1="+birthday1_js;          
    var data = "id_dealer="+id_dealer;
     xhr.open("POST", "h1/penyerahan_stnk/t_stnk", true); 
...
function cek_alamat(){
  var id_dealer = document.getElementById("id_dealer").value; 
  $.ajax({
      url : "<?php echo site_url('h1/penyerahan_stnk/cari_alamat')?>",
      type:"POST",
...
function generate()
{
  ...
  $.ajax({
       ...
       url:"<?php echo site_url('h1/penyerahan_stnk/t_stnk')?>",
       type:"POST",
       data:value,
       cache:false,
...
$( document ).ready(function() {
    tabless = $('#table_penyerahan_stnk').DataTable({
      "scrollX": true,
      "processing": true, 
      "bDestroy": true,
      "serverSide": true, 
      "order": [],
      "ajax": {
        "url": "<?php  echo site_url('h1/penyerahan_stnk/fetch_data_penyerahan_stnk_datatables')?>",
          "type": "POST"
      },  
