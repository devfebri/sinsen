  ...
  <section class="content">
    ...
    <div class="box box-default">
      <div class="box-header with-border">
        <h3 class="box-title">
          <a href="h1/analisis_proyeksi_order">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="h1/analisis_proyeksi_order/save" method="post" enctype="multipart/form-data">
              <div class="box-body">                
                        ...
                        <select class="form-control select2" name="id_dealer" id="id_dealer">
                          <?php if ($dealer->num_rows() >0) { ?>
                            ...
                            <?php foreach ($dealer->result() as $rs): ?>
                                <option value="<?=$rs->id_dealer?>"><?=$rs->kode_dealer_md?> | <?=$rs->nama_dealer?></option>
                            <?php endforeach ?>
                         <?php } ?>
                        </select>
                    </div>
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="h1/analisis_proyeksi_order/update" method="post" enctype="multipart/form-data">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">
          <a href="h1/analisis_proyeksi_order/add">
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          foreach($dt->result() as $row) {  ?>
            ...
            ?>
              <tr>
                <td><?=$no?></td>
                <td><a href="h1/analisis_proyeksi_order/detail?id=<?=$row->id_analisis?>"><?=$row->nama_dealer?></a></td>
                <td><?=bln($row->bulan)?></td>
                <td><?=$row->tahun?></td>
                <td><?=$qty_order?></td>
                ...
                <td align="center">
                  <?php if ($status!='approved'): ?>
                    <a href="h1/analisis_proyeksi_order/approval?id=<?=$row->id_analisis?>" class="btn btn-success btn-xs btn-flat"><i class="fa fa-check"></i></a>
                  <?php endif ?>
                </td>
              </tr>
          <?php
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="h1/analisis_proyeksi_order/approval" method="post" enctype="multipart/form-data">
              <div class="box-body">                
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Dealer</label>
                 <?php $dealer= $this->db->query("SELECT * FROM ms_dealer ORDER BY nama_dealer ASC") ?>
    ...
    if(confirm('Are you sure delete this '+list_id.length+' data?'))
      {
        $.ajax({
          type: "POST",
          data: {id:list_id},
          url: "<?php echo site_url('h1/analisis_proyeksi_order/ajax_bulk_delete')?>",
          dataType: "JSON",
 ...
 if (value.id_dealer=='') {
  alert('Silahkan lengkapi data...!');
   ...
   $.ajax({
       ...
       url:"<?php echo site_url('h1/analisis_proyeksi_order/generate')?>",
       type:"POST",
       data:value,
       cache:false,
