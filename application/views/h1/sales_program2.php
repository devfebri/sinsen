              ...
              <div class="box-body">       
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">                  
                    ...
                    <div class="col-sm-7">
                      ...
                      <input type="hidden" name="segment" id="segment_inp">
                    </div>
                  </div> 
                ...
                <div class="col-md-6">
                  ...
                  <label for="inputEmail3" class="col-sm-4 control-label">Kuota Program</label>
                    <div class="col-sm-6">
                      <input type="text" name="kuota_program" placeholder="Kuota Program" class="form-control" id="kuota_program" autocomplete="off">
                    </div>
                  </div> 
          ...
          <table id="example2" class="table table-bordered table-hover" width="100%">
            ...
            echo "          
              <tr>
                ...
                <td>".strtoupper($row->subProgram)."</td>
                ...
                ?>
                  ...
                  <a data-toggle='tooltip' title="Send to Dealer" onclick="return confirm('Are you sure to send this data to dealer?')" class="btn btn-warning btn-sm btn-flat" href="h1/sales_program/send_to_dealer?id=<?php echo $row->id_program_md ?>"><i class="fa fa-paper-plane"></i></a>
                  <?php } ?>
                </td>
              </tr>
            <?php
            ...
            <form class="form-horizontal">              
              <div class="box-body">       
                ...
                <div class="col-md-6">
                  ...
                  <label for="inputEmail3" class="col-sm-4 control-label">Sumber Program </label>
                  <div class="col-sm-7">
                      <input type="text" value="<?php echo strtoupper($row->jenis); ?>" class="form-control" readonly>
                    </div>
                  </div>
              ...
              <div class="box-body">       
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">                  
                    <label for="inputEmail3" class="col-sm-4 control-label">Deskripsi Program MD</label>
                    <div class="col-sm-7">
                      <input type="text" name="judul_kegiatan" placeholder="Deskripsi Program MD" readonly value="<?php echo  $row->judul_kegiatan ?>" class="form-control" >
                    </div>
                  </div> 
                  ...
                  <div class="form-group">                  
                    <label for="inputEmail3" class="col-sm-4 control-label">Sumber Program </label>
                    <div class="col-sm-7">
                      <input type="text" value="<?php echo strtoupper($row->jenis) ?>" class="form-control" name="jenis" readonly>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">                  
                    <label for="inputEmail3" class="col-sm-4 control-label">Kuota Program</label>
                    <div class="col-sm-7">
                      <input type="text" value="<?php echo $row->kuota_program ?>" id="kuota_program" name="kuota_program" class="form-control" >
                    </div>
                  </div> 
