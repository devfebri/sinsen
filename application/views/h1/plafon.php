  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        ?>
        <table id="table_plafon" class="table table-bordered table-hover">
          <thead>
            <tr>
  ...
  function showTotal()
{
  ...
  $( document ).ready(function() {
   ...
   tabless = $('#table_plafon').DataTable({
	      "scrollX": true,
        "processing": true, 
        "bDestroy": true,
        "serverSide": true, 
        "order": [],
        "ajax": {
          "url": "<?php  echo site_url('h1/plafon/fetch_data_plafon_datatables')?>",
            "type": "POST"
        },  
