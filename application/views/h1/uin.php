  ...
  <section class="content">
    ...
    <div class="box box-default">
      <div class="box-header with-border">
        <h3 class="box-title">
          <a href="h1/uin/create_file">
            <button type="button" onclick="return confirm('Are you sure to create this data?')" name="process" value="edit" class="btn btn-info btn-flat"><i class="fa fa-edit"></i> Create File .UIN</button>                                  
          </a>
        </h3>
  ...
  if (window.XMLHttpRequest) { // Mozilla, Safari, ...
   ...
   //var data = "birthday1="+birthday1_js;          
    var data = "start_date="+start_date+"&end_date="+end_date;                           
     xhr.open("POST", "h1/uin/t_detail", true); 
