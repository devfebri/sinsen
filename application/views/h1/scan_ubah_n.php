    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div class="row" id="nrfs_div">
          <div class="col-md-12">
            <div class="box-body">    
              <form class="form-horizontal" action="h1/nrfs_rfs/save" method="post" enctype="multipart/form-data">              
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div class="row" id="nrfs_div">
          <div class="col-md-12">
            <div class="box-body">    
              <form class="form-horizontal" action="h1/nrfs_rfs/update" method="post" enctype="multipart/form-data">              
                <div class="form-group">
                  <!--label for="inputEmail3" class="col-sm-2 control-label">ID Ubah Status</label-->
                  <div class="col-sm-3">
              ...
              <div id="tampil_data"></div>
                ...
                <div class="form-group">
                  <button <?php echo $this->m_admin->set_tombol($id_menu,$group,"edit"); ?> type="submit" onclick="return confirm('Are you sure to update all data?')" name="save" value="update" class="btn btn-info btn-flat margin"><i class="fa fa-save"></i> Update All </button>              
          ...
          foreach($dt_cetak->result() as $row) {                 
            ...
            <tr>
              ...
              <td>"; ?>
                ...
                <button name="cetak" <?php echo $this->m_admin->set_tombol($id_menu,$group,"print"); ?> type="button" class="btn bg-maroon btn-flat btn-sm" 
                  onclick="javascript:wincal=window.open('h1/nrfs_rfs/cetak_s?id=<?php echo $row->no_mesin; ?>',
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          foreach ($dt_scan_ubah->result() as $row) {
            ...
            <tr>
              ...
              <td>$isi</td>
              <td>"; ?>                
                <!--a href='<?php echo "h1/nrfs_rfs/approve?id=$rt->id_scan_ubah" ?>'>
                ...
                <a href='<?php echo "h1/nrfs_rfs/reject?id=$rt->id_scan_ubah" ?>'>
                ...
                <a href='<?php echo "h1/nrfs_rfs/detail?id=$rt->id_scan_ubah" ?>'>
                  <button class='btn btn-flat btn-xs btn-warning'><i class='fa fa-eye'></i> Detail</button>
                </a>
                <?php 
                if($rt->status_ubah == 'input'){ 
                ?>
                <a href='<?php echo "h1/nrfs_rfs/edit?id=$rt->id_scan_ubah" ?>'>
                ...
                ?>
                <a href='<?php echo "h1/nrfs_rfs/cetak_stiker?id=$rt->id_scan_ubah" ?>'>
                  <button <?php echo $this->m_admin->set_tombol($id_menu,$group,"print"); ?> class='btn btn-flat btn-xs btn-info'><i class='fa fa-print'></i>  Cetak Striker</button>                
                </a>                
                <?php } ?>
              </td>
            </tr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table id="example3" class="table table-bordered table-hover">
          ...
          <?php
          $no = 1;                         
          $dt_scan = $this->db->query("SELECT * FROM tr_scan_barcode WHERE tipe = 'NRFS' AND status = '1'");
...
function auto(){
  ...
  $.ajax({
      url : "<?php echo site_url('h1/nrfs_rfs/cari_id')?>",
      type:"POST",
      data:"tgl="+tgl_js,   
      cache:false,   
  ...
  if (window.XMLHttpRequest) { // Mozilla, Safari, ...
   ...
   //var data = "birthday1="+birthday1_js;          
    var data = "id_ubah="+id_ubah;                           
     xhr.open("POST", "h1/nrfs_rfs/t_rfs", true); 
...
function simpan_rfs(){
  ...
  if (id_ubah == "" || rfs_text == "") {    
      ...
      $.ajax({
          url : "<?php echo site_url('h1/nrfs_rfs/save_rfs')?>",
          type:"POST",
...
function hapus_scan(a,b,c){ 
    ...
    var no_mesin      = c;       
    $.ajax({
        url : "<?php echo site_url('h1/nrfs_rfs/delete_scan')?>",
        type:"POST",
