...
<section class="content-header">
    ...
    <body>
      ...
      <?php if($tanggal2 != ''){ ?>
        ...
        <center>
            ...
            <h2>LAPORAN ONGKOS ANGKUT UNIT</h2>
        ...
        <table class='table table-bordered' style='font-size: 12pt' width='200%'>
          ...
          <tr>                          
            ...
            <th bgcolor='yellow' class='bold text-center'>No SL</th>
            ...
            <th bgcolor='yellow' class='bold text-center'>Tipe</th>
            ...
            <th bgcolor='yellow' class='bold text-center'>Ekspedisi</th>
          ...
          <?php
...

            {
		      ...
		      <td width="150px;"><?php echo $dw->no_faktur ?></td>
			<?php $reformat = substr($dw->tgl_faktur,0,2).'-'.substr($dw->tgl_faktur,2,2).'-'.substr($dw->tgl_faktur,4,4); ?>

		      <td width="150px;"><?php echo $reformat; ?></td>



		      <td style=" text-align:'center';"><?php echo $dw->no_sl ?></td>



		      <td style=" text-align:'center';"><?php echo $dw->no_mesin_lengkap ?></td>
		      ...
		      <td width="300px;"><?php echo $dw->id_modell ?></td>
		      ...
		      <td style=" text-align:'center';"><?php echo $dw->vendor_name ?></td>



		      <td style=" text-align:'center';"><?php echo number_format($dw->ongkos_ahm,0,',','.')  ?></td>
  ...
  <?php } elseif ($set == 'export_excel') { 
    ...
    header("Content-Disposition: attachment; filename=lap_ongkos_angkut_unit-$date_buat.xls");
        ...
        <table class='table table-bordered' style='font-size: 12pt' width='200%' border="1">
          ...
          <?php
            ...
            <tr>
		      ...
		      <td width="150px;"><?php echo $dw->no_faktur ?></td>
			<?php $reformat = substr($dw->tgl_faktur,4,4).'-'.substr($dw->tgl_faktur,2,2).'-'.substr($dw->tgl_faktur,0,2); ?>
...
function getReport(){
  ...
  if (value.tanggal1 == '' && value.tanggal2 == '') {
    ...
    $("#showReport").attr("src",'<?php echo site_url("h1/Lap_ongkos_angkut_unit?") ?>cetak='+value.cetak+'&tanggal1='+value.tanggal1+'&tanggal2='+value.tanggal2);
