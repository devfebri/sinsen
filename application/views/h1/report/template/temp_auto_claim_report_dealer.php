...
<table>  
 ...
 <table border="1">  
	<tr class="title-header">
		...
		<td rowspan="2" width="3000">Deskripsi Program</td>
...
foreach ($auto_claim_dealer as $field) {
    ...
    <tr>
		...
		<td><?= $arraySsu[] 	 = (int)$field->tot_gc + (int)$field->tot_ssu   ?></td>

        <td><?= $arrayClaim[]    = (int)$field->tot_ssu_credit +  (int)$field->tot_ssu_cash   ?></td>
		...
		<td><?= $arraySsuCredit[]     = (int)$field->tot_ssu_credit + (int)$field->tot_gc_kredit  ?></td>
        <td><?= $arrayClaimCredit[]   = (int)$field->tot_ssu_credit ?></td>
        <td><?= $arrayApproveCredit[] = (int)$field->approve_kredit ?></td>
        <td><?= $arrayRejectCredit[]  = (int)$field->rejected_kredit ?></td>

        <td><?= $arraySsuCash[]     = (int)$field->tot_ssu_cash + (int)$field->tot_gc_cash ?></td>
        <td><?= $arrayClaimCash[]   = (int)$field->tot_ssu_cash ?></td>
