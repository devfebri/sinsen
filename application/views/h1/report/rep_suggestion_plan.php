  ...
  <section class="content">
    ...
    <div class="box box-default">
      <div class="box-header with-border">        
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="h1/rep_suggestion_plan/download" id="frm" method="post" enctype="multipart/form-data">
              <div class="box-body">                                                                              
                <div class="form-group">                                    
                  ...
                  <div class="col-sm-2">
                    <input type="text" name="tahun" required autocomplete="off" value="<?php echo date('Y') ?>" class="form-control" placeholder="Tahun">
                  </div>                                
                  <div class="col-sm-2">
