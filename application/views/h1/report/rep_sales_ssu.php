  ...
  <section class="content">
    ...
    <div class="box box-default">
      <div class="box-header with-border">        
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="h1/rep_sales_ssu/download" id="frm" method="post" enctype="multipart/form-data">
              <div class="box-body">                                                                              
                
                <div class="form-group">                                    
                  <label for="inputEmail3" class="col-sm-2 control-label">Periode Jual</label>
                  <div class="col-sm-2">                    
                ...
                <div class="form-group">                                    
                  <label for="inputEmail3" class="col-sm-2 control-label">Periode Entry</label>
                  <div class="col-sm-2">                    
                    <input type="text" autocomplete="off" required placeholder="Awal" name="tgl3" id="tanggal4" class="form-control">
                  </div>                                                                    
                  <div class="col-sm-2">                    
                    <input type="text" autocomplete="off" required placeholder="Akhir" name="tgl4" id="tanggal3" class="form-control">
                  </div>                                                             
                </div>                
                <div class="form-group">                                    
