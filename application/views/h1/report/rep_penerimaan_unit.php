  ...
  <section class="content">
    ...
    <div class="box box-default">
      <div class="box-header with-border">        
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="h1/rep_penerimaan_unit/download" id="frm" method="post">
              <div class="box-body">                                                                              
                ...
                <div class="form-group">                                    
                  <label for="inputEmail3" class="col-sm-2 control-label">Tgl Invoice AHM</label>
                  <div class="col-sm-2">
                    <input placeholder="Awal" type="text" autocomplete="off" name="tgl3" id="tanggal3" class="form-control">
                  </div>                  
                  <div class="col-sm-2">
                    <input placeholder="Akhir" type="text" autocomplete="off" name="tgl4" id="tanggal4" class="form-control">
                  </div>                  
                </div>
                <div class="form-group">
