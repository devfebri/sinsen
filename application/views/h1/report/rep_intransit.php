  ...
  <section class="content">
    ...
    <div class="box box-default">
      <div class="box-header with-border">        
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="h1/rep_intransit/download" id="frm" method="post" enctype="multipart/form-data">
              <div class="box-body">                                                                              
                <div class="form-group">                                    
                  <label for="inputEmail3" class="col-sm-2 control-label">Periode Shipping List</label>
                  <div class="col-sm-2">
                    <input type="text" required autocomplete="off" placeholder="Tgl Awal" id="tanggal1" name="tgl1" class="form-control">
                  </div>
                  <div class="col-sm-2">
                    <input type="text" required autocomplete="off" placeholder="Tgl Akhir" id="tanggal2" name="tgl2" class="form-control">
                  </div>
                
                  <label for="inputEmail3" class="col-sm-2 control-label">Kode Tipe</label>                                                  
                  <div class="col-sm-4">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select name="id_warna" class="form-control select2">
                      <option value="">All</option>
                      <?php 
