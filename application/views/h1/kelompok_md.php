            ...
            <form class="form-horizontal" action="master/kelompok_md/save" method="post" enctype="multipart/form-data">
              <div class="box-body">                
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">ID Kelompok Harga Jual</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" required id="inputEmail3" placeholder="ID Kelompok Harga Jual" name="id_kelompok_md">
                  </div>
                  <label for="inputEmail3" class="col-sm-2 control-label">ID Kelompok Harga</label>
                  <div class="col-sm-4">
                    <select name="id_kelompok_harga" class="form-control select2">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="master/kelompok_md/update" method="post" enctype="multipart/form-data">
              <input type="hidden" name="id" value="<?php echo $row->id_kelompok_md ?>" />
              <div class="box-body">                
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">ID Kelompok Harga Jual</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" required id="inputEmail3" value="<?php echo $row->id_kelompok_md ?>" placeholder="ID Kelompok Harga Jual" name="id_kelompok_md">
                  </div>
                  <label for="inputEmail3" class="col-sm-2 control-label">ID Kelompok Harga</label>
                  <div class="col-sm-4">
                    <select name="id_kelompok_harga" class="form-control select2">
                      ...
                      <?php 
                      $dt_kel = $this->m_admin->kondisiCond("ms_kelompok_harga","id_kelompok_harga != ".$row->id_kelompok_harga);                                                                      
                      foreach($dt_kel->result() as $val) {
                        echo "
                        <option value='$val->id_kelompok_harga'>$val->kelompok_harga</option>;
                        ";
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Harga BBN</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" name="harga_bbn" placeholder="Harga BBN" value="<?php echo $row->harga_bbn ?>">                    
                  </div>
                  <label for="inputEmail3" class="col-sm-2 control-label">Harga Jual</label>
                  <div class="col-sm-4">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Start Date</label>
                  <div class="col-sm-4">
                    <input type="text" id="tanggal" class="form-control" value="<?php echo $row->start_date ?>" name="start_date" placeholder="Start Date">
                  </div>                
                  <label for="inputEmail3" class="col-sm-2 control-label">End Date</label>
                  <div class="col-sm-4">
                    <input type="text" id="tanggal2" class="form-control" value="<?php echo $row->end_date ?>" name="end_date" placeholder="End Date">
                  </div>
                </div> 
                <div class="form-group">
                  <label for="field-1" class="col-sm-2 control-label"></label>            
      ...
      <div class="box-body">
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          echo "          
            <tr>
              <td>$no</td>
              <td>$row->id_kelompok_md</td>              
              <td>$row->kelompok_harga</td>              
              <td>$row->id_item</td>
              <td>".mata_uang2($row->harga_bbn)."</td>
