                ...
                <div class="form-group">                                
                  ...
                  <div class="col-sm-4">
                    <select class="form-control" name="tipe_customer" id="tipe_customer" onchange="cek_tipe()">
                      ...
                      <option>Group Dealer</option>
                      <option>Lain-lain</option>
                    </select>
                  </div>           
                  
                  <span id="group_dealer">
                    <label class="col-sm-2 control-label">Diterima Dari Group Dealer</label>
                    <div class="col-sm-4">
                    <select class="form-control select2" >
                        <option value="">- choose -</option>
                        <?php 
                        $datas = $this->db->query("SELECT * FROM ms_group_dealer_custome")->result();	
                        var_dump($datas);
                        die();
                        foreach ($data as $isi) { ?>
                          <option value='<?=$isi->id_group_dealer_custome?>'><?=$isi->qq_kwitansi?></option>";
                        <?}
                        ?>
                      </select>             
                    </div>                                                      
          ...
          <div class="col-md-12">            
            <form class="form-horizontal" action="h1/entry_penerimaan_bank/save_edit" method="post" enctype="multipart/form-data" id="form_entri">              
              <div class="box-body">       
                ...
                <div class="form-group">                                
                  <label for="inputEmail3" class="col-sm-2 control-label">Tipe Customers</label>
                  <div class="col-sm-4">
    ...
    <script type="text/javascript">
      $(document).ready(function(e){
        ...
        $('#datatable').DataTable({
           ...
           "ajax":{
                    url :  base_url+'h1/entry_penerimaan_bank/getData',
                    type : 'POST'
                  },
        }); // End of DataTable
