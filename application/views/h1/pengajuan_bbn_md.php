      ...
      <div class="box-body">
        ...
        <div class="row">
          ...
          if($dt_so->num_rows() == 0){
            ...
            $this->db->where('a.no_mesin', $row->no_mesin);
            ...
            if($row->bpkb_stnk_birth_place!=''){
              $tempat_lahir = $row->bpkb_stnk_birth_place;
            }else{
              $tempat_lahir = $row->tempat_lahir;
            }
            if($row->bpkb_stnk_birth_date){
              $tanggal_lahir = $row->bpkb_stnk_birth_date;
            }else{
            ...
            <form class="form-horizontal" action="h1/pengajuan_bbn_md/update" method="post" enctype="multipart/form-data">              
              <div class="box-body">       
                ...
                <div class="form-group">                  
                  ...
                  <div class="col-sm-4">
                    <input type="text" onkeydown="upperCaseF(this)" name="tempat_lahir" value="<?php echo strtoupper($tempat_lahir) ?>" placeholder="Tempat Lahir" class="form-control">
                  </div>                  
                  <div class="col-sm-4">
                    <input type="text" name="tgl_lahir" placeholder="Tanggal Lahir" value="<?php echo $tanggal_lahir ?>" id="tanggal2" class="form-control">
                  </div>                  
                </div>                               
                <div class="form-group">
                ...
                <div class="form-group">                  
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="alamat" onkeydown="upperCaseF(this)" autocomplete="off" placeholder="Alamat" value="<?php echo strtoupper($row->alamat) ?>" class="form-control">
                  </div>                  
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <!--	<select class="form-control select2">
                    ...
                    if(isset($row->kerja)){
                      ...
                      $cek = $this->db->query("SELECT tr_spk_gc.jenis_gc FROM tr_faktur_stnk_detail INNER JOIN tr_sales_order_gc ON tr_faktur_stnk_detail.id_sales_order = tr_sales_order_gc.id_sales_order_gc
                        INNER JOIN tr_spk_gc ON tr_sales_order_gc.no_spk_gc = tr_spk_gc.no_spk_gc
                        WHERE tr_faktur_stnk_detail.no_bastd = '$no_bastd' and tr_faktur_stnk_detail.no_mesin ='$no_mesin'");                      
                      if($cek->num_rows() > 0){                        
  ...
  function pilihPekerjaan(krj)
  {
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <a href="h1/pengajuan_bbn_md" <?php echo ($_GET AND $_GET['page'] == 'history') ? 'class="btn btn-info"' : 'class="btn btn-success"' ?>>Pengajuan BBN MD</a></li>
        <a href="h1/pengajuan_bbn_md?page=history" <?php echo ($_GET AND $_GET['page'] == 'history') ? 'class="btn btn-success"' : 'class="btn btn-info"' ?>>Riwayat Pengajuan BBN MD</a>
        <hr>
        ...
        $('#datatable').DataTable({
           ...
           "ajax":{
                    <?php if (isset($_GET['page'])): ?>
                      url :  base_url+'h1/pengajuan_bbn_md/get_data_pengajuan_bbm_md?page=history',
                    <?php else: ?>
                      url :  base_url+'h1/pengajuan_bbn_md/get_data_pengajuan_bbm_md',
                    <?php endif ?>
                  ...
                  <table id="example4" class="table myTable1 table-bordered table-hover">
                    ...
                    <tbody>                    
                     ...
                     foreach($get_nosin->result() as $row) {                                                   
                        $getTipe = $this->db->query("SELECT deskripsi_samsat FROM ms_tipe_kendaraan WHERE id_tipe_kendaraan='$row->tipe_motor'");
