...
<body onload="mulai();cek_isi_form();">
    ...
    <div class="box">
      ...
      <form class="form-horizontal" method="GET" action="h1/entry_stnk/index_cari">
        <div class="form-group">
          ...
          <div class="col-sm-2">
            <input type="text" class="form-control datepicker" name="tgl_mohon_samsat1" value="<?= isset($tgl_mohon_samsat1)?$tgl_mohon_samsat1:'' ?>" autocomplete="off" required>
          </div>
          <label for="inputEmail3" class="col-sm-2 control-label">Tgl. Mohon Samsat Akhir</label>
          <div class="col-sm-2">
            <input type="text" class="form-control datepicker" name="tgl_mohon_samsat2" value="<?= isset($tgl_mohon_samsat2)?$tgl_mohon_samsat2:'' ?>" autocomplete="off" required>
          </div>          
        </div>
        <div class="form-group">
        ...
        <table id="example8" class="table table-bordered table-hovered">
          <thead>
            <tr>              
              ...
              <th>Tipe</th>                 
              <th>Warna</th>
              <th style="width: 13%">No STNK</th>
              <th style="width: 13%">No Polisi</th>
              <th style="width: 13%">Plat</th>
              <th style="width: 13%">No BPKB</th>              
            </tr>
          </thead>
          <tbody>            
          <?php 
          ...
          foreach($dt_bbn->result() as $row){   
            ...
            if($cek->num_rows() > 0){
              $m = $cek->row();
              $cek_s = ($m->no_stnk != "") ? "checked" : "" ;              
              $stnk = "value='$m->no_stnk'";              
              $cek_b = ($m->no_bpkb != "") ? "checked" : "" ;              
              $bpkb = "value='$m->no_bpkb'";              
              $cek_p = ($m->no_plat != "") ? "checked" : "" ;              
              if($m->no_plat != ""){
            ...
            <tr>
              ...
              <td>  
                ...
                <input type='checkbox' id='cek_stnk_$no' name='cek_stnk_$no' onchange='cek_form()' $cek_s>
                <input $stnk type=\"text\" autocomplete=\"off\" class=\"form-control isi\" name=\"no_stnk_$no\" id=\"no_stnk_$no\">
              </td>                           
              <td>
                <input type='checkbox' id='cek_pol_$no' name='cek_pol_$no'  onchange='cek_form()' $cek_o><br>
                <span id='pol_$no'></span>
                <input $pol1 type=\"text\" autocomplete=\"off\" class=\"isi\" name=\"no_pol_$no\" id=\"no_pol_$no\" style='width:60%' i ='$no'>
                <input $pol2 type=\"text\" autocomplete=\"off\" class=\"isi\" name=\"b_pol_$no\" id=\"b_pol_$no\" style='width:35%' maxlength='2' onkeyup=\"this.value = this.value.toUpperCase()\">
              </td> 
              <td>
                <input type='checkbox' id='cek_plat_$no' name='cek_plat_$no'  onchange='cek_form()' $cek_p><br>
                <span id='plat_$no'></span>
                <input $plat1 type=\"text\" autocomplete=\"off\" class=\"isi\" name=\"no_plat_$no\" id=\"no_plat_$no\" style='width:60%' i ='$no' readonly >
                <input $plat2 type=\"text\" autocomplete=\"off\" class=\"isi\" name=\"b_plat_$no\" id=\"b_plat_$no\" style='width:35%' maxlength='2' readonly>  
              </td>                           
              <td>
                <input type='checkbox' id='cek_bpkb_$no' name='cek_bpkb_$no'  onchange='cek_form()' $cek_b>
                <input $bpkb type=\"text\" autocomplete=\"off\" class=\"form-control isi\" name=\"no_bpkb_$no\" id=\"no_bpkb_$no\">
              </td>";                                      
          $no++;
          }
          ?>
        ...
        OR tr_proses_bbn_detail.status_stnk IS NULL OR tr_proses_bbn_detail.status_bpkb IS NULL OR tr_proses_bbn_detail.status_plat IS NULL)
          ...
          foreach($dt_bbn_bantuan->result() as $row){   
            ...
            <tr>
              ...
              <td>
                <input type='checkbox' id='cek_pol_$no' name='cek_pol_$no'  onchange='cek_form()' $cek_0><br>
                <span id='pol_$no'></span>
                <input $pol1 type=\"text\" autocomplete=\"off\" class=\"isi\" name=\"no_pol_$no\" id=\"no_pol_$no\" style='width:60%' i ='$no'>
                <input $pol2 type=\"text\" autocomplete=\"off\" class=\"isi\" name=\"b_pol_$no\" id=\"b_pol_$no\" style='width:35%' maxlength='2' onkeyup=\"this.value = this.value.toUpperCase()\">
              </td> 
    ...
    <div class="box">
      ...
      <form class="form-horizontal" method="GET" action="h1/entry_stnk/index_cari">
        <div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">Tgl. Mohon Samsat Awal</label>
          <div class="col-sm-2">
            <input type="text" class="form-control datepicker" name="tgl_mohon_samsat1" value="<?= isset($tgl_mohon_samsat)?$tgl_mohon_samsat:'' ?>" autocomplete="off" required>
          </div>
          <label for="inputEmail3" class="col-sm-2 control-label">Tgl. Mohon Samsat Akhir</label>
          <div class="col-sm-2">
            <input type="text" class="form-control datepicker" name="tgl_mohon_samsat2" value="<?= isset($tgl_mohon_samsat2)?$tgl_mohon_samsat2:'' ?>" autocomplete="off" required>
