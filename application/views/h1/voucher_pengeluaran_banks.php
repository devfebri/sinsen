                    ...
                    <div class="form-group">
                      <span id="tampil_bg">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                          <button type="button" onClick="add_bg_temp(1)" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> Add</button>
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <tbody id="coa-tbody">
                          <tr id="temp_1">
                            <td>
                              ...
                              <input  name="temp[kode_coa_temp][]" id="kode_coa" readonly type="text" onclick="showModalCOAS(1)" name="kode_coa" class="form-control isi kode_coa_temp_1" placeholder="Kode COA">
                            </td>
                            <td>
                              <input  type="text" readonly id="coa" class="form-control isi_combo coa_temp_1" onclick="showModalCOAS(1)" placeholder="COA">
                            </td>                          
                            <td>
                              <select  name="temp[referensi_temp][]" class="form-control isi_combo select2" id="referensi" onchange="cek_ref()">
                              </select>
                            </td>
                            <td>
                              <input  name="temp[sisa_hutang_temp][]" type="text" class="form-control isi_combo" id="sisa_hutang" placeholder="Sisa Hutang" readonly>
                            </td>
                            <td>
                              <input  name="temp[nominal_temp][]" type="text" class="form-control isi_combo  nominal_temp" id="nominal"  placeholder="Nominal">
                            </td>
                            
                            <td>
                              <input  name="temp[keterangan_temp][]" type="text" class="form-control isi_combo" id="keterangan" placeholder="Keterangan">
                            </td>
        ...
        <script>
          ...
          function add_coa_temp(data) {
            ...
            var tableHTML = '<tr id="temp_'+urut+'">' +
              ...
              '</td>'+
              '<td>' +
              '<input id="coa'+urut+'"  readonly type="text" class="form-control  isi_combo coa_temp_'+button+'" onclick="showModalCOAS('+urut+')" placeholder="COA"> ' +
              '</td>'+
              '<td>' +
              '<select class="form-control isi_combo select2"    name="temp[referensi][]" id="referensi" onchange="cek_ref()"></select>' +
              '</td>'+
              '<td>' +
              '<input type="text" class="form-control isi_combo " id="sisa_hutang'+urut+'" name="temp[sisa_hutang][]" placeholder="Sisa Hutang" readonly>' +
              '</td>'+
              '<td>' +
              '<input type="text" class="form-control isi_combo tanpa_rupiah nominal_temp  " id="nominal" name="temp[nominal][]" placeholder="Nominal">' +
              '</td>'+
              '<td>' +
              '<input type="text" class="form-control isi_combo" id="keterangan" placeholder="Keterangan"  name="temp[keterangan][]" >' +
              '</td>'+
          ...
          function add_voucher_temp(set){ 
            ...
            if (nominal_bg == '' ){
             ...
             var tableHTML = 
              '<tr id="voucher_'+set+'">' +
                  '<th width="5%">'+set+'</th>' +
                  '<th><input type="text" class="input-clean" name="voucher[tgl_transfer][]" value="'+tgl_transfer_voucher+'"  readonly> </th>' +
                  '<th><input type="text" class="nominal_voucher input-clean" name="voucher[nominal_transfer][]"         value="'+nominal_voucher_temp+'"  readonly> </th>' +
            ...
            var calculatedTotalSums = 0;
            $(".nominal_voucher_temp").each(function() {
                var getTextboxValue = parseFloat($(this).val()) || 0;

                alert(getTextboxValue);
                calculatedTotalSums += getTextboxValue;
            });
         ...
         function add_bg_temp(set){
          ...
          '<tr id="bg_'+set+'">' +
              '<th width="5%">'+set+'</th>' +
              '<th><input type="text"  class="input-clean"              name="bg[no_bg][]"              value="'+no_bg+'" readonly></th>' +
              '<th><input type="text"  class="input-clean"              name="bg[tgl_jatuh_tempo][]"   value="'+tgl_jatuh_tempo_bg+'"  readonly></th>' +
              '<th><input type="text"  class="input-clean nominal_bg"   name="bg[nominal][]"           value="'+nominal_bg+'" class="" readonly> </th>' +
