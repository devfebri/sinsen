  ...
  <tfoot>
    <tr>
     ...
     <td rowspan="7"><select class="select2 id_warna" style="width: 100%" multiple="multiple" name="id_warna" id="id_warna">
      ...
      <td><b>AHM</b></td><td><input type="text" name="ahm_cash"  id="ahm_cash" class="form-control auto_sum_cash"></td><td><input type="text" name="ahm_kredit" id="ahm_kredit"  class="form-control auto_sum_kredit"></td>
   ...
   <tr>
     <td><b>Add. MD</b></td><td><input type="text" name="add_md_cash" id="add_md_cash" class="form-control auto_sum_cash"></td><td><input type="text" name="add_md_kredit" id="add_md_kredit" class="form-control auto_sum_kredit"></td>
   </tr>
   <tr>
     <td><b>Add. Dealer</b></td><td><input type="text" name="add_dealer_cash" id="add_dealer_cash" class="form-control auto_sum_cash"></td><td><input type="text" name="add_dealer_kredit" id="add_dealer_kredit" class="form-control auto_sum_kredit"></td>
   </tr>
   <tr>
