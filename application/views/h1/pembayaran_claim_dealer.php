...
<body>
  ...
  <body >
    ...
    ?>
        <div class="box box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">
              <a href="h1/pembayaran_claim_dealer/add" class="btn bg-blue btn-flat margin"><i class="fa fa-plus"></i>
                Add New</a>
              <a href="h1/pembayaran_claim_dealer/history" class="btn bg-yellow btn-flat margin"><i
                  class="fa fa-eye"></i> History</a>
                  <a href="h1/pembayaran_claim_dealer/monitoring_payment" class="btn bg-maroon btn-flat margin"><i class="fa fa-file" aria-hidden="true"></i> Monitoring Payment</a>
              <h3 class="box-title">
              </h3>
              </a>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a href="h1/pembayaran_claim_dealer/send_notify?id_generate=<?=$row->id_claim_generate_payment?>"
                          class="btn btn-primary btn-xs btn-flat margin" hidden title="Send to Dealer"><i class="fa fa-paper-plane"></i></a>
                          
                        <? elseif ($row->status=='send'): ?>
                            <a href="h1/pembayaran_claim_dealer/aksi?id=<?=$row->id_claim_generate_payment?>" class="btn bg-primary btn-flat margin"><i class="fa fa-print"></i></a>

                        <!-- <a href="h1/pembayaran_claim_dealer/claim_approve?id_generate=<?php //$row->id_claim_generate_payment?>"
    ...
    <?php
    } else if($set=="monitoring_payment"){
    ?>
            ...
            <table id="claim_header" class="table table-bordered table-hover" style="overflow: auto; height: 100px;">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?=$row->approved?></td>
                  <td><?=$row->rejected?></td>
                  <td><?=number_format($row->nilai_potongan_approved)?></td>
                  <td><?=number_format($row->nilai_potongan_rejected)?></td>
                  <td><?=number_format($row->nilai_potongan_rejected)?></td>
                  <td><span class="label label-success tooltiptext">
                                  Approve Claim From Dealer
                              </span></td>
                  <td>
                    <div class="row">
                      <? if ($row->approve_from_dealer==1): ?>
                      <a href="h1/pembayaran_claim_dealer/send_notify?id_generate=<?=$row->id_claim_generate_payment?>"
                        class="btn btn-primary btn-xs btn-flat" hidden><i class="fa fa-paper-plane"></i></a>
                      <? endif; ?>
                    </div>
                  </td>
                </tr>
                ...
                <td>
                  <div class="row">
                    ...
                    <a href="h1/pembayaran_claim_dealer/claim_approve?id_generate=<?=$row->id_claim_generate_payment?>"
                      class="btn btn-info btn-xs btn-flat"
                      onclick="return confirm('Are you sure to approve this data?')"><i class="fa fa-check"></i> Approve
                    </a>
                    <? elseif ($row->status=='approved'):  ?>
                    <a href="h1/pembayaran_claim_dealer/process_claim" class="btn btn-warning btn-xs btn-flat margin"><i
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">
            ...
            <a href="h1/pembayaran_claim_dealer/monitoring_from_dealer" class="btn bg-yellow btn-flat margin"><i class="fa fa-eye"></i> Monitoring</a>
          </h3>
          <div class="box-tools pull-right">
            <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
            <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
                      ...
                      <div class="col-sm-8">
                        <div class="row">
                          <div class="col-sm-6">
                            ...
                            <input type="text" name="tanggal_awal" value="2022-01-01" class="form-control" id="tanggal3" autocomplete="off" placeholder="Tanggal Priode Awal" required>
                          ...
                          <div class="col-sm-6">
                            ...
                            <input type="text" name="tanggal_akhir" value="2022-07-30" class="form-control" id="tanggal4" autocomplete="off" placeholder="Tanggal Priode Awal" required>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        ?>
          ...
          <div class="row">
            ...
            <div class="col-md-2 col-md-offset-5 m-2">
              <button type="submit" class="btn btn-info btn-flat" onclick="return confirm('Are you sure to Generate this data ?')"> <i class="fa fa-save"></i>Save</button>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php
                // var_dump($sales_program_modal);
                // die();
                ?>
                  
                    <select name="no_sales_id" class="form-control select2"  id="no_sales_id_manual_modal"  value="<?php echo set_value('no_sales_id'); ?>"   style="width: 100% !important;padding: 0;" >
                          <option value="">- Pilih sales ID -</option>
                          <?php
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  ...
                  <!-- <input type="text" readonly class="form-control" value="2021-10-01" > -->
                </div>
          ...
          ?>
              ...
              <tfoot>
                ...
                <tr>
                  ...
                  <td></td>
                  <!-- <td><b><?php //number_format($tot_reject_full)?></b></td> -->
                </tr>
              </tfoot>
            </table>
          </div>
   ...
   ?>
    ...
    <script>
             function rubah_format_rupiah(){
              ...
              //  var approve = $('#total_tot_approved_footer_check').val('');
              //  var reject = $('#total_tot_approved_footer_check').val('');
              //  var gantung = $('#format_footer_total_sisa_stock_pending').val('');
              //  var ahm = $('#format_footer_total_tot_ahm').val('');
              //  var md = $('#format_footer_total_tot_m').val('');
              //  var d = $('#format_footer_total_tot_d').val('');
              //  var tot_ahm = $('#format_footer_total_ful_tot_ahm').val('');
              //  var tot_md = $('#format_footer_total_ful_tot_md').val('');
              //  var tot_d = $('#format_footer_total_ful_tot_d').val('');
              //  var tot_rej = $('#format_footer_total_ful_tot_reject').val('');
              //  var tot_gantung = $('#format_footer_total_tot_sisa').val('');
              //  var tot_pembayaran = $('#format_footer_total_tot_pembayaran').val('');

              //  $("#format_footer_total_tot_approve").val(format(approve));
              //  $("#format_footer_total_tot_reject").val(format(reject));
              //  $("#format_footer_total_sisa_stock_pending").val(format(gantung));
              //  $("#format_footer_total_tot_ahm").val(format(ahm));
              //  $("#format_footer_total_tot_m").val(format(md));
              //  $("#format_footer_total_tot_d").val(format(d));
              //  $("#format_footer_total_ful_tot_ahm").val(format(tot_ahm));
              //  $("#format_footer_total_ful_tot_md").val(format(tot_md));
              //  $("#format_footer_total_ful_tot_d").val(format(tot_d));
              //  $("#format_footer_total_ful_tot_reject").val(format(tot_rej));
              //  $("#format_footer_total_tot_sisa").val(format(tot_gantung));
              //  $("#format_footer_total_tot_pembayaran").val(format(tot_pembayaran));
    ...
    <!-- <script type="text/javascript">
      function validateForm() {
        var a = document.forms["Form"]["footer_total_tot_approve"].value;
        if (a == null || a == "") {
          alert("List data belum di check");
...
// $('#select_tipe_program').on('change', function (e) {
...
function get_manual() {
  var dealer = $('#id_dealer_manual_modal option:selected').val();
  var sales  = $('#no_sales_id_manual_modal option:selected').val();
  ...
  $.ajax({
            ...
            data: {
                'dealer': dealer,  'sales': sales, 'ppn' : ppn
            },
            success: function(data) {
                // var data_json = JSON.parse(data);
                count += 1;
                // html += '<td>  <input type="text" name="no_juklak[]"                      value="'+data_json[0].no_juklak_md+'" class="hiden-texts" checked readonly >'+data_json[0].no_juklak_md+'</td>';
                // html += '<td>  <input type="text" name="jenis_sales_program[]"            class="hide-input-sm-footer"    value="'+data_json[0].jenis_sales_program+'"       checked readonly >'+data_json[0].jenis_sales_program+'</td>';
...
<script>
  ...
  function ful_total_manual() {
        ...
        // alert(ful_total_kontribusi_ahm[]);
        // alert('Success');
