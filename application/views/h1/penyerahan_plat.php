  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">            
            <form class="form-horizontal" id="myForm" action="h1/penyerahan_plat/save" method="post" enctype="multipart/form-data">              
              <div class="box-body">       
                <br>
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">            
            <form class="form-horizontal" action="h1/penyerahan_plat/save" method="post" enctype="multipart/form-data">              
              <div class="box-body">       
                <br>
                <div class="form-group">                  
                  <label for="inputEmail3" class="col-sm-2 control-label">Tgl Serah Terima</label>
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        ?>
        <table id="table_penyerahan_plat" class="table table-bordered table-hover">
          <thead>
            <tr>
            <th width="5%">No</th>                          
  ...
  if (window.XMLHttpRequest) { // Mozilla, Safari, ...
   ...
   //var data = "birthday1="+birthday1_js;          
    var data = "id_dealer="+id_dealer;
     xhr.open("POST", "h1/penyerahan_plat/t_plat", true); 
...
function cek_alamat(){
  var id_dealer = document.getElementById("id_dealer").value; 
  $.ajax({
      url : "<?php echo site_url('h1/penyerahan_plat/cari_alamat')?>",
      type:"POST",
...
function generate()
{
  ...
  $.ajax({
       ...
       url:"<?php echo site_url('h1/penyerahan_plat/t_plat')?>",
       type:"POST",
       data:value,
       cache:false,
...
$( document ).ready(function() {
    tabless = $('#table_penyerahan_plat').DataTable({
      "scrollX": true,
      "processing": true, 
      "bDestroy": true,
      "serverSide": true, 
      "order": [],
      "ajax": {
        "url": "<?php  echo site_url('h1/penyerahan_plat/fetch_data_penyerahan_plat_datatables')?>",
          "type": "POST"
      },  
