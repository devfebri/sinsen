...
<?php if ($set != 'form') : ?>
      ...
      <style>
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">
              <a href="h1/voucher_pengeluaran_banks">
          ...
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-md-12">
                <form id="form_entri" class="form-horizontal" action="h1/voucher_pengeluaran_banks/save" method="post" enctype="multipart/form-data">

                  <div class="box-body">
                    <div class="form-group">
                        <!-- testing -->
                      <input type="hidden" name="id_voucher_bank" id="id_voucher_bank">
                      <label for="inputEmail3" class="col-sm-2 control-label">Account Ernesto</label>
                      <div class="col-sm-4">
                        <!-- testing ernesto -->
                    ...
                    <div class="form-group">
                      ...
                      <label for="inputEmail3" class="col-sm-2 control-label">Total Pembayaran Ernesto</label>
                      <div class="col-sm-4">
                        <input type="text" name="total_pembayaran_real" readonly  placeholder="Total Pembayaran" class="form-control set_value_total_temp">
                        <!-- <input type="text" name="total_pembayaran_real" readonly id="total_pembayaran_real" placeholder="Total Pembayaran" class="form-control set_value_total_temp"> -->
                    ...
                    <div class="form-group">
                      ...
                      <label for="inputEmail3" class="col-sm-2 control-label">Via Bayar Ernesto</label>
                      <div class="col-sm-4">
                    ...
                    <div class="form-group">
                      ...
                      <span id="tampil_bg">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <select class="form-control select2 no_bg_temp" id="no_bg" name="no_bg">
                              <!-- <option value="">- choose -</option>
                          <?php
                          ...
                          <div class="col-sm-4">
                            <input type="text" class="form-control tgl_jatuh_tempo_bg" id="tanggal4" placeholder="Tgl.Jatuh Tempo BG/Cek" name="tgl_bg">
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="field-1" class="col-sm-2 control-label">Nominal BG/Cek</label>
                          <div class="col-sm-4">
                            <input type="text" id="nominal_bg" class="form-control nominal_bg_temp" placeholder="Nominal BG/Cek" name="nominal_bg">
                          </div>
                          <div class="col-sm-2">
                          </div>
                          
                          <div class="col-sm-4">
                            <button type="button" onClick="add_bg_temp(1)" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> Add Ernesto BG</button>
                        ...
                        <div class="col-sm-2"></div>
                          <div class="col-sm-10">
                            ...
                            <table class="table table-bordered responsive-utilities jambo_table bulk_action"  >
                                  ...
                                  <tbody class="table-bg-append"> 
                                  </tbody>
                                  <tfoot>
                                  <tr>
                                    <td colspan="3"><b>Total</b></td>
                                    <td align="left"> <input type="text" class="total_bg_temp input-clean" readonly></td>
                                    <td></td>
                                  </tr>
                                  </tfoot>
                            </table>
                      ...
                      <span id="tampil_transfer">
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input type="text" class="form-control tgl_transfer_voucher_temp" id="tanggal5" placeholder="Tgl.Transfer" name="tgl_transfer">
                          </div>
                          <label for="field-1" class="col-sm-2 control-label">Nominal Transfer</label>
                          <div class="col-sm-4">
                            <input type="text" id="nominal_transfer" class="form-control nominal_voucher_temp" placeholder="Nominal Transfer" name="nominal_transfer">
                          </div>
                          <div class="form-group">
                          </div>
                          <div class="col-sm-8">
                          ...
                          <div class="col-sm-4">
                            <button type="button" onClick="add_voucher_temp(1)" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> Add Ernesto Voucher</button>
                          ...
                          <div class="col-sm-10">
                            <div id="tableContainer">
                              <table class="table table-bordered responsive-utilities jambo_table bulk_action"  >
                                    ...
                                    <tbody class="table-voucher-append"></tbody>
                                    <tfoot>
                                      <tr>
                                        <td colspan="2"><b>Total Voucher</b></td>
                                        <td align="left"> <input type="text" class="total_voucher_temp input-clean" readonly></td>
                                        <td></td>
                                      </tr>
                                    </tfoot>
                              </table>
                     ...
                     <div class="form-group">
                      <table class="table table-hover table-bordered tbl-product-body" width="100%" >
                        <thead>
                        ...
                        <tbody id="coa-tbody">
                          <tr id="temp_1">
                            <td>
                              ...
                              <input id="kode_coa" readonly type="text" onclick="showModalCOAS(1)" name="kode_coa" class="form-control isi kode_coa_temp_1" placeholder="Kode COA">
                            </td>
                            <td>
                              <input type="text" readonly id="coa" class="form-control isi_combo coa_temp_1" onclick="showModalCOAS(1)" placeholder="COA">
                            </td>                          
                            <td>
                            ...
                            <td>
                              <input type="text" class="form-control isi_combo  nominal_temp" id="nominal"  placeholder="Nominal">
                            </td>
                            ...
                            <td class ="button-set-1" >
                              <button type="button" onClick="add_coa_temp(1)" class="btn btn-sm btn-primary btn-flat button-1"><i class="fa fa-plus"></i></button>                          
                            </td>                        
                          </tr>
                        </tbody>    


                        <tfoot class="tbl-product-foot">
                        <tr>
                            <td align="right" colspan="4"><b>Total</b></td>
                            <td align="right"><input type="text" name="total_temp" class ="total_temp input-clean" style="font-weight: bold;"></td>
                          <td colspan="2"></td>
                        </tr>
                        </tfoot>   
                      </table>
        ...
        <script>
          let data = 0;
          function add_coa_temp(data) {
            var kode_coa_temp           = $('.kode_coa_temp_'+data).val();
            var nominal_temp            = $('.nominal_temp_'+data).val();
            ...
            $(".button-" + data).hide();
            var tableHTML = '<tr id="temp_'+urut+'">' +
              '<td>' +
              '<input id="kode_coa'+urut+'" readonly type="text" name="temp["kode_coa"][]" onclick="showModalCOAS('+urut+')"  class="form-control  input-clean isi kode_coa_temp_'+ button+'" placeholder="Kode COA"> ' +
              '</td>'+
              '<td>' +
              '<input id="coa'+urut+'"  readonly    type="text"  name="temp["kode_coa"][]" class="form-control  input-clean isi_combo coa_temp_'+button+'" onclick="showModalCOAS('+urut+')" placeholder="COA"> ' +
              '</td>'+
              '<td>' +
              '<select class="form-control isi_combo select2"    name="temp["referensi"][]" id="referensi" onchange="cek_ref()"></select>' +
              '</td>'+
              '<td>' +
              '<input type="text" class="form-control isi_combo  input-clean" id="sisa_hutang'+urut+'" name="temp["sisa_hutang"][]" placeholder="Sisa Hutang" readonly>' +
              '</td>'+
              '<td>' +
              '<input type="text" class="form-control isi_combo tanpa_rupiah nominal_temp  input-clean" id="nominal" name="temp["nominal"][]"  placeholder="Nominal">' +
              '</td>'+
              '<td>' +
              '<input type="text" class="form-control isi_combo  input-clean" id="keterangan" placeholder="Keterangan"  name="temp["keterangan"][]" >' +
              '</td>'+
              '<td class ="button-set-'+urut+'" >' +
              '<button type="button" onClick="add_coa_temp('+button+')" class="btn btn-sm btn-primary btn-flat button-'+button+'"><i class="fa fa-plus"></i></button>' +
              '</td>' +
              '</tr>';
              $('.button-set-'+data).append('<button type="button" onClick="delete_coa_temp('+data+')" class="btn btn-sm btn-danger btn-flat button-'+data+'"><i class="fa fa-trash"></i></button>');
              $('#coa-tbody').append(tableHTML);
              calculateTotal();
           }

          function calculateTotal() {
              var calculatedTotalSums = 0;
              $(".nominal_temp").each(function() {
                  var getTextboxValue = parseFloat($(this).val()) || 0;
                  calculatedTotalSums += getTextboxValue;
              });

              $(".total_temp").val(calculatedTotalSums);
              $(".set_value_total_temp").val(calculatedTotalSums);
          }

          function delete_coa_temp(set) {
            $("#temp_"+set).remove();
            calculateTotal();
          }

          function add_voucher_temp(set){ 
            var temp = set + 1;
            var tgl_transfer_voucher = $(".tgl_transfer_voucher_temp").val();
            var nominal_voucher_temp = $(".nominal_voucher_temp").val();

            if (tgl_transfer_voucher == '' ) {
                alert('Tgl Transfer Tidak Boleh Kosong');
            } 
            
            if (nominal_bg == '' ){
                alert('Nominal BG tidak Boleh Kosong');
              return false;
            }
             ...
             var tableHTML = 
              '<tr id="voucher_'+set+'">' +
                  '<th width="5%">'+set+'</th>' +
                  '<th><input type="text" class="nominal_voucher  input-clean" name="tgl_jatuh_tempo[]" value="'+tgl_transfer_voucher+'" id="" readonly> </th>' +
                  '<th><input type="text" class="nominal_voucher  input-clean" name="nominal[]" value="'+nominal_voucher_temp+'" id="" readonly> </th>' +
                  '<th width="7%"> <button title="Hapus Data" class="btn btn-sm btn-danger btn-flat fa fa-trash-o" type="button" onclick="hapus_voucher_temp('+set+')"></button>  </th>' +
              '</tr>';

            $('.table-voucher-append').append(tableHTML);

            $(".tgl_transfer_voucher_temp").val();
            $(".nominal_voucher_temp").val();

            var calculatedTotalSums = 0;
            $(".nominal_voucher").each(function() {
                var getTextboxValue = parseFloat($(this).val()) || 0;
                calculatedTotalSums += getTextboxValue;
            });

            $(".total_voucher_temp").val(calculatedTotalSums);
            $(".set_value_total_temp").val(calculatedTotalSums);
          }

          function hapus_voucher_temp(set){
          $("#voucher_" + set).remove();
          calculateTotalVoucher();
         }

         
         function add_bg_temp(set){
          var temp = set + 1;
          var tgl_jatuh_tempo_bg = $(".tgl_jatuh_tempo_bg").val();
          var nominal_bg         = $(".nominal_bg_temp").val();
          var no_bg              = $(".no_bg_temp").val();

          if (tgl_jatuh_tempo_bg == ''){
          ...
          '<tr id="bg_'+set+'">' +
              '<th width="5%">'+set+'</th>' +
              '<th><input type="text"  class="input-clean" name="no_bg[]" value="'+no_bg+'" readonly></th>' +
              '<th><input type="text"  class="input-clean" name="tgl_jatuh_tempo[]" value="'+tgl_jatuh_tempo_bg+'"  readonly></th>' +
              '<th><input type="text"  class="input-clean nominal_bg" name="nominal[]" value="'+nominal_bg+'" class="" readonly> </th>' +
              '<th width="7%"> <button title="Hapus Data" class="btn btn-sm btn-danger btn-flat fa fa-trash-o" type="button" onclick="hapus_bg_temp('+set+')"></button> </th>' +
          '</tr>';

          $('.table-bg-append').append(tableHTML);
          $(".tgl_jatuh_tempo_bg").val('');
          $(".nominal_bg_temp").val('');
          calculateTotalBG();
         }

         function hapus_bg_temp(set){
          $("#bg_" + set).remove();
          calculateTotalBG();
         }

         function calculateTotalBG() {
            var calculatedTotalSums = 0;
            $(".nominal_bg").each(function() {
                var getTextboxValue = parseFloat($(this).val()) || 0;
                calculatedTotalSums += getTextboxValue;
            });

            $(".total_bg_temp").val(calculatedTotalSums);
            $(".set_value_total_temp").val(calculatedTotalSums);
            }


         function showModalCOAS(data) {
          $.ajax({
            url: "<?php echo site_url('master/coa/coa_popups'); ?>",
            type: "POST",
            data:{
              temp : data,
            },
        ...
        <script>
          ...
          var set_value_total_temp = $(".set_value_total_temp").val();
          var total_temp            = $(".total_temp").val();

          if (set_value_total_temp !== total_temp ){
            alert('Nominal Tidak Sama Mohon Periksa Kembali !');
            return false;
          }
      ...
      ?>
        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-md-12">
                <form id="form_entri" class="form-horizontal" action="h1/voucher_pengeluaran_banks/<?= $form ?>" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      <!-- testing -->
        ...
        <script>
            ...
            computed: {
              ...
              totNominalDetails: function() {
                ...
                for (dtl of this.details) {
                  ...
                  console.log(total); // ada yg char dan numeric
          ...
          $('#submitBtn').click(function() {
            ...
            if ($('#form_entri').valid()) // check if form is valid
            {
              ...
              alert('Silahkan isi field requireds !')
            }
          })
  ...
  <script type="text/javascript">
    ...
    function sum() {
      ...
      $.ajax({
        url: "<?php echo site_url('h1/voucher_pengeluaran_banks/cari_total') ?>",
        type: "POST",
    ...
    function kirim_detail() {
      ...
      //var data = "birthday1="+birthday1_js;          
      var data = "id_voucher_bank=" + id_voucher_bank;
      xhr.open("POST", "h1/voucher_pengeluaran_banks/t_detail", true);
      xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
      xhr.send(data);
      xhr.onreadystatechange = display_data;
