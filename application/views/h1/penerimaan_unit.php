...
<section class="content-header">
  ...
  <section class="content">
    ...
    //     //datatables
    //     modal_detail32 = $('#example123').DataTable({ 
    ...
    //         "ajax": {
    //             "url": "<?php echo site_url('h1/penerimaan_unit_sl_datatable')?>",
    //             "type": "POST"
    //         },
          ...
          function launchQZ() {
            ...
            function startConnection(config) {
                if (!qz.websocket.isActive()) {
                    ...
                    qz.security.setCertificatePromise(function(resolve, reject) {
                      fetch("assets/tray/assets/signing/digital-certificate.txt", {cache: 'no-store', headers: {'Content-Type': 'text/plain'}})
    ...
    */?>
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        ?>
        <table id="table_penerimaan_unit" class="table table-bordered table-hover">
          <thead>
          <tr>
              <!--th width="1%"><input type="checkbox" id="check-all"></th-->              
              <th width="5%">No</th>
    ...
    <script>
      $( document ).ready(function() {
      tabless = $('#table_penerimaan_unit').DataTable({
            "scrollX": true,
            "processing": true, 
            "bDestroy": true,
            "serverSide": true, 
            "order": [],
            "ajax": {
              "url": "<?php  echo site_url('h1/penerimaan_unit/fetch_data_penerimaan_unit_datatables')?>",
                "type": "POST"
            },  
    ...
    */?>
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        ?>
        <table id="table_penerimaan_unit_history" class="table table-bordered table-hover">
          <thead>
          <tr>
              <th width="5%">No</th>
              <th>No Penerimaan Unit</th>
    ...
    <script>
      $( document ).ready(function() {
        tabless = $('#table_penerimaan_unit_history').DataTable({
            "scrollX": true,
            "processing": true, 
            "bDestroy": true,
            "serverSide": true, 
            "order": [],
            "ajax": {
              "url": "<?php  echo site_url('h1/penerimaan_unit/fetch_data_penerimaan_unit_history_datatables')?>",
                "type": "POST"
            },  
