...
<link href="https://fonts.googleapis.com/css2?family=Roboto&display=swap" rel="stylesheet"> 
       ...
       <body>
           ...
           <table class="word-table">
               ...
               <?php $harga_neto = $rows->harga_dealer_user - ($rows->harga_dealer_user * $diskonDealertoDecimal);?>
                ...
                <tr>
                    ...
                    <td><p><?php echo number_format($rows->harga_dealer_user - ($rows->harga_dealer_user * $diskonDealertoDecimal),0,',','.')?></p></td>
           ...
           <table class="word-table2">
               ...
               <tr>
                <th style="padding:25px 0px;vertical-align:text-bottom"><p style="margin-bottom:-100px !important; font-weight:normal">Nama :</p></th>
                <th style="padding:25px 0px;vertical-align:text-bottom"><p style="margin-bottom:-100px !important; font-weight:normal">Nama :</p></th>
                <th style="padding:25px 0px;vertical-align:text-bottom"><p style="margin-bottom:-100px !important; font-weight:normal">Nama :</p></th>
                <th style="padding:25px 0px;vertical-align:text-bottom"><p style="margin-bottom:-100px !important; font-weight:normal">Nama :</p></th>
               </tr>
