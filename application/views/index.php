      ...
      <section class="col-lg-12 connectedSortable pull-left">
        <div class="box box-warning">
          ...
          <div class="box-body chat" id="chat-box">
            <table class="table table-bordered table-hovered table-striped " id="showDetailStok"></table>
          </div>
        </div>
      </section>      
            ...
            <table class="table table-bordered table-hovered table-striped" id="tabel_finance">
              ...
              <tfoot>
                <tr>
                  ...
                  <th><?php echo $stk['jml_bulan'] ?> Unit</th>
                  <th></th>                  
                </tr>
              </tfoot>
            </table>
          ...
          <div class="box-body chat" id="chat-box">
            <table class="table table-bordered table-hovered table-striped" id="tabel_finance2">
              ...
              <tfoot>
                <tr>
                  <th>Total</th>
                  <th><?php echo $stk['jml_hari'] ?> Unit</th>
                  <th><?php echo $stk['jml_bulan'] ?> Unit</th>                  
                </tr>
              </tfoot>
            </table>
