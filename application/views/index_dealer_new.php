...
<body onload="tampil_grafik();daily();">
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      $stk = $this->m_admin->get_data_dashboard_dealer($tgl, $id_dealer);
	    $ordIn = $this->m_admin->get_data_orderin($tgl, $id_dealer);
      ?>
      <div class="row">
        <div class="col-sm-3" style="min-height: 195px !important">
          <div class="box box-warning">
            ...
            <div class="box-body box-warning" id="copyReport" style="min-height: 195px">
                <br>
              <b><?php
              ...
              <?php if (is_array($stk['series_detail'])) : ?>
                ...
                echo "AT LOW " . $jml_hari . "/" . $jml_bulan;
                ?>
                <?php foreach ($stk['series_detail'] as $ser) : ?>
                  <br><?= $ser['series'] . ' ' . $ser['jml_hari'] . '/' . $ser['jml_bulan'] ?>
                <?php endforeach ?>
              <?php endif ?>
            </div>
          </div>
        ...
        <div class="col-sm-3">
            <div class="box box-warning" >
                <div class="box-body" style="min-height: 215px !important">
        ...
        <div class="col-sm-6" style="min-height: 195px  !important">
          <div class="row">
            <div class="col-sm-4">
              <div class="small-box bg-aqua">
                <div class="inner">
                  <div style="font-weight:bold; font-size:26px;"><?= $stk['jml_hari'] ?></div>
            ...
            <div class="col-sm-4">
              <div class="small-box bg-yellow">
                <div class="inner">
                  <div style="font-weight:bold; font-size:26px;"><?= $stk['jml_bulan'] ?></div>
                  <p>Total Bulan Ini</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-4">
              <div class="small-box bg-green">
                <div class="inner">
                  <div style="font-weight:bold; font-size:26px;"><?= $stk['jml_kemarin'] ?></div>
                  <p>Kemarin</p>
                </div>
              </div>
            </div>
              ...
              <div class="small-box bg-red">
                <div class="inner">
                  <p>
		            ...
		            <div style="font-weight:bold; font-size:17px;"><?= $y .' '.$f?></div>
            ...
            <div class="col-sm-4">
              <div class="small-box" style="background-color:#0c3c52; color:white">
                <div class="inner">
                  <div style="font-weight:bold; font-size:26px;"><?= $ordIn['walkin'].'/'.$ordIn['walkin_cum'] ?></div>
                  <p>Walk In/ Cummulative <br>&nbsp;</p>
            ...
            <div class="col-sm-4">
              <div class="small-box" style="background-color:#917c3c; color:white">
                <div class="inner">
                  <div style="font-weight:bold; font-size:26px;"><?= $ordIn['success'].'/'.$ordIn['success_cum'].'/'.$ordIn['success_ratio'] ?></div>
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
              <div class="small-box" style="background-color:#3d34eb; color:white">
                <div class="inner">
                  <div style="font-weight:bold; font-size:26px;"><?= $ordIn['orderin'].'/'.$ordIn['orderin_cum'] ?></div>
            ...
            <div class="col-sm-6">
              <div class="small-box" style="background-color:#ffbe45; color:white">
                <div class="inner">
                  <div style="font-weight:bold; font-size:26px;"><?= $ordIn['reject'].'/'.$ordIn['reject_cum'].'/'.$ordIn['reject_ratio'] ?></div>
        ...
        <div class="col-sm-6" id="divSalesFincContDP">
          <div class="box box-warning">
            <div class="box-header">
              ...
              <div class="box-tools pull-right">
                <a class="btn btn-primary btn-sm" target="_blank" href="<?= base_url('/dashboard/getSalesFincoByDPDealer_new?download=y&tanggal=' . $tgl) ?>"><i class="fa fa-download"></i></a>
              </div>
            </div>
          ...
          <div class="box box-warning">
            ...
            <div class="box-body" style="min-height: 259px;">
                <div class="table-responsive" id="resp">
                    <table class="table table-bordered table-hovered table-striped" id="showSalesPerformance" style="font-size: 10pt;text-align:center;width:100%"></table>
                </div>
            </div>
          </div>
        </div>
            ...
            <div class="box-body" style="min-height: 259px;">
              ...
              <div class="box-body box-warning" id="copyReport2" style="min-height: 200px">
                <table style="font-size:18px;" width="80%" class="table table-bordered">
                  ...
                  $y = date('Y');
                  $id_dealer = $this->m_admin->cari_dealer();
                  $retail = $this->m_admin->get_penjualan_dashboard('tahun', $y, null, $id_dealer);
                  ...
                  $faktur = $this->db->query("SELECT SUM(jum) AS hasil FROM
                    ...
                    SELECT COUNT(tr_faktur_stnk_detail.no_mesin) AS jum FROM tr_faktur_stnk_detail 
                        ...
                        WHERE LEFT(tr_sales_order.tgl_cetak_invoice,4) = '$y' AND tr_faktur_stnk.id_dealer = '$id_dealer' 
                    ...
                    SELECT COUNT(tr_faktur_stnk_detail.no_mesin) AS jum FROM tr_faktur_stnk_detail 
                        ...
                        WHERE LEFT(tr_sales_order_gc.tgl_cetak_invoice,4) = '$y' AND tr_faktur_stnk.id_dealer = '$id_dealer' 
                        AND tr_faktur_stnk.status_faktur = 'approved'                                    
                    )a");
          ...
          <div class="box box-warning">
            <div class="box-header">
              ...
              <div class="box-tools pull-right">
                ...
                <button class="btn btn-danger btn-sm" type="button" onclick="previewStock()"><span class="fa fa-eye"></span></button>
              </div>
            </div>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      INNER JOIN ms_provinsi ON ms_kabupaten.id_provinsi = ms_provinsi.id_provinsi
      WHERE ms_dealer.id_dealer='$id_dealer'")->row();
          $sq = $this->db->query("SELECT tr_prospek.id_karyawan_dealer AS sales, ms_karyawan_dealer.nama_lengkap, tr_spk.no_spk 
          FROM tr_sales_order 
          ...
          JOIN ms_dealer ON ms_karyawan_dealer.id_dealer = ms_dealer.id_dealer
          JOIN ms_kelurahan ON ms_dealer.id_kelurahan = ms_kelurahan.id_kelurahan
          INNER JOIN ms_kecamatan ON ms_kelurahan.id_kecamatan = ms_kecamatan.id_kecamatan
          INNER JOIN ms_kabupaten ON ms_kecamatan.id_kabupaten = ms_kabupaten.id_kabupaten
          INNER JOIN ms_provinsi ON ms_kabupaten.id_provinsi = ms_provinsi.id_provinsi
          WHERE tr_sales_order.tgl_cetak_invoice IS NOT NULL AND LEFT(tr_sales_order.tgl_cetak_invoice,7) = '$bln'              
          AND ms_kabupaten.id_kabupaten = '$cari_daerah->id_kabupaten' and ms_dealer.id_dealer ='$id_dealer'
          GROUP BY tr_prospek.id_karyawan_dealer
          ORDER BY ms_karyawan_dealer.nama_lengkap ASC");

          foreach ($sq->result() as $isi) {
            $sr = $this->db->query("SELECT count(tr_sales_order.no_mesin) as jum 
              FROM tr_sales_order 
              JOIN tr_spk ON tr_sales_order.no_spk = tr_spk.no_spk
              JOIN tr_prospek ON tr_spk.id_customer = tr_prospek.id_customer
              JOIN ms_karyawan_dealer ON tr_prospek.id_karyawan_dealer = ms_karyawan_dealer.id_karyawan_dealer 
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      WHERE ms_dealer.id_dealer='$id_dealer'")->row();
          ...
          INNER JOIN ms_provinsi ON ms_kabupaten.id_provinsi = ms_provinsi.id_provinsi
          WHERE tr_sales_order.tgl_cetak_invoice IS NOT NULL AND LEFT(tr_sales_order.tgl_cetak_invoice,7) = '$bln'              
          AND ms_provinsi.id_provinsi = '$cari_daerah->id_provinsi' and ms_dealer.id_dealer='$id_dealer'
          GROUP BY tr_prospek.id_karyawan_dealer
          ORDER BY ms_karyawan_dealer.nama_lengkap ASC");
          foreach ($sq->result() as $isi) {
            $sr = $this->db->query("SELECT count(tr_sales_order.no_mesin) as jum 
  ...
  <script type="text/javascript">
    ...
    function getSalesFincoByDP() {
      $.ajax({
        ...
        url: "<?php echo site_url('dashboard/getSalesFincoByDPDealer_new') ?>",
        type: "POST",
        data: values,
        cache: false,
        success: function(response) {
    ...
    function getTotalDistribusiOfYear() {
        $.ajax({
            ...
            url: "<?php echo site_url('dashboard/getTotalDistribusiOfYearDealer') ?>",
            type: "POST",
            data: values,
            cache: false,
            success: function(response) {
