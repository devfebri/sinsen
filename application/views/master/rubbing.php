                      ...
                      foreach($dt_nosin->result() as $row) {           
                        ...
                        <tr>                    
                          ...
                          <td width='1%' align='center'>
                            ...
                            <input type='checkbox' disabled name='check_$no' $c>          
                          </td>
                        </tr>";    
                        $no++;
                        }
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          foreach($dt_rubbing->result() as $row) {                                         
            if($row->status_rubbing=='input'){
              ...
              $tom = "<a href='h1/rubbing/approval?id=$row->no_rubbing' type='button' class='btn btn-flat btn-primary btn-xs'><i class='fa fa-check'></i> Approve/Reject</a>";
            }else{
