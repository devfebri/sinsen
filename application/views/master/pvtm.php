  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="master/pvtm/import_db" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Choose File</label>
                  <div class="col-sm-10">
                    <input type="file" accept=".PVTM" required class="form-control" autofocus name="userfile">                    
                  </div>                  
                </div>                                                                                                      
              </div><!-- /.box-body -->
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <table id="example4" class="table table-bordered table-hover">
          ...
          <?php 
          $no=1; 
          foreach($dt_pvtm->result() as $row) {          
          echo "          
            <tr>
              <td>$no</td>
              <td>$row->no_part</td>
              <td>$row->tipe_marketing</td>              
            </tr>";                        
          $no++;
          }
          ?>
