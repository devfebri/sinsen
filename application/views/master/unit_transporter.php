  ...
  <section class="content">
    ...
    <div class="box box-default">
      <div class="box-header with-border">
        <h3 class="box-title">
          <a href="master/unit_transporter">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="master/unit_transporter/save" method="post" enctype="multipart/form-data">
              <div class="box-body">   
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="master/unit_transporter/update" method="post" enctype="multipart/form-data">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">
          <a href="master/unit_transporter/add">
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          echo "          
            <tr>
              ...
              <td>";
              ?>
                <a data-toggle='tooltip' title="Delete Data" onclick="return confirm('Are you sure to delete this data?')" class="btn btn-danger btn-sm btn-flat" href="master/unit_transporter/delete?id=<?php echo $row->id_unit_transporter ?>"><i class="fa fa-trash-o"></i></a>
                <a data-toggle='tooltip' title="Edit Data" class='btn btn-primary btn-sm btn-flat' href='master/unit_transporter/edit?id=<?php echo $row->id_unit_transporter ?>'><i class='fa fa-edit'></i></a>
              </td>
            </tr>
          <?php
          $no++;
    ...
    if(confirm('Are you sure delete this '+list_id.length+' data?'))
      {
        $.ajax({
          type: "POST",
          data: {id:list_id},
          url: "<?php echo site_url('master/unit_transporter/ajax_bulk_delete')?>",
          dataType: "JSON",
