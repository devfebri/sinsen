            ...
            <div class="row">
              <div class="col-md-12">
                <form class="form-horizontal" action="master/dealer/save" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Tampilkan PPN H23</label>
                    <div class="col-sm-4">
                      <select class="form-control" required name="tampil_ppn_h23">
                        <option value="">- choose - </option>
            ...
            <form class="form-horizontal" action="master/dealer/update" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="field-1" class="col-sm-2 control-label">Logo</label>
                  <div class="col-sm-4">
                    <p style="font-weight: bold;">*) Logo sebelumnya : <br>
                      <img src="<?php echo base_url() ?>/assets/panel/images/<?php echo $row->logo ?>" style="width: 100px;">
                    </p>
                    <input type="file" class="form-control" name="logo">
                    <input type="hidden" name="logo_old" value="<?php echo $row->logo ?>">
                  </div>
                  <label for="field-1" class="col-sm-2 control-label">Favicon</label>
                  <div class="col-sm-4">
                    <p style="font-weight: bold;">*) Favicon sebelumnya : <br>
                      <img src="<?php echo base_url() ?>/assets/panel/images/<?php echo $row->favicon ?>" style="width: 100px;">
                    </p>
                    <input type="file" class="form-control" name="favicon">
                    <input type="hidden" name="favicon_old" value="<?php echo $row->favicon ?>">
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <select class="form-control" required name="tampil_ppn_h23">
                    <option value="">- choose - </option>
                    <option value=1 <?= $row->tampil_ppn_h23 == 1 ? 'selected' : ''; ?>>Ya</option>
                    <option value=0 <?= $row->tampil_ppn_h23 == 0 ? 'selected' : ''; ?>>Tidak</option>
                  </select>
                </div>
              </div>
              <div class="form-group">
