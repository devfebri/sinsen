      ...
      <div class="box-body">
                ...
                <!-- <div class="form-group">
                 ...
                 <div class="form-group">                  
                  ...
                  <div class="col-sm-4">
                    ...
                    <input type="text" value="<?php echo $row->id_tipe_kendaraan ?>" class="form-control" placeholder="Tipe Kendaraan" name="id_tipe_kendaraan" id="id_tipe_kendaraan" readonly>
		...
		<label for="inputEmail3" class="col-sm-2 control-label">Warna</label>
                  ...
                  <div class="col-sm-4">
                    ...
                    <input type="text" value="<?php echo $row->warna ?>" class="form-control" placeholder="Warna" name="warna" id="warna" readonly>
                ...
                <div class="form-group">                  
                  ...
                  <label for="inputEmail3" class="col-sm-2 control-label">Lead Time Pemenuhan Indent By AHM (hari)</label>

                  <div class="col-sm-4">

                    <input type="text" value="<?php echo $row->proses_indent_ahm ?>" class="form-control" placeholder="Tipe Kendaraan" name="proses_indent_ahm" id="proses_indent_ahm" onchange="total_lead()" required>
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          <thead>
            ...
            <tr>
              ...
              <th>Lead Time Pemenuhan Indent By AHM</th>
          ...
          // log_r($k->active);     
            ...
            <tr>
              ...
              <td>$k->id_tipe_kendaraan</td>          

              <td>$k->warna</td>                                          

              <td>$k->proses_indent_ahm</td>                                          
              ...
              <td>"; ?>
                ...
                <a <?php echo $this->m_admin->set_tombol($id_menu,$group,"edit"); ?> data-toggle='tooltip' title="Edit Data" class='btn btn-primary btn-sm btn-flat' href='master/master_lead/edit?id=<?php echo $k->id_master_lead_detail ?>&id_tipe_kendaraan=<?php echo $k->id_tipe_kendaraan ?>&warna=<?php echo $k->warna ?>'><i class='fa fa-edit'></i></a>
...
function total_lead(){
  ...
  var a5      = document.getElementById("proses_indent_ahm").value;       
...
$("#lead_time_ahm_md").keyup(function() {

    total_lead();

});

$("#proses_receiving_md").keyup(function() {

    total_lead();

});

$("#lead_time_md_d").keyup(function() {

    total_lead();

});

$("#proses_receiving").keyup(function() {

    total_lead();

});

$("#proses_indent_ahm").keyup(function() {
