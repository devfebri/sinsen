<label for="inputEmail3" class="col-sm-4 control-label">Tipe</label>
                  ...
                  <div class="col-sm-1"><button class="btn btn-primary btn-sm" type="button" onclick="addStok()"><i class="fa fa-plus"></i></button></div>
<br>    <br>   <div class="col-sm-offset-2 col-sm-9">
       	<table class="table table-condensed table-bordered" >
       		...
       		<?php $no=1;foreach ($fast->result() as $rs_f): ?>
     ...
     function addStok()
	  {
	      var value={id_tipe_kendaraan:$('#id_tipe_kendaraan').val(),
	                 jenis_moving:'fast',
	                 persen_stok_ditahan:$('#stok_ditahan_fast').val(),
