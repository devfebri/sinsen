  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="master/refferal/import_db" method="post" enctype="multipart/form-data">
              <div class="box-body">
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('master/refferal/ajax_list')?>",
            "type": "POST"
        },
