...
<script>
  $(document).ready(function(){  
      var dataTable = $('#datatable_server').DataTable({  
         ...
         "ajax":{  
              url:"<?php echo site_url('master/part').'/fetch'; ?>",  
              type:"POST",
              dataSrc: "data",
              //data: {id_provinsi:$('#id_provinsi').val()}  
              data: function ( d ) {
                //   d.kode_lokasi = $('#kode_lokasi').val();
                //   // d.nama_lokasi = $('#nama_lokasi').val();
                //   d.nama_tingkat = $('#nama_tingkat').val();
                //   d.nama_gudang = $('#nama_gudang').val();
                //   d.nama_rak = $('#nama_rak').val();
                //   d.nama_lantai = $('#nama_lantai').val();
      ...
      $(inputColumns).each( function (index, value) {
          $('#'+value).keyup(_.debounce(function(e){
              dataTable.draw();
          }, 500));
      });  
});  
