    ...
    ?>
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">
            <a href="master/dgi_activity_log_md">
      ...
      $this->load->view('master/h2_api', $data); ?>
      <script>
        ...
        function generateKey() {
          ...
          $.ajax({
            ...
            url: '<?= base_url('master/dgi_activity_log_md/generateKey') ?>',
            type: "POST",
            data: values,
            cache: false,
            dataType: 'JSON',
          ...
          if ($('#form_').valid()) // check if form is valid
          {
            ...
            if (confirm("Apakah anda yakin ?") == true) {
              $.ajax({
                ...
                url: '<?= base_url('master/dgi_activity_log_md/' . $form) ?>',
                type: "POST",
                data: values,
                cache: false,
                dataType: 'JSON',
          ...
          <script>
            $(document).ready(function() {
              var dataTable = $('#datatable_server').DataTable({
                ...
                "ajax": {
                  url: "<?php echo site_url('master/dgi_activity_log_md/fetch'); ?>",
                  type: "POST",
                  dataSrc: "data",
                  data: function(d) {
                    return d;
