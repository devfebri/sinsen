    ...
    ?>
              ...
              <form id="form_" class="form-horizontal" method="post" enctype="multipart/form-data">
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" name="kode_detail" id="kode_detail" autocomplete="off" value="<?= isset($row) ? $row->kode_detail : '' ?>" :readonly="mode=='detail'" <?= $readonly ?> disabled>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Nama Detail Work List</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" name="nama_detail" id="nama_detail" autocomplete="off" value="<?= isset($row) ? $row->nama_detail : '' ?>" :readonly="mode=='detail'" required>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-2">
                      <div id="label-switch" class="make-switch" data-on-label="<i class='entypo-check'></i>" data-off-label="<i class='entypo-cancel'></i>">
                        <input <?= $disabled ?> type="checkbox" class="form-control flat-red" name="status" value="1" <?= isset($row) ? $row->status == 1 ? 'checked' : '' : 'checked' ?>>
                      </div>
                    </div>
                  </div>
                </div><!-- /.box-body -->
      ...
      <script>
        ...
        $('#submitBtn').click(function() {
          ...
          {
            <?php if (isset($row)) { ?>
              values['kode_detail_old'] = '<?= $row->kode_detail ?>';
            <?php } ?>
