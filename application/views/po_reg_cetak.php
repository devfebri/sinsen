...
<link href="https://fonts.googleapis.com/css2?family=Roboto&display=swap" rel="stylesheet"> 
       ...
       <body>
        <?php /*
           ...
           <table >
                <?php if($data['po_nmd']=='1'){?>
                    <caption><h3 style="font-family: 'Roboto', sans-serif;font-size:12px;">FORM ORDER REGULER ORDER - NON-MD SINSEN</h3></caption>
                <?php }else{ ?>
                    <caption><h3 style="font-family: 'Roboto', sans-serif;font-size:12px;">FORM ORDER REGULER ORDER</h3></caption>
                <?php } ?>
               <tr>
