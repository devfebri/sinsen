    ...
    <div class="box box-default">
      <br>
        <div class="row">
          <div class="col-md-12">
           <center>
             <img src="assets/panel/access_denied.png">
             <h2>Access Denied!</h2>
             <p>You don't have permission to access this page. <br>
             Please contact your Administrator to request access.</p> <br>
             <button type="button" onclick="kembali()" class="buttonstyle">Go Back</button>
           </center>
           <br><br><br>
          </div>
        </div>
