        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                               <button class="btn btn-primary btn-sm btn-flat" type="button" id="btn-cari_customer_rd"><span class="fa fa-search"></span>Search</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <script>
                    ...
                    //             { data: 'no_polisi' }, 
                    //             { data: 'no_identitas' }, 
                    //             { data: 'aksi', orderable: false, className: 'text-center', width: '3%' }
                    //         ],
                    //     });
                    // });

                    function drawing_customer_rd() {
                        $('#datatable-customer').DataTable({
                            processing: true,
                            serverSide: true,
                            searching: false, 
                    ...
                    $(document).ready(function() {
                        $('#btn-cari_customer_rd').click(function(e){
