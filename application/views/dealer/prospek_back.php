                  ...
                  <div class="col-sm-4">
                    <input type="text" required class="form-control" id="id_customer" readonly placeholder="ID Customer" name="id_customer">                    
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input type="text" required class="form-control" placeholder="Nama Konsumen" name="nama_konsumen" value="<?= isset($row) ? $row->nama_konsumen : '' ?>" :disabled="mode=='detail'">
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">No HP *</label>
                          <div class="col-sm-4">
                            <input type="text" class="form-control" maxlength="15" onkeypress="return number_only(event)" required placeholder="No HP" name="no_hp" value="<?= isset($row) ? $row->no_hp : '' ?>" :disabled="mode=='detail'">
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <select class="form-control" name="pekerjaan" required required :disabled="mode=='detail'">
                              <option value="">- choose -</option>
                              <?php
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input type="text" id="tempat_lahir" class="form-control" placeholder="Tempat Lahir" name="tempat_lahir" value="<?= isset($row) ? $row->tempat_lahir : '' ?>" :disabled="mode=='detail'">
                          </div>
                          <label for="inputEmail3" class="col-sm-2 control-label">Tgl.Lahir</label>
                          <div class="col-sm-4">
                            <input type="text" id="tanggal4" class="form-control tgl_lahir" placeholder="Tgl.Lahir" name="tgl_lahir" onchange="cek_umur()" value="<?= isset($row) ? $row->tgl_lahir : '' ?>" :disabled="mode=='detail'">
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <select class="form-control" name="status_prospek" v-model='status_prospek' :disabled="mode=='detail'">
                              <option value="">- choose -</option>
                              <option>Low</option>
                              <option>Hot</option>
                      ...
                      <option>Loss</option>   -->
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-4">
                            <input type="text" class="form-control" name="catatan" value="<?= isset($row) ? $row->catatan : '' ?>" :disabled="mode=='detail'">
                          </div>
                    ...
                    <form class="form-horizontal" action="dealer/prospek/update_gc" method="post" enctype="multipart/form-data" id='form_'>
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">No HP *</label>
                          <div class="col-sm-4">
                            <input type="text" class="form-control" maxlength="15" onkeypress="return number_only(event)" required value="<?php echo $row->no_hp ?>" placeholder="No HP" name="no_hp">
                          </div>
                          <label for="inputEmail3" class="col-sm-2 control-label">Status No Hp *</label>
                          <div class="col-sm-4">
                            <select class="form-control" name="status_nohp" required>
