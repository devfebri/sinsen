                  ...
                  <div class="col-sm-12">
                    <table class="table table-condensed table-hover table-bordered" >
                      <thead>
                        <th width="5%">No.</th>
                        <th width="60%">Tipe</th>
                        <th width="10%">Suggestion Dsitribusi</th>                        
                      </thead>
                      <tbody>
                        <?php $no=1; foreach ($dt_detail->result() as $key => $rs): ?>
                              ...
                              <tr>
                                ...
                                <td style="text-align: right;"><input type="text" name="qty_order_<?=$key?>" class="form-control isi" value="<?=floor($rs->qty_order)?>" readonly></td>
                              </tr>                              
                          <?php $no++; endforeach ?>
                      </tbody>
                    </table>
