                    ...
                    <div class="col-sm-4">
                      <input id="nama_bpkb" type="text" required class="form-control" placeholder="Nama STNK/BPKB" name="nama_bpkb">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input type="text" class="form-control input_angka" name="tanda_jadi" id="tanda_jadi" required>
                          </div>
                        </div>
              ...
              $('#submitBtn').click(function() {
                ...
                if ($('#form_').valid()) // check if form is valid
                {
                  ...
                  if (jenis_beli == 'Cash') {
                    ...
                    if (id_program_md != '' && voucher_1 === 0 && id_program_md.substr(-6) != 'SP-002') {
                      toastr_error('Sales program terpilih, tetapi voucher tidak terisi !');
                      return false;
                    }
                    ...
                    if (id_program_md != '' && voucher_2 === 0 && id_program_md.substr(-6) != 'SP-002') {
                      toastr_error('Sales program terpilih, tetapi voucher tidak terisi !');
                      return false;
                    }
		    
		    let dp_stor = parseInt($('#dp_stor').val());
		    if(dp_stor < 0) {
			toastr_error('Silahkan cek kembali inputan nilai DP Gross / DP Setor !');
	                return false;
		    }
                    ...
                    <form id="form_" class="form-horizontal" action="dealer/spk/save_gc" method="post" enctype="multipart/form-data">
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input class='form-control input_angka' name='tanda_jadi' value='0' />
                          </div>
                        </div>
                    ...
                    <form class="form-horizontal" action="dealer/spk/update_gc" method="post" enctype="multipart/form-data">
                      ...
                      <option class="hide">Cash</option> -->
                        ...
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">Tanda Jadi Sementara</label>
                          <div class="col-sm-4">
                            <input class='form-control input_angka' name='tanda_jadi' value='<?= $row->tanda_jadi ?>' <?= $readonly ?> />
                          </div>
                        </div>
                        <!-- <div class="col-sm-3">                    
                    <button class="btn btn-primary btn-flat" type="button" onclick="tampil_cash()"><i class="fa fa-refresh"></i> Cash</button>
                  ...
                  <div class="col-sm-10">
                    ...
                    <button onclick="take_harga()" type="button">generate</button>
                        ...
                        <div class="form-group">
                          <label for="inputEmail3" class="col-md-offset-6 col-sm-2 control-label">Tanda Jadi *</label>
                          <div class="col-sm-4">
                            <input type="text" class="form-control input_angka" name="tanda_jadi" id="tanda_jadi" value="<?= $row->tanda_jadi ?>" <?= $readonly ?>>
                          </div>
                        </div>
                        <button class="btn btn-block btn-primary btn-flat" disabled> EVENT </button> <br>
                        <div class="form-group">
...
*/ ?>
          ...
          ?>
            <div class="box">
			  ...
			  $tombol = $btn_cetak;
                          ...
                          $tombol .= " <a data-toggle='tooltip' title='Cancel' class='btn btn-danger btn-xs btn-flat' href='dealer/spk/cancel?id=$row->no_spk'><i class='fa fa-close'></i> Cancel</a>";
			}
                      }
                    ...
                    <form class="form-horizontal" id="form_" action="dealer/spk/save_cancel" method="post" enctype="multipart/form-data">
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <select name="id_reasons" class="form-control select2" onchange="cekLain(this)" required>
      ...
      <script type="text/javascript">
        $(document).ready(function() {
          ...
          $('.input_angka').on('keypress', function(e) {
              ...
              success: function(html) {
                ...
                if (data.length > 2) {
                  if (jenis_beli == 'Cash') {
                    ...
                    if (data[0] != '' || data[0] > 0) {
                      // var harga_on_r = $("#harga_on_r").val();
                      // var n_harga_on_r = convertToAngka(harga_on_r);
                      // var hasil = n_harga_on_r - parseInt(data[0]);
                      // $("#harga_on_r").val(convertToRupiah(hasil));
                      // take_harga(data[0]);
                      $("#nilai_voucher").show();
        ...
        function take_harga() {
          ...
          // var nilai_voucher2 = $("#nilai_voucher2")val();
          getAksesoris();
          if (mode_edit != 'false') {
            $.ajax({
