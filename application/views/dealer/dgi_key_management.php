    ...
    ?>
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">
            <a href="dealer/dgi_key_management">
      ...
      <script>
        ...
        function generateKey() {
          ...
          $.ajax({
            ...
            url: '<?= base_url('dealer/dgi_key_management/generateKey') ?>',
            type: "POST",
            data: values,
            cache: false,
            dataType: 'JSON',
          ...
          if ($('#form_').valid()) // check if form is valid
          {
            ...
            if (confirm("Apakah anda yakin ?") == true) {
              $.ajax({
                ...
                url: '<?= base_url('dealer/dgi_key_management/' . $form) ?>',
                type: "POST",
                data: values,
                cache: false,
                dataType: 'JSON',
          ...
          <script>
            $(document).ready(function() {
              var dataTable = $('#datatable_server').DataTable({
                ...
                "ajax": {
                  url: "<?php echo site_url('dealer/dgi_key_management/fetch'); ?>",
                  type: "POST",
                  dataSrc: "data",
                  data: function(d) {
                    return d;
