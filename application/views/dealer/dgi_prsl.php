...
?>
              ...
              <form class="form" id="frm" method="GET">
                ...
                <div class="box-body">
                  <div class="row">
                    ...
                    <!-- <div class="col-sm-4">
                      <label>PO ID</label>
                      <input type="text" class="form-control" id="po_id" name="po_id" readonly placeholder='Klik Untuk Memilih' onclick="showModalWOProses()">
                    </div> -->
                    <div class="col-sm-4">
                      <label>PO ID</label>
                      <input type="text" class="form-control" id="po_id" name="po_id" readonly placeholder='Klik Untuk Memilih' onclick="showModalPODealerPart()">
                    </div>
                  </div>
                </div>
  ...
  <?php
  $data['data'] = ['modalPODealerPart', 'po_type_hlo'];
