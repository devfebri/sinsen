  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">
            <a href="dealer/create_indent/download_history" target="_blank" class="btn btn-flat btn-info"><i class="fa fa-export"></i> History Indent</a>
          </h3>
          <h3 class="box-title">
            <a href="dealer/create_indent/download_excel_laporan" target="_blank" class="btn btn-flat btn-success"><i class="fa fa-export"></i> Download Excel</a>
          </h3>
          <div class="box-tools pull-right">
            <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
            <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
          ...
          <script type="text/javascript">
            $(document).ready(function(e){
              ...
              $('#datatable').DataTable({
                 ...
                 "ajax":{
                          url :  base_url+'dealer/create_indent/get_data',
                          type : 'POST'
                        },
              }); // End of DataTable
