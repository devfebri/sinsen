                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div v-if='preview' class="col-sm-2">
                                        <a :href="'dealer/h3_dealer_laporan_pendapatan_ahass/generate?start_date=' + start_date + '&end_date=' + end_date + '&type=Excel'" class="btn btn-flat btn-primary">Download excel</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                        <div v-if='preview' class="row">
                            <div class="col-md-12">
                                <iframe :src="'dealer/h3_dealer_laporan_pendapatan_ahass/generate?start_date=' + start_date + '&end_date=' + end_date + '&type=Pdf'" frameborder="0" width='100%' height='1200px'></iframe>
                            </div>
                        </div>
                    </div>
                </div>
