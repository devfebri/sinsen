  ...
  <section class="content">
    ...
    ?>
      ...
      <div class="box box-default">
                    ...
                    <tfoot>
                      <tr v-if="mode=='insert' || mode=='edit'">
                        ...
                        <td colspan=2>
                          ...
                          <button style="text-align:right;width:15%" type="button" class="btn btn-primary btn-sm btn-flat" onclick="showModalRefPenerimaanBank('Transfer')"><i class="fa fa-search"></i></button>
                        </td>
                        <td>
                          <input class="form-control input-inline" v-model="dtl.dibayar" readonly />
                        </td>
                        <td>
        ...
        <?php
        $data['data'] = ['modalCOADealer', 'modalRefPenerimaanBank', 'not_exist_penerimaan'];
        ...
        <script>
          ...
          function pilihRef(ref) {
            ...
            form_.dtl.dibayar = ref.saldo;
            form_.dtl.referensi = ref.referensi;
          }
        </script>
      <?php } ?>
  </section>
