...
*/ ?>
      ...
      <script type="text/javascript">
        ...
        function take_harga(nilai_voucher=0) {
          ...
          if (mode_edit != 'false') {
            $.ajax({
              ...
              type: "POST",
              data: "id_warna=" + id_warna + "&id_tipe_kendaraan=" + id_tipe_kendaraan + "&tipe_customer=" + tipe_customer + "&nilai_voucher=" + nilai_voucher,
              cache: false,
              success: function(msg) {
                data = msg.split("|");
                var bbn = data[0];
