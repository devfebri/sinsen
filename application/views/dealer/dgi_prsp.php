...
?>
                ...
                <div class="box-body">
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      ...
                      <input type="text" class="form-control" id="salesman" name="salesman" readonly placeholder='Klik Untuk Memilih' onclick="showModalKaryawanDealer()">
                      <input type="hidden" class="form-control" id="id_karyawan_dealer" name="id_karyawan_dealer">
                    </div>
                    <div class="col-sm-3">
                      <label>Nama Lengkap Prospect</label>
                      <input type="text" class="form-control" id="prospek" name="prospek" readonly placeholder='Klik Untuk Memilih' onclick="showModalProspek()">
                      <input type="hidden" class="form-control" id="id_prospek" name="id_prospek">
                    </div>
                  </div>
                </div>
  ...
  <?php
  $data['data'] = ['modalProspek', 'modalKaryawanDealer', 'jabatan_kry' => ['JBT-071', 'JBT-072', 'JBT-073', 'JBT-074']];
  ...
  <script>
    ...
    function pilihProspek(params) {
      console.log(params)
      $('#id_prospek').val(params.id_prospek);
      $('#prospek').val(params.nama_konsumen);
    }
