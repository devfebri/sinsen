...
<section class="content-header">
  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <div class="form-group">
        <?php $id_dealer = $this->m_admin->cari_dealer();$dl =$this->db->get_where('ms_dealer',['id_dealer'=>$id_dealer])->row() ?>
...
<!-- 
 ...
 -->
                   ...
                   <div class="col-sm-10" style="padding-left: 7%">
                      ...
                      <tr>
                       ...
                       <tr>
                        ...
                        <td>Tanggal Pengiriman Unit</td><td>:</td><td><?php echo date('Y-m-d') ?></td>
            ...
            if($row->status_close != 'closed'){
              if ($no_faktur->num_rows() >0) {
               ...
               $tombol = "";
                if ($row->status_cetak =='') {
                  // $tombol="
                  // <a $approval href='dealer/sales_order/approve?id=$row->id_sales_order' onclick=\"return confirm('Are you sure to Approve this data ?')\" class='btn btn-flat btn-xs bg-green'>Approve</a>
                  // <a $approval href='dealer/sales_order/reject?id=$row->id_sales_order' onclick=\"return confirm('Are you sure to reject this data ?')\" class='btn btn-flat btn-xs bg-red'>Reject</a>
                  // ";
                  // $tombol="
                  // <a $approval href='dealer/sales_order/approve?id=$row->id_sales_order' onclick=\"return confirm('Are you sure to Approve this data ?')\" class='btn btn-flat btn-xs bg-green'>Approve</a>
                  // ";
                  ...
                  $tombol1 = "<a href='dealer/sales_order/cetak_so?id=$row->id_sales_order' target='_blank' >
                            ...
                            <button $print type=\"button\" class=\"btn btn-success btn-flat btn-xs\"  id_sales_order=\"$row->id_sales_order\" onclick=\"choosedriver('$row->id_sales_order')\">BASTK</button>
                            <a href='dealer/sales_order/cetak_kwitansi?id=$row->id_sales_order' target='_blank' >
                              <button $print class='btn btn-flat btn-xs bg-maroon'><i class='fa fa-print'></i> Cetak Kwitansi</button>
                            </a>
                            <a href='dealer/sales_order/close?id=$row->id_sales_order'>
    ...
    <script type="text/javascript">
      $('#submitBtnBASTK').click(function(){
         $('#form_').validate({
          ...
          {
            values = {tgl_pengiriman:$('#tgl_pengiriman').val(),
             ...
             $tombol = "";
              if ($row->status_cetak =='') {
                ...
                $tombol1 = "<a href='dealer/sales_order/cetak_so_gc?id=$row->id_sales_order_gc' target='_blank' >
                          ...
                          <a href='dealer/sales_order/syarat_bbn?id_c=$row->id_sales_order_gc'>
                            <button class='btn btn-flat btn-xs btn-warning'><i class='fa fa-list'></i> Syarat BBN</button> 
                          </a>";                
              }elseif($row->status_cetak=='cetak_so' AND $row->tgl_cetak_so != null){
                $tombol1 = "<a href='dealer/sales_order/cetak_so_gc?id=$row->id_sales_order_gc' target='_blank' >
                            <button $print class='btn btn-flat btn-xs bg-blue' ><i class='fa fa-print'></i> Cetak SO</button>
                ...
                $tombol1 = "<a href='dealer/sales_order/cetak_so_gc?id=$row->id_sales_order_gc' target='_blank' >
                          ...
                          <button $print type=\"button\" class=\"btn btn-success btn-flat btn-xs\" data-toggle=\"modal\" data-target=\".modal_bastk_gc\" id_sales_order_gc=\"$row->id_sales_order_gc\" onclick=\"choosedriver_gc('$row->id_sales_order_gc')\">BASTK</button>";                
              }elseif(($row->status_cetak =='cetak_bastk' OR $row->status_cetak=='cetak_invoice' OR $row->status_cetak=='cetak_barcode'  OR $row->status_cetak=='cetak_kwitansi' ) AND $row->status_so=='so_invoice'){
                $tombol1 = "<a href='dealer/sales_order/cetak_so_gc?id=$row->id_sales_order_gc' target='_blank' >
                            <button $print class='btn btn-flat btn-xs bg-blue' ><i class='fa fa-print'></i> Cetak SO</button>
                          </a>
                          ...
                          <button $print type=\"button\" class=\"btn btn-success btn-flat btn-xs\" data-toggle=\"modal\" data-target=\".modal_bastk_gc\" id_sales_order_gc=\"$row->id_sales_order_gc\" onclick=\"choosedriver_gc('$row->id_sales_order_gc')\">BASTK</button>
                          <a href='dealer/sales_order/cetak_kwitansi_gc?id=$row->id_sales_order_gc' target='_blank' >
                            <button $print class='btn btn-flat btn-xs bg-maroon'><i class='fa fa-print'></i> Cetak Kwitansi</button>
                          </a>
    ...
    <div class="modal fade modal_bastk_gc">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-body" id="show_detail">
            <form class="form-horizontal" method="GET" action="dealer/sales_order/bastk_gc">
              <div class="form-group">
                <div class="col-sm-12">
                  <label>ID Sales Order</label>
                  <input type="text" name="id_sales_order_gc" class="form-control" id="id_sales_order_gc" readonly>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-12">
    ...
    <script type="text/javascript">
      function choosedriver_gc(id_sales_order_gc)
      {
        $('.modal_bastk_gc #id_sales_order_gc').val(id_sales_order_gc);        
      }
    </script>
    <?php
    }elseif($set=="history"){
          ...
          foreach($dt_sales_order->result() as $row) {    
              ...
              if ($no_faktur->num_rows() >0) {
               ...
               $tombol = "";
                // if ($row->status_cetak =='') {
                //   $tombol="
                //   <a href='dealer/sales_order/approve?id=$row->id_sales_order' onclick=\"return confirm('Are you sure to Approve this data ?')\" class='btn btn-flat btn-xs bg-green'>Approve</a>
                ...
                //               <button class='btn btn-flat btn-xs btn-danger'><i class='fa fa-print'></i> Cetak Barcode AHASS</button>
                //             </a>
                //             <button type=\"button\" class=\"btn btn-success btn-flat btn-xs\"  id_sales_order=\"$row->id_sales_order\" onclick=\"choosedriver('$row->id_sales_order')\">BASTK</button>";                
                // }elseif(($row->status_cetak =='cetak_bastk' OR $row->status_cetak=='cetak_invoice' OR $row->status_cetak=='cetak_barcode'  OR $row->status_cetak=='cetak_kwitansi' ) AND $row->status_so=='so_invoice'){
                //   $tombol1 = "<a href='dealer/sales_order/cetak_so?id=$row->id_sales_order' target='_blank' >
                //               <button class='btn btn-flat btn-xs bg-blue' ><i class='fa fa-print'></i> Cetak SO</button>
                //             </a>
            ...
            $print = $this->m_admin->set_tombol($id_menu,$group,'print');            
             ...
             $tombol = "";
              if ($row->status_cetak =='') {
                ...
                $tombol1 = "<a href='dealer/sales_order/cetak_so?id=$row->id_sales_order_gc' target='_blank' >
                            <button $print class='btn btn-flat btn-xs bg-blue' ><i class='fa fa-print'></i> Cetak SO</button>
                          </a>
                          <a href='dealer/sales_order/cetak_cover?id=$row->id_sales_order_gc' target='_blank' >
                            <button $print class='btn btn-flat btn-xs bg-green'><i class='fa fa-print'></i> Cetak Cover</button> 
                          </a>";                
              }elseif($row->status_cetak=='cetak_so' AND $row->tgl_cetak_so != null){
                $tombol1 = "<a href='dealer/sales_order/cetak_so?id=$row->id_sales_order_gc' target='_blank' >
                          ...
                          <a href='dealer/sales_order/cetak_invoice?id=$row->id_sales_order_gc' target='_blank' >
                            <button $print class='btn btn-flat btn-xs bg-blue'><i class='fa fa-print'></i> Cetak Invoice</button>
                          </a>";              
              }elseif(($row->status_cetak=='cetak_invoice' OR $row->status_cetak=='cetak_so') AND $row->status_cetak != 'cetak_bastk' AND $row->status_so =='so_invoice'){
                $tombol1 = "<a href='dealer/sales_order/cetak_so?id=$row->id_sales_order_gc' target='_blank' >
                          ...
                          <a href='dealer/sales_order/cetak_barcode?id=$row->id_sales_order_gc' target='_blank' >
                            <button $print class='btn btn-flat btn-xs btn-danger'><i class='fa fa-print'></i> Cetak Barcode AHASS</button>
                          </a>";     
              }elseif(($row->status_cetak=='cetak_invoice' OR $row->status_cetak=='cetak_barcode') AND $row->tgl_bastk != null AND $row->status_cetak != 'cetak_bastk' AND $row->status_so =='so_invoice' ){
                $tombol1 = "<a href='dealer/sales_order/cetak_so?id=$row->id_sales_order_gc' target='_blank' >
                          ...
                          <button $print type=\"button\" class=\"btn btn-success btn-flat btn-xs\"  id_sales_order_gc=\"$row->id_sales_order_gc\" onclick=\"choosedriver('$row->id_sales_order_gc')\">BASTK</button>";                
              }elseif(($row->status_cetak =='cetak_bastk' OR $row->status_cetak=='cetak_invoice' OR $row->status_cetak=='cetak_barcode'  OR $row->status_cetak=='cetak_kwitansi' ) AND $row->status_so=='so_invoice'){
                $tombol1 = "<a href='dealer/sales_order/cetak_so?id=$row->id_sales_order_gc' target='_blank' >
                            <button $print class='btn btn-flat btn-xs bg-blue' ><i class='fa fa-print'></i> Cetak SO</button>
                          </a>
                          ...
                          <button $print type=\"button\" class=\"btn btn-success btn-flat btn-xs\"  id_sales_order_gc=\"$row->id_sales_order_gc\" onclick=\"choosedriver('$row->id_sales_order_gc')\">BASTK</button>
                          <a href='dealer/sales_order/cetak_kwitansi?id=$row->id_sales_order_gc' target='_blank' >
                            <button $print class='btn btn-flat btn-xs bg-maroon'><i class='fa fa-print'></i> Cetak Kwitansi</button>
                          </a>
                          <a href='dealer/sales_order/close?id=$row->id_sales_order_gc'>
                            <button class='btn btn-flat btn-xs btn-warning'><i class='fa fa-close'></i> Close</button>
                          </a>";                              
              }elseif($row->status_cetak=='reject'){
                $tombol ="<a href='dealer/sales_order/edit_gc?id=$row->id_sales_order_gc' target='_blank' >
            ...
            <form class="form-horizontal" action="dealer/sales_order/save" method="post" enctype="multipart/form-data">
              ...
              <input type="hidden" name="mode" id="mode" value="<?= $mode ?>">         
                ...
                <div class="form-group">                  
                  <label for="inputEmail3" class="col-sm-2 control-label">No Mesin</label>
                  <div class="col-sm-4">
                    <input value="<?php echo $row->no_mesin ?>" type="text" class="form-control" id="no_mesin" readonly required placeholder="No Mesin" name="no_mesin">                                        
                  </div>                  
              ...
              <div class="box-footer">
                ...
                <div class="col-sm-10">                  
                 <?php if ($cek_tot==0){ ?>
                  ...
                  <button type="reset" class="btn btn-default btn-flat"><i class="fa fa-refresh"></i> Cancel</button>                   
                  <?php }else{ ?>    
                       <a href="dealer/sales_order/cetak_kwitansi_act_gc?id=<?=$cek->id_sales_order?>" class="btn btn-primary btn-flat" target="_blank" >Cetak</a>    
                  <?php } ?>
                </div>
              </div><!-- /.box-footer -->
            </form>
              ...
              <div class="box-body">       
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <?php $finco = $this->db->get_where('ms_finance_company',['id_finance_company'=>$row->id_finance_company]); $finco = $finco->num_rows()>0?$finco->row()->finance_company:''; ?>
                   <label for="inputEmail3" class="col-sm-2 control-label">Finance Company</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Diskon</label>
                    <div class="col-sm-4">
                    <input type="text" readonly class="form-control" autocomplete="off" value="<?=mata_uang_rp($row->diskon)?>" >
                  </div>
                </div>
                 <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Harga Jual</label>
                    <div class="col-sm-4">
                    <input type="text" readonly class="form-control" autocomplete="off" value="<?=mata_uang_rp($row->harga_on_road)?>" >
                  </div>
                </div>
                 <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Total Harga</label>
                    <div class="col-sm-4">
                    <input type="text" readonly class="form-control" autocomplete="off" value="<?=mata_uang_rp($row->harga_on_road - $row->diskon - $voucher)?>" >
                  </div>
                </div>
              </div>
              <div class="box-footer">
 ...
 function  datatables()
  ...
  function getJenisBayar(){
      ...
      $.ajax({
          ...
          type:"POST",
          data:"jenis_bayar="+jenis_bayar+"&id_sales_order="+id_sales_order+"&isi_jenis="+isi_jenis,            
          cache:false,
          success:function(html){  
            if(isi_jenis > 0){
              getDatePicker();              
