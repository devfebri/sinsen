  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="dealer/guest_book/save" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">               
                  ...
                  <div class="col-sm-4">
                    <select class="form-control select2" required name="sales" id="id_sales" onchange="take_appointment()">
                      <option value="">- choose -</option>
                       <?php 
                      $id_dealer = $this->m_admin->cari_dealer();
                      $sales = $this->db->query("SELECT * FROM ms_karyawan_dealer WHERE id_dealer = '$id_dealer' AND id_flp_md <> '' ORDER BY nama_lengkap ASC"); 
                ...
                <div class="form-group">               
                  ...
                  <div class="col-sm-4">
                    <select class="form-control select2" name="id_list_appointment" id="id_list_appointment" onchange="take_idlist()" required>
                      <option value="">- choose -</option>
                    </select>
                  </div>                  
                  <label for="inputEmail3" class="col-sm-2 control-label">No HP</label>
                  <div class="col-sm-4">                    
                    <input type="text" class="form-control" readonly required placeholder="No HP" id="no_hp" name="no_hp">                                                                           
                  </div>
                </div>                
                <div class="form-group">                
                  <label for="inputEmail3" class="col-sm-2 control-label">Nama Konsumen</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" readonly required placeholder="Nama Konsumen" id="nama_konsumen" name="nama_konsumen">                    
                  </div>                  
                </div>
                <div class="form-group">                
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select class="form-control" name="id_jenis_customer" required>
                      <option value="">- choose -</option>
                      <?php 
                  ...
                  <div class="col-sm-4">
                    <select class="form-control" name="rencana_bayar" required>
                      <option value="">- choose -</option>
                      <option>Cash</option>
                ...
                <div class="form-group">                  
                  ...
                  <div class="col-sm-4">                    
                    <select class="form-control select2" name="id_tipe_kendaraan" id="id_tipe_kendaraan" required onchange="getWarna()">
                      <option value="">- choose -</option>
                      <?php 
                ...
                <!-- <div class="form-group">                
                  <label for="inputEmail3" class="col-sm-2 control-label">Alamat</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Alamat" name="alamat2">                    
                  </div>                  
                </div> -->
                <div class="form-group">                
                ...
                <button class="btn btn-block btn-success btn-flat" disabled> FOLLOW UP </button> <br>
                <table id="myTable1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <input type="text" autocomplete="off" id="tanggal4" class="form-control" placeholder="Tgl Follow Up" name="tgl_fu">                                        
                      </td>
                      <td>
                        <input type="text" autocomplete="off" class="form-control" placeholder="Hasil Follow Up" name="hasil_fu">                      
                      </td>
                      <td>
                        <select class="form-control" name="status_fu">
                          <option value="">- choose -</option>
                      ...
                      <td>
                        <input type="text" id="tanggal5" autocomplete="off" class="form-control" placeholder="Next Follow Up" name="next_fu">                                        
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div class="box-body">              
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    <select class="form-control select2" required name="id_list_appointment" id="id_list_appointment" onchange="take_idlist()">
                      <option value="<?php echo $row->id_list_appointment ?>">
                        <?php 
                        $dt_cust    = $this->m_admin->getByID("tr_prospek","id_list_appointment",$row->id_list_appointment)->row();                                 
                        if(isset($dt_cust)){
                          echo $dt_cust->id_list_appointment;
                        }else{
                          echo "- choose -";
                        }
                        ?>
                      ...
                      <?php 
                      $list = $this->m_admin->kondisiCond("tr_prospek","id_list_appointment != '$row->id_list_appointment'");                                                
                      foreach ($list->result() as $isi) {
                        echo "<option value='$isi->id_list_appointment'>$isi->id_list_appointment</option>";
                      }
                      ?>  
                    </select>
                  </div>                  
                ...
                <div class="form-group">                
                  <label for="inputEmail3" class="col-sm-2 control-label">Alamat</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Alamat" value="<?php echo $row->alamat2 ?>" name="alamat" id="alamat">                    
                  </div>                  
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Jenis Customer</label>
                ...
                <div class="form-group">                  
                  <label for="inputEmail3" class="col-sm-2 control-label">Type Motor</label>
                  <div class="col-sm-4">                    
                    <select class="form-control select2" name="id_tipe_kendaraan" required onchange="getWarna()" id="id_tipe_kendaraan">
                ...
                <!-- <div class="form-group">                
                  <label for="inputEmail3" class="col-sm-2 control-label">Alamat</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Alamat" value="<?php echo $row->alamat2 ?>" name="alamat2">                    
                  </div>                  
                </div> -->
                <div class="form-group">                
                  <label for="inputEmail3" class="col-sm-2 control-label">Deskripsi Warna Motor</label>
            ...
            <form class="form-horizontal" action="dealer/guest_book/update" method="post" enctype="multipart/form-data">
              <div class="box-body">              
                ...
                <div class="form-group">
                  ...
                  <?php $folup =$this->db->query("SELECT * FROM tr_guest_book_detail WHERE id_guest_book='$row->id_guest_book'") ?>
                  <?php if ($folup->num_rows()>0): ?>
                      <tbody>
                        <?php $no=1;foreach ($folup->result() as $rss): ?>
                          <tr>
                            <td><?=$no?></td>
                            <td><?=$rss->tgl_fu?></td>
                            <td><?=$rss->hasil_fu?></td>
        ...
        <table id="example3" class="table table-bordered table-hover">
          ...
          $no=1; 
               foreach($dt_guest_book->result() as $row) {
                $cek = $this->db->query("SELECT * FROM tr_guest_book_detail WHERE id_guest_book = '$row->id_guest_book' ORDER BY id_guest_book_detail DESC LIMIT 0,1");
                if($cek->num_rows() > 0){
                  $t = $cek->row();
                  $tgl_fu = $t->tgl_fu;
                }else{
                ...
                $dt_p = $this->db->query("SELECT * FROM tr_prospek WHERE id_list_appointment='$row->id_list_appointment' AND id_dealer = '$row->id_dealer'");
                if($dt_p->num_rows() > 0){
                  $t = $dt_p->row();
                ...
                <tr>
                  <td>$no</td>  
                  <td>$row->id_guest_book</td>

                  <td>
                    <a href='dealer/guest_book/detail?id=$row->id_guest_book'>
                      $nama_konsumen
                    </a>
                  </td>
                  <td>$no_hp</td>
