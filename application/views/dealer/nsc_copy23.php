          ...
          <div class="row">
            <div class="col-sm-12">
              <form class="form-horizontal" id="form_">
                ...
                <div class="form-group" v-if="data.no_inv_uang_jaminan!=undefined">
                  <label class="col-sm-2 control-label" >Invoice Uang Jaminan</label>
                  <div class="col-sm-4">
                ...
                <div v-if="data!=''">
                  ...
                  <div class="row" v-if="mode!='detail_nsc'">
                    <div class="col-sm-12">
                    <div class="callout callout-danger">
                      <h4>Penting !</h4>
                      <p style='font-size:11pt !important'>Mohon pastikan kelengkapan part dan uang jaminan sebelum menyimpan Nota Suku Cadang(NSC).</p>
                    </div>
                    </div>
                  </div>
                  <div class="col-sm-12" align="center" v-if="mode=='create_nsc'">
                    <button type="button" id="submitButton" @click.prevent="saveNSC(this)" class="btn btn-info btn-flat">Create NSC</button>
                  </div>
                </div> <!-- END IF -->
              </form>
            </div>
          ...
          var form_ = new Vue({
            ...
            methods: {
              set_harga: function(prt) {
                ...
                if (this.pkp === 1 && this.tampil_ppn) {
                  harga = parseInt(prt.harga_beli) / <?php echo getPPN(1.1,false) ?>;
                  // console.log(harga);
                }
                return harga
              },
              ...
              subTotPart: function(part) {
                ...
                if (this.pkp == 1 && this.tampil_ppn === 1) {
                  harga_real = harga_real / <?php echo getPPN(1.1,false) ?>;
                }
                return (qty * harga_real) - (qty*potongan_harga);
              }
            },
            ...
            computed: {
              totParts: function() {
                ...
                if (this.pkp === 1 && this.tampil_ppn === 1) {
                  tot.ppn = Math.round( <?php echo getPPN(0.1, false) ?> * tot.total_no_ppn);
                }
