              ...
              <form class="form-horizontal" enctype="multipart/form-data">
                <div class="box-body">
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Kode MD</label>
                    <div class="col-sm-4">
                        <input value="E20" type="text" class="form-control" :disabled="mode=='detail'" disabled>
                    </div>
                    <label for="inputEmail3" class="col-sm-2 control-label">ID Customer</label>
                    <div class="col-sm-4">
                      <input v-if='purchase.customer == null' value="-" type="text" class="form-control" disabled>
                      <div class="input-group" v-if='purchase.customer != null'>
                          <input readonly type="text" class="form-control" v-model='purchase.customer'>
                          <div class="input-group-btn">
                            <button v-show='mode == "detail"|| mode == "revisi_po"' class="btn btn-flat btn-primary" type='button' data-toggle="modal" data-target="#modalCustomer"><i class="fa fa-eye"></i></button>
                          </div>
                        </div>
                    </div>
                  </div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h3 class="modal-title" id="exampleModalLabel">Data Customer</h3>
                        </div>
                        <div class="modal-body">
                          <table>
                            <tr>
                              ...
                              <td>:</td>
                              <td>{{purchase.id_tipe_kendaraan}}</td>
                            </tr>
                            <tr>
                              <td>Nama Customer</td>
                              <td>:</td>
                              <td>{{purchase.nama_customer}}</td>
                              <td>Kode Warna</td>
                              <td>:</td>
                              <td>{{purchase.id_warna}}</td>
                            </tr>
                            <tr>
                              <td>No.Hp</td>
                              <td>:</td>
                              <td>{{purchase.no_hp}}</td>
                              <td>Tahun Produksi</td>
                              <td>:</td>
                              <td>{{purchase.tahun_produksi}}</td>
                            </tr>
                            <tr>
                              <td>Alamat</td>
                              <td>:</td>
                              ...
                              <td>No Mesin</td>
                              <td>:</td>
                              <td>{{purchase.no_mesin}}</td>
                            </tr>
                            <tr>
                              <td>Kota</td>
                              <td>:</td>
                              <td>{{purchase.kabupaten}}</td>
                              <td>No Rangka</td>
                              <td>:</td>
                              <td>{{purchase.no_rangka}}</td>
                            </tr>
                          </table>
                        </div>
                  ...
                  <div class="form-group">
                    ...
                    <div v-bind:class="{ 'has-error': errors.po_type != null }" class="col-sm-4">
                      <select required class="form-control" :disabled="is_nmd || mode=='detail' || mode=='edit' || mode=='revisi_po'" v-model="purchase.po_type">
                    ...
                    <!-- <div v-if="is_other && mode=='insert'">
                      <label for="inputEmail3" class="col-sm-2 control-label" v-model="purchase.po_nmd">Main Dealer</label>
                      <div class="col-sm-4">
                        <div class="form-check form-check-inline">
                          <input class="form-check-input"  type="radio" name="nmd" v-model="purchase.po_nmd" id="md" value="0">
                          <label class="form-check-label" for="md" >MD</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" v-model="purchase.po_nmd" name="nmd" id="nmd" value="1">
                          <label class="form-check-label" for="nmd" >Non-MD</label>
                        </div>
                      </div>
                    </div> -->
                  </div>
                  <div class="form-group">
                    ...
                    <div v-if="mode!='insert' && is_other">
                      <label for="inputEmail3" class="col-sm-2 control-label" v-model="purchase.po_nmd">Main Dealer</label>
                      <div class="col-sm-4">
                        <div class="form-check form-check-inline">
                          <input class="form-check-input"  type="radio" name="nmd" v-model="purchase.po_nmd" id="md" value="0" :disabled='mode == "detail" || mode=="edit" || mode == "revisi_po"'>
                          <label class="form-check-label" for="md" >MD Sinsen</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" v-model="purchase.po_nmd" name="nmd" id="nmd" value="1" :disabled='mode == "detail" || mode=="edit" || mode == "revisi_po"'>
                          <label class="form-check-label" for="nmd" >Non-MD Sinsen</label>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div v-if="is_other && is_nmd" class="col-sm-4">
                  ...
                  <div class="form-group">
                    <div v-if='is_hlo || (is_other && is_md)'>
                  ...
                  <div v-show='is_hlo' class="form-group">
                    ...
                    <div v-bind:class="{ 'has-error': error_exist('id_booking') }" class="col-sm-4">
                      <div class="input-group">
                          ...
                          <div class="input-group-btn">
                            <button :disabled='mode == "edit"' v-show='request_document_empty || mode == "detail" || mode == "edit"' :disabled='mode == "detail" || mode=="revisi_po"' class="btn btn-flat btn-primary" type='button' data-toggle="modal" data-target="#modal-booking-ref"><i class="fa fa-search"></i></button>
                            <button v-show='!request_document_empty && mode != "detail" && mode != "edit"' :disabled='generateByBooking == 1 || mode=="revisi_po"' class="btn btn-flat btn-danger" @click.prevent='hapus_request_document'><i class="fa fa-trash-o"></i></button>
                          </div>
                        </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-12 col-sm-offset-2" v-if="mode=='revisi_po'">
                      <button @click.prevent='<?= $form ?>'  type="button" class="btn btn-sm btn-success btn-flat"><i class="fa fa-save"></i> Save Revisi PO</button>
                    </div>
                  </div>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      <tr>
                        ...
                        <td v-if='is_hlo'>Import/Lokal</td>
                        <td v-if='is_hlo'>Current/Non-Current</td>
                        <td v-if='is_hlo'>Kuantitas Max Order</td>
                        ...
                        <td width='10%' v-if="mode=='detail' && is_hlo" class="text-right">ETA Tercepat</td>
                        <td width='10%' v-if="mode=='detail' && is_hlo" class="text-right">ETA Terlama</td>
                        <td width='10%' v-if="mode=='detail' && is_hlo" class="text-right">ETA Revisi</td>
                        <td width='10%' v-if="purchase.po_revisi='1' && mode!='insert'" class="text-left">Part PO Sebelumnya</td>
                        <td width='10%' v-if="purchase.po_revisi='1' && mode!='insert'" class="text-left">Alasan Revisi Part</td>
                      ...
                      <tr v-if="filtered_parts.length > 0" v-for="(part, index) of filtered_parts" v-bind:class="{ 'text-red': melewati_maks_stok(part) }">
                        ...
                        <td v-if='is_hlo' class="align-middle">
                        ...
                        <td v-if="(is_other && is_nmd && mode=='insert') || (mode=='edit'&&is_other && is_nmd) " class="align-middle text-right">
                          <vue-numeric  class="input-compact" thousand-separator="." v-model="part.harga_saat_dibeli" :empty-value="0"  v-on:keyup.native="" />
                        </td>
                        ...
                        <td v-if="is_other && is_nmd" class="align-middle text-right">
                        ...
                        <td v-if="mode=='detail' && is_hlo && part.eta_tercepat == null" class="align-middle text-right"> -</td>
                        <td v-if="mode=='detail' && is_hlo && part.eta_tercepat != null" class="align-middle text-right">{{ moment(part.eta_tercepat).format('D-MM-Y') }}</td>
                        <td v-if="mode=='detail' && is_hlo && part.eta_terlama == null" class="align-middle text-right">-</td>
                        <td v-if="mode=='detail' && is_hlo && part.eta_terlama != null" class="align-middle text-right">{{ moment(part.eta_terlama).format('D-MM-Y')}}</td>
                        <td v-if="mode=='detail' && is_hlo && part.eta_revisi == null" class="align-middle text-right"> -</td>
                        <td v-if="mode=='detail' && is_hlo && part.eta_revisi == '0000-00-00'" class="align-middle text-right"> -</td>
                        <td v-if="mode=='detail' && is_hlo && part.eta_revisi != null && part.eta_revisi != '0000-00-00'" class="align-middle text-right">{{ moment(part.eta_revisi).format('D-MM-Y') }}</td>
                        <td v-if="purchase.po_revisi='1' && mode!='insert' && is_hlo" class="align-middle text-center">
                          <input disabled v-model='part.part_revisi_dari_md' type="checkbox" true-value='1' false-value='0'>
                        </td> 
                        <td v-if="purchase.po_revisi=1 && mode!='insert' && is_hlo " class="align-middle text-center">
                          <span>{{ part.alasan_part_revisi_md }}</span>
                        </td>
                      ...
                      <tr v-if="parts.length > 0 && (!is_other || is_md)">
                  ...
                  <div class="box-footer">
                    ...
                    <?php if ($mode == 'detail') : ?>
                      ...
                      <div class="col-sm-6 no-padding text-right">
                          ...
                          <button v-if='allowed_submit_revisi_po && purchase.status == "Revisi Dealer"' class="btn btn-flat btn-sm btn-info" @click.prevent='update_status("Submit & Approve Revisi")'>Submit Revisi</button>
                          ...
                          <a v-if='mode == "detail" && purchase.status == "Reject & Revisi by MD" && auth.can_update' :href="'dealer/h3_dealer_purchase_order/revisi_po?id=' + purchase.po_id" class="btn btn-sm btn-warning btn-flat">Revisi</a>
        ...
        form_ = new Vue({
          ...
          methods: {
            <?= $form ?>: function(){
              ...
              post = {};
              if(this.mode == 'edit' ||this.mode == 'revisi_po'){
          ...
          computed: {
            ...
            allowed_submit_revisi_po: function(){
              if(this.is_hlo && this.purchase.no_inv_uang_jaminan == null){
                return false;
              }

              return this.mode == "detail" && this.purchase.status == "Revisi Dealer" && this.auth.can_submit;
            },
            is_urg: function(){
        ...
        <div class="box-body">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <!-- <div class="col-sm-2">
                <div class="form-group">
                  <input type="text" class="form-control" name="filter_search_nama_cust" id="filter_search_nama_cust" placeholder="Cari Nama Customer">
                </div>
              </div>  -->
              <div class="col-sm-2">
                <div class="form-group">
                  <input type="text" class="form-control" name="filter_no_booking" id="filter_no_booking" placeholder="Cari No Booking">
                </div>
              </div> 
              <div class="col-sm-2">
                <div class="form-group">
            ...
            $(document).ready(function() {
                      ...
                      ajax: {
                          ...
                          data: function(data) {
                              ...
                              data.filter_no_booking=$('#filter_no_booking').val();
