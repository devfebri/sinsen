    ...
    <!-- <div class="col-sm-12"> -->
      <div class="box-header with-border">
        <div class="box box-warning">
          ...
          <form class="form-horizontal" action="dealer/h2_dealer_overview_customer/index" method="get">
            <div class="box-body">       
              <!-- <div class="form-group"> -->
                ...
                <table>
                  <tr>
                    <td ><label for="inputEmail3" >M/C Type (Opsional)</label></td>
                    ...
                    <td><label for="inputEmail3" >Pekerjaan (Opsional)</label></td>
                    <td style="width: 400px;"><select class="form-control select2"  aria-label="Default select example" name="profesi" id="profesi">
...
<script>
  $('#reset').click(function () {
    window.location = "<?php echo base_url('dealer/h2_dealer_overview_customer/')?>"; 
  });
  $(function () {
    $("#tanggal1").datepicker({
      autoclose: true,
