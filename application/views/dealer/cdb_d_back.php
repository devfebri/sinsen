          ...
          <div class="col-md-12">
            <form id="form_" class="form-horizontal" action="dealer/cdb_d/save" method="post" enctype="multipart/form-data">
              <div class="box-body">                              
                ...
                <span id="tampil_alamat">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" readonly class="form-control" maxlength="100" placeholder="Alamat Sesuai KTP"  name="alamat2">                                        
                    </div>
                  </div>
                </span>
                <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="Nama Instansi / Usaha" id="nama_instansi" name="nama_instansi">
                  </div>                 
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Alamat Instansi / Usaha</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Alamat Instansi / Usaha" id="alamat_instansi" name="alamat_instansi">
                  </div>                 
                </div>
                <div class="form-group">
                ...
                <div class="form-group">                  
                  ...
                  <div class="col-sm-4">
                    <input type="email" class="form-control" maxlength="100" readonly placeholder="Email" id="email" name="email" required="required">                                        
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">                  
                  ...
                  <div class="col-sm-4">                    
                    <select class="form-control" name="aktivitas_penjualan" id="aktivitas_penjualan" required>
                      <option value="">- choose -</option>
                      <option value="Gathering">Gathering</option>
                      <option value="Canvassing">Canvassing</option>
                      <option value="Pameran">Pameran</option>
                      <option value="Walk In">Walk In</option>
                      <option value="Ruang Tunggu AHASS">Ruang Tunggu AHASS</option>
              ...
              <div class="form-group">
                <div class="col-md-3">
                  NIK
                  <input type="text" class="form-control" v-model="kk.nik">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                  Tanggal Lahir
                  <input type="text" class="form-control datepicker" v-model="kk.tgl_lahir" onchange="setTglLahirKK(this)">
                </div>
                <div class="col-md-3">
                  Agama
                ...
                <div class="col-md-3">
                  Pekerjaan
                  <select v-model="kk.id_pekerjaan" class="form-control" id="kk_pekerjaan">
                          <?php 
            ...
            <form id="form_" class="form-horizontal" action="dealer/cdb_d/update" method="post" enctype="multipart/form-data">
              <div class="box-body">                              
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nama Instansi / Usaha</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="Nama Instansi / Usaha" id="nama_instansi" name="nama_instansi" value="<?= $row->nama_instansi ?>">
                  </div>                 
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Alamat Instansi / Usaha</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Alamat Instansi / Usaha" id="alamat_instansi" name="alamat_instansi" value="<?= $row->alamat_instansi ?>">
                  </div>                 
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Kecamatan Instansi / Usaha</label>
                ...
                <div class="form-group">                  
                  ...
                  <label for="inputEmail3" class="col-sm-2 control-label">Email</label>
                  <div class="col-sm-4">
                    <input type="email" class="form-control" readonly placeholder="Email" maxlength="100" id="email" name="email" required="required">                                        
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Refferal ID</label>
...
var form_ = new Vue({
      ...
      data: {
        ...
        WHERE no_spk='$row->no_spk'")->result(); echo json_encode($cdb_kk); ?>
      },
      methods: {
        setJK:function (el) {
          var text = el.options[el.selectedIndex].text;
  ...
  $(document).ready(function(){
  $('#aktivitas_penjualan').val('<?= $row->aktivitas_penjualan ?>').trigger('change');
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          foreach($dt_cdb->result() as $row) {     
            ...
            <tr>
              ...
              <td>$row->no_ktp</td>
              <td>"; ?>
                <a data-toggle='tooltip' <?php echo $this->m_admin->set_tombol($id_menu,$group,"edit"); ?> title="Edit Data" class='btn btn-primary btn-sm btn-flat' href='dealer/cdb_d/edit?id=<?php echo $row->id_cdb ?>'><i class='fa fa-edit'></i></a>
              </td>                                                        
            </tr>
          <?php
            $no++;
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          foreach($dt_cdb->result() as $row) {     
            ...
            <tr>
              ...
              <td>$row->alamat</td>
              <td>"; ?>
                <a  data-toggle='tooltip' <?php echo $this->m_admin->set_tombol($id_menu,$group,"edit"); ?> title="Edit Data" class='btn btn-primary btn-sm btn-flat' href='dealer/cdb_d/edit_gc?id_c=<?php echo $row->id_cdb_gc ?>'><i class='fa fa-edit'></i></a>
              </td>                                                        
            </tr>
          <?php
            $no++;
      ...
      <div class="modal-body">
        <table id="example3" class="table table-bordered table-hover">        
          ...
          $dt_npwp = $this->db->query("SELECT * FROM tr_spk_gc LEFT JOIN ms_kelurahan ON tr_spk_gc.id_kelurahan=ms_kelurahan.id_kelurahan 
              ...
              ORDER BY tr_spk_gc.nama_npwp ASC");   
