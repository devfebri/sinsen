  ...
  <section class="content">
            ...
            <tr>
              ...
              <td>                                
                <a href='dealer/penyerahan_stnk/cash?id=$row->no_mesin'>
                  <button class='btn btn-flat btn-xs btn-primary'><i class='fa fa-print'></i> Cetak TTD Cash</button>
                </a>
                <a href='dealer/penyerahan_stnk/print?id=$row->no_mesin'>
                  <button class='btn btn-flat btn-xs btn-warning'><i class='fa fa-print'></i> Cetak TTD Kredit</button>
                </a>
              </td>
            </tr>
            ";
          ...
          <tbody>            
            <?php $no=1;foreach ($dt_hist->result() as $rs):
             ...
             ?>
                <tr>
                  <td><?= $no ?></td>
                  <td><?= $rs->kd_stnk_konsumen ?></td>
                  <td><?= $tgl ?></td>
                  <td><?= $rs->jml ?></td>
                  <td><?= $rs->diterima ?></td>
                  <td><?= $rs->diserahkan ?></td>
                  <td>
                    <a href="dealer/penyerahan_stnk/cetak_ulang?id=<?=$rs->kd_stnk_konsumen?>&p=<?=$rs->jenis_cetak?>" class="btn btn-success btn-flat btn-xs" target="_blank"><i class="fa fa-print"></i></a>
                  </td>
                </tr>
            <?php $no++; endforeach ?>
          </tbody>
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">
          <ul class="nav nav-pills">
            ...
            <li role="presentation" class="<?= $set1 ?>"><a href="dealer/penyerahan_stnk/print_preview?p=plat">PLAT</a></li>
            <li role="presentation" class="<?= $set2 ?>"><a href="dealer/penyerahan_stnk/print_preview?p=stnk">STNK</a></li>
            <li role="presentation" class="<?= $set3 ?>"><a href="dealer/penyerahan_stnk/print_preview?p=bpkb">BPKB</a></li>
            <li role="presentation" class="<?= $set4 ?>"><a href="dealer/penyerahan_stnk/print_preview?p=srut">SRUT</a></li>
          </ul>
          <!-- <a href="dealer/penyerahan_stnk/add">
            <button <?php echo $this->m_admin->set_tombol($id_menu,$group,"insert"); ?> class="btn bg-blue btn-flat margin"><i class="fa fa-plus"></i> Add New</button>
          </a>           -->
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="dealer/penyerahan_stnk/print_preview?p=<?= $setprint?>" method="post" enctype="multipart/form-data">
              <div class="box-body">    
                <div class="form-group">
                  <label for="" class="col-sm-1 control-label">Search</label>
                  <div class="col-sm-4">
                    <input type="hidden" name="setprint">
                    <input type="text" required class="form-control"  placeholder="Search" name="search" autocomplete="off" value="<?= $search ?>">
                  </div>
                  <div class="col-sm-1">
              ...
              <form class="form-horizontal" action="dealer/penyerahan_stnk/cetak" target="_blank" method="POST">
                <input type="hidden" name="setprint" value="<?= $setprint ?>">
                <table id="example4" class="table table-bordered table-hover">
                  <thead>
                    <th>No Mesin</th>
                    <th>No Rangka</th>
                    ...
                    <?php if ($dt_serah !=null) {
                      ...
                      foreach ($dt_serah->result() as $rs) {  ?>
                        <tr>
                          ...
                          <td><?= $rs->no_bpkb ?></td>
                          <td><?= $rs->no_bpkb ?></td>
                          <td align="center"><input type="checkbox" name="check_<?= $x ?>">
                                             <input type="hidden" name="no_mesin[]" value="<?= $rs->no_mesin ?>">
                          </td>
                        </tr>
                    <?php $x++; }
                    } ?>
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="" class="col-sm-2 control-label">No HP Penerima</label>
                    <div class="col-sm-4">
                      <input type="text" required class="form-control" name="no_hp_penerima" autocomplete="off">
                    </div>              
                  </div>
              </div>
                <div class="box-footer">
