        ...
        <div class="box">
          ...
          <div class="box-body">
            ...
            <table id="example4" class="table table-bordered table-hover">
              ...
              <tbody>
                <?php $no = 1;
                foreach ($dt_hist->result() as $rs) :
                  $tgl_exp = explode(' ', $rs->tgl_cetak);
                  $tgl = date('d-m-Y', strtotime($tgl_exp[0]));
                  $nomesin = $this->db->query("select no_mesin from tr_tandaterima_stnk_konsumen_detail where kd_stnk_konsumen ='$rs->kd_stnk_konsumen'")->result();
                ?>
                  <tr>
                    <td><?php echo  $no ?></td>
                    ...
                    <td>
                      <?php $number = 1;
                      foreach ($nomesin as $nom) {
                        echo $nom->no_mesin . "<br>";
                      } ?>
                    </td>
                    ...
                    <td>
                      <a href="dealer/penyerahan_stnk/cetak_ulang?id=<?php echo $rs->kd_stnk_konsumen ?>&p=<?php echo $rs->jenis_cetak ?>" class="btn btn-success btn-flat btn-xs" target="_blank" title="Cetak"><i class="fa fa-print"></i></a>
                    </td>
                  </tr>
                <?php $no++;
                endforeach ?>
          ...
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-md-12">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        ...
                        <input type="text" required class="form-control" placeholder="No Mesin/ Nama Konsumen/ Leasing" name="search" autocomplete="off" value="<?php echo  $search ?>">
                      </div>
                      <div class="col-sm-1">
                ...
                <form class="form-horizontal" action="dealer/penyerahan_stnk/cetak" method="POST">
                      ...
                      <?php if ($dt_serah != null) {
                        ...
                        foreach ($dt_serah->result() as $rs) {  ?>
                          <tr>
                            ...
                            <td align="center">
                              <input type="checkbox" name="no_mesin_checked[]" value='<?php echo  $rs->no_mesin ?>'>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" required class="form-control" name="disetujui" autocomplete="on">
                    </div>
                  </div>
                  <?php if ($setprint == 'bpkb') : ?>
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" required class="form-control" name="diperiksa" autocomplete="on">
                      </div>
                    </div>
                  <?php endif ?>
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" required class="form-control" name="diserahkan" autocomplete="on">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Diterima Oleh</label>
                    <div class="col-sm-4">
                      <input type="text" required class="form-control" name="diterima" autocomplete="on">
                    </div>
                  </div>
                  <div class="form-group">
