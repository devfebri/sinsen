  ...
  $(document).ready(function(){
    ...
    <div class="box box-default">
      <div class="box-header with-border">
        <h3 class="box-title">
          <a href="dealer/laporan_penjualan">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form  class="form-horizontal" id="form_" action="dealer/laporan_penjualan/<?= $form ?>" method="post" enctype="multipart/form-data">
              <?php if (isset($row)): ?>
    ...
    methods: {
      getUnit: function () {
       ...
       $.ajax({
        ...
        url:'<?= base_url('dealer/laporan_penjualan/get_unit') ?>',
        type:"POST",
        data: values,
        cache:false,
        dataType:'JSON',
...
<script>
   $(document).ready(function(){  
      var dataTable = $('#datatable_server').DataTable({  
         ...
         "ajax":{  
              url:"<?php echo site_url('dealer/laporan_penjualan/fetch'); ?>",  
              type:"POST",
              dataSrc: "data",
              data: function (d) {
                  return d;
