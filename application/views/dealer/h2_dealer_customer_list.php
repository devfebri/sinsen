  ...
  <section class="content">
    <div class="box box-default">
      ...
      <div class="alert alert-warning alert-dismissable">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" id="frm" method="post" action= "dealer/H2_dealer_customer_list/export_excel" enctype="multipart/form-data">
              <div class="box-body">                                                              
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nomor Mesin</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" name="no_mesin" id="no_mesin" placeholder="Cari Nomor Mesin">
                  </div>  
                  <label for="inputEmail3" class="col-sm-2 control-label">Active Passive</label>
                  <div class="col-sm-4">
                    <select class="form-control form-select" aria-label="Default select example" name="active_passive" id="active_passive">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select class="form-control form-select" aria-label="Default select example" name="frekuensi_service" id="frekuensi_service">
                  ...
                  <div class="col-sm-4">
                    <select class="form-control form-select" aria-label="Default select example" name="avg_rp_ue" id="avg_rp_ue">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select class="form-control form-select" aria-label="Default select example" name="waktu_service_terakhir" id="waktu_service_terakhir">
                  ...
                  <div class="col-sm-4">
                    <select class="form-control select2" aria-label="Default select example" name="profesi" id="profesi">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select class="form-control form-select" aria-label="Default select example" name="status_fu" id="status_fu">
                  ...
                  <div class="col-sm-4">
                    <input id='last_fu' type="text" class="form-control" placeholder="Cari Last FU">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select class="form-control form-select" aria-label="Default select example" name="gender" id="gender">
                  ...
                  <div class="col-sm-4">
                    <select class="form-control form-select" aria-label="Default select example" name="km_terakhir" id="km_terakhir">
                ...
                <div class="form-group" >
                  ...
                  <div class="col-sm-4">
                    <!-- <select class="form-control form-select" aria-label="Default select example" name="tipe_kendaraan"> -->
                        <!-- <option selected disabled>Pilih Tipe Kendaraan</option>-->
                        <!-- <select class="js-example-basic-multiple" name="states[]" multiple="multiple">
                        <?php foreach($kendaraan->result() as $motor) : ?>
                            <option value="<?php echo $motor->id_tipe_kendaraan?>"><?php echo $motor->tipe_ahm?></option>
                        <?php endforeach; ?>
                        </select> -->
                    <!-- </select> -->
                    <div class="input-group" id="filter_mc_type">
                      ...
                      <input type="hidden" :value='filters' name='filters_id_tipe_kendaraan' id='id_tipe_kendaraan'>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    <input id='tahun_motor' type="text" name="tahun_motor"  id="tahun_motor" class="form-control" placeholder="Tahun Motor">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4" id="filter_toj">
                    <div class="input-group" >
                      ...
                      <div class="input-group-btn">
                        <button class="btn btn-flat btn-primary" type='button' data-toggle='modal' data-target='#h2_last_toj' id="last_toj2"><i class="fa fa-search"></i></button>
                      </div>
                    </div>
                ...
                <div class="form-group">
                  <div class="col-sm-1" style="margin-right: -12px;">
                    <button type="button" id="btn-reset" name="process" value="reset" class="btn btn-sm bg-maroon "><i class="fa fa-history"></i> Reset</button>                                                      
  		            ...
  		            <!-- <div class="col-sm-1" style="margin-right: -12px;">
                    <button type="button" name="process" value="submit2" class="btn btn-sm bg-blue "></i> Submit</button>                                                      
                  </div> -->
                  <div class="col-sm-1" style="margin-right: -12px;">
                    <button type="button" name="process" value="submit2" id="btn-search" onclick="submit_data()" class="btn btn-sm bg-blue "><i class="fa fa-search"></i> Search</button>                                                      
                  </div>
                  <div class="col-sm-1" style="margin-right: 17px;">
                    <button type="submit" name="process" value="export_excel" class="btn btn-sm btn-success"><i class="fa fa-download" ></i> Export Excel</button>                                                      
                  </div>
                  <!-- href="dealer/h2_dealer_customer_list/generate_data" -->
                  <div class="col-sm-1" style="margin-right: 24px;">
                    <button type="button" name="process" value="generateData"  class="btn btn-sm btn-primary btn_generate" onclick="generate_data()"> <i class="fa fa-upload"> </i> Generate Data </button>                                                      
                  </div>
                  <div class="col-sm-1">
  ...
  <?php }elseif($set=="detail"){?>
    <section class="content">
      <div class="box box-default">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">
            <a href="dealer/h2_dealer_customer_list">
              <button class="btn bg-maroon btn-flat margin"><i class="fa fa-arrow-left"></i> Kembali </button>
            </a>
          </h3>
          <form class="form-horizontal" id="frm_update" method="post" action= "" enctype="multipart/form-data">
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  <h2 class="box-title">
                    <h4><b>Profil Customer</b></h4>
                    <input type="hidden" name="id_customer" id="id_customer" value="<?php echo $getDetailData->row()->id_customer ?>">
                  </h2>
                    <div class="row">
                      <div class="col-sm-6">
                        <table class="table">
                          ...
                          <tr>
                              <td>Tanggal Lahir</td>
                              <td>:</td>
                              <td> <input type="text" class="form-control datepicker" name="tgl_lahir" value="<?= $getDetailData->row()->tgl_lahir ?>" id="tgl_lahir"></td>
                          </tr>
                          <tr>
                              <td>Asal Provinsi</td>
                              <td>:</td>
                          ...
                          <tr>
                              ...
                              <td>:</td>
                              <td><?php echo $getDetailData->row()->tgl_pembelian ?></td>
                          </tr> 
                        </table>
                      </div>
                      <div class="col-sm-6">
                        <table class="table">
                          <tr>
                              <td>No Hp</td>
                              <td>:</td>
                              <td><input type="number" class="form-control" name="no_hp" value="<?=$getDetailData->row()->hp_pembawa?>" id="no_hp">
                              <small>Ex.0852XXXXXXXX</small></td>
                          </tr> 
                          <tr>
                              <td>Email</td>
                              <td>:</td>
                              <td><input type="email" class="form-control" name="email" value="<?=$getDetailData->row()->email?>" id="email">
                          </tr> 
                          <tr>
                          ...
                          <tr>
                              ...
                              <td>:</td>
                              <td> <input type="text" class="form-control" name="tujuan_penggunaan_motor" value="<?=$getDetailData->row()->tujuan_penggunaan_motor?>" id="tujuan_penggunaan_motor"></td>
                          </tr> 
                          <tr>
                              <td>Last ToJ</td>
                              <td>:</td>
                          ...
                          <tr>
                              ...
                              <td>:</td>
                              <td><?php echo $getDetailData->row()->saran_mekanik  ?></td>
                          </tr>
                        </table>
                      </div>
                    </div>
            ...
            <div class=" box-footer">
              <div class="col-sm-12" align="center">
                ...
                <button type="button" name="process" value="updateData" id="btn_update"  class="btn btn-sm btn-warning btn_generate" onclick="update_data()"> <i class="fa fa-pencil"> </i> Update Data </button>                                                      
              </div>
              </div>
            </div>
          </form>
    ...
    <script>
      const update_data = () => {
        ...
        if(confirm('Yakin data akan diupdate?')){
          $.ajax({
                    type: "POST",
                    url: "<?= base_url('dealer/h2_dealer_customer_list/update_data') ?>",
                    beforeSend: function(){
...
<script>
    ...
    $("#h2_last_toj").on('change',"input[type='checkbox']",function(e){
      ...
      function drawing_fu_table(){
        ...
        bDestroy: true,
        ajax: {
          url: "<?= base_url('dealer/H2_dealer_customer_list/getDataTable') ?>",
          dataSrc: "data",
          type: "POST",
          data: function(d){
        ...
        columns: [
          ...
          { data: 'deskripsi', width: '100px', orderable: false },
          { data: 'pekerjaan' },
    ...
    // $('#last_toj').on('select2:select', function (e) {
    //   // alert("Selected value is: "+$("#last_toj").val());
    //   list_fu_table.draw();
    // }).on('select2:unselecting',function(e){
    //   // history.go(0);
    //   var tes=$("#last_toj").val()
    //   alert(tes)
    //   // list_fu_table.ajax.reload();
    //   // list_fu_table.draw();
    // });
    // $('.last_toj2').on('click', _.debounce(function(){
    //     alert("sda")
    //   }, 500));
  ...
  const generate_data = () => {
    if(confirm('Yakin data akan di-generate?')){
      $.ajax({
                type: "POST",
                url: "<?= base_url('dealer/h2_dealer_customer_list/save_generate') ?>",
  ...
  const sync_data = () => {
    // if(confirm('Yakin data akan di-generate?')){
      $.ajax({
                type: "POST",
                url: "<?= base_url('dealer/h2_dealer_customer_list/sync_data') ?>",
                dataType: "JSON",
