    ...
    ?>
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    <div class="form-input">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" name="nama_customer" required readonly v-model="customer.nama_customer">
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                    <div class="form-input">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" name="nama_stnk" required readonly v-model="customer.nama_stnk">
                      </div>
                    </div>
                    <div class="form-input">
                  ...
                  <div class="form-group">
                    <div class="form-input">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" name="no_polisi" v-model="customer.no_polisi" readonly required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="form-input">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" v-model="customer.id_tipe_kendaraan" readonly required name="id_tipe_kendaraan" id='id_tipe_kendaraan'>
                      </div>
                    </div>
                    <div class="form-input">
                      <label for="inputEmail3" class="col-sm-2 control-label">Deskripsi Tipe Unit *</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" v-model="customer.tipe_ahm" readonly name="desk_tipe_unit" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="form-input">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" v-model="customer.no_mesin" readonly required name="no_mesin">
                      </div>
                    </div>
                    <div class="form-input">
                      <label for="inputEmail3" class="col-sm-2 control-label">No. Rangka *</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" v-model="customer.no_rangka" readonly required name="no_rangka">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="form-input">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" v-model="customer.tahun_produksi" readonly required name="tahun_motor" onkeypress="return number_only(event)">
                      </div>
                    </div>
                    <div class="form-input">
                      <label for="inputEmail3" class="col-sm-2 control-label">Tanggal Pembelian *</label>
                      <div class="col-sm-4">
                        <date-picker name="tgl_pembelian" v-model="customer.tgl_pembelian" id="tgl_pembelian" readonly required></date-picker>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="form-input" id="div_informasi_bensin">
                  ...
                  <div class="form-group">
                    <div class="form-input">
                      <label for="inputEmail3" class="col-sm-2 control-label">State of Charge (SOC)</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" id="soc" name="soc" min="0" max="100" v-model="sa.soc" :disabled="mode=='detail' || mode=='detail_wo' || mode=='insert_wo' || mode=='update_wo'" <?= $disabled ?>>
                      </div>
                    </div>
                    <div class="form-input">
                      <label for="inputEmail3" class="col-sm-2 control-label">Serial Number Battery Saat Ini</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" id="serial_number_battery" name="serial_number_battery" v-model="sa.serial_number_battery" :disabled="mode=='detail' || mode=='detail_wo' || mode=='insert_wo' || mode=='update_wo'" <?= $disabled ?>>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12">
                    ...
                    <div class="form-input">
                      ...
                      <div class="col-sm-4">
                        <select name="asal_unit_entry" v-model="sa.asal_unit_entry" class="form-control" :disabled="mode=='detail' || mode=='detail_wo' || mode=='insert_wo' || mode=='update_wo'" <?= $disabled ?> required>
                          <option value="">-choose-</option>
                          <?php $filter['active'] = 1;
                          $activity_promotion = $this->m_sm->getActivityPromotion($filter)->result(); ?>
                  ...
                  <div class="col-md-12" id="div_lcr" v-if="(mode=='insert_wo' && (status_lcr == 'perlu_lcr_check' ||status_lcr == 'perlu_lcr_treatment' ||status_lcr == 'perlu_lcr_penggantian')) || (mode=='update_wo' && (status_lcr == 'perlu_lcr_check' ||status_lcr == 'perlu_lcr_treatment' ||status_lcr == 'perlu_lcr_penggantian'||sa.kesediaan_customer || sa.kesediaan_customer_lcr_treatment || sa.kesediaan_customer_lcr_ganti)) ||(mode=='detail_wo' && (sa.kesediaan_customer_lcr_id || sa.kesediaan_customer_lcr_treatment || sa.kesediaan_customer_lcr_ganti))">
                    <button style="font-size: 11pt;font-weight: 540;width: 100%" class="btn btn-success btn-flat btn-sm" disabled>Layanan Cek Rangka (LCR)</button><br><br>
                    <input type="text" id="status_lcr" name="status_lcr" v-model="status_lcr" hidden>
                    <div class="form-group" id="div_kesediaan_customer" v-if="(mode=='insert_wo' && status_lcr == 'perlu_lcr_check') || (mode == 'update_wo' && (sa.kesediaan_customer_lcr_id || status_lcr == 'perlu_lcr_check')) || (mode=='detail_wo' && sa.kesediaan_customer_lcr_id)">
                      <div class="form-input">
                        <label for="inputEmail3" class="col-sm-2 control-label">Kesediaan Customer LCR Check*</label>
                        <div class="col-sm-4">
                          <select name="kesediaan_customer_lcr_id" v-model="sa.kesediaan_customer_lcr_id" id="kesediaan_customer" class="form-control" :disabled=" mode=='detail_wo'" <?= $disabled ?>>
                            <option value="">-choose-</option>
                            <?php
                      ...
                      <div class="form-input" v-if="sa.kesediaan_customer_lcr_id == 3">
                        <label for="inputEmail3" class="col-sm-2 control-label">Alasan Tidak Bersedia</label>
                        <div class="col-sm-4">
                          <select name="record_reason_lcr_id" v-model="sa.record_reason_lcr_id" class="form-control" id="record_reason" :disabled="mode=='detail_wo'" <?= $disabled ?>>
                            <option value="">-choose-</option>
                            <?php
                      ...
                      <div class="form-input" v-if="sa.kesediaan_customer_lcr_id == 1 || sa.kesediaan_customer_lcr_id == 2">
                        <label for="inputEmail3" class="col-sm-2 control-label">Hasil Pengecekan LCR</label>
                        <div class="col-sm-4">
                          <select name="hasil_pengecekan_lcr_id" v-model="sa.hasil_pengecekan_lcr_id" class="form-control" id="hasil_pengecekan" :disabled="mode=='detail' || mode=='detail_wo'" <?= $disabled ?>>
                            <option value="">-choose-</option>
                            <?php
                    ...
                    <div class="form-group" v-if="mode=='insert_wo'||mode=='update_wo' ||mode=='detail_wo' ">
                      <div class="form-group" v-if="status_lcr == 'perlu_lcr_treatment' || sa.kesediaan_customer_lcr_treatment">
                        <div class="form-input">
                          <label for="inputEmail3" class="col-sm-2 control-label">Kesediaan Customer LCR Treatment</label>
                          <div class="col-sm-4">
                            <select name="kesediaan_customer_lcr_treatment" v-model="sa.kesediaan_customer_lcr_treatment" id="kesediaan_customer_lcr_treatment" class="form-control" :disabled=" mode=='detail_wo'" <?= $disabled ?>>
                              <option value="">-choose-</option>
                              <?php
                              $getPilihanKesediaanCustomer = $this->m_sm->getPilihanKesediaanCustomer()->result(); ?>
                              <?php foreach ($getPilihanKesediaanCustomer as $act2) { ?>
                        ...
                        <div class="form-input" v-if="sa.kesediaan_customer_lcr_treatment == 3">
                          <label for="inputEmail3" class="col-sm-2 control-label">Alasan Tidak Bersedia LCR Treatment</label>
                          <div class="col-sm-4">
                            <select name="record_reason_lcr_id_treatment" v-model="sa.record_reason_lcr_id_treatment" class="form-control" id="record_reason_lcr_treatment" :disabled="mode=='detail_wo'" <?= $disabled ?>>
                              <option value="">-choose-</option>
                              <?php
                              $getAlasanTidakBersedia = $this->m_sm->getAlasanTidakBersedia()->result(); ?>
                              <?php foreach ($getAlasanTidakBersedia as $act3) { ?>
                      ...
                      <div class="form-group" v-if="status_lcr == 'perlu_lcr_penggantian'|| sa.kesediaan_customer_lcr_ganti">
                        <div class="form-input">
                          <label for="inputEmail3" class="col-sm-2 control-label">Kesediaan Customer LCR Ganti</label>
                          <div class="col-sm-4">
                            <select name="kesediaan_customer_lcr_ganti" v-model="sa.kesediaan_customer_lcr_ganti" id="kesediaan_customer_lcr_ganti" class="form-control" :disabled=" mode=='detail_wo'" <?= $disabled ?>>
                              <option value="">-choose-</option>
                              <?php
                              $getPilihanKesediaanCustomer = $this->m_sm->getPilihanKesediaanCustomer()->result(); ?>
                              <?php foreach ($getPilihanKesediaanCustomer as $act2) { ?>
                        ...
                        <div class="form-input" v-if="sa.kesediaan_customer_lcr_ganti == 3">
                          <label for="inputEmail3" class="col-sm-2 control-label">Alasan Tidak Bersedia LCR Ganti</label>
                          <div class="col-sm-4">
                            <select name="record_reason_lcr_id_ganti" v-model="sa.record_reason_lcr_id_ganti" class="form-control" id="record_reason_lcr_ganti" :disabled="mode=='detail_wo'" <?= $disabled ?>>
                              <option value="">-choose-</option>
                              <?php
                              $getAlasanTidakBersedia = $this->m_sm->getAlasanTidakBersedia()->result(); ?>
                              <?php foreach ($getAlasanTidakBersedia as $act3) { ?>
                        ...
                        <tr v-for="(dt, index) of details" v-bind:style="[dt.pekerjaan_batal==1?{'background':'#f1d6ce'}:{}]">
                          <td>
                            ...
                            <table class="table table-condensed table-bordered" v-bind:style="[dt.pekerjaan_batal==1?{'background':'#f1d6ce'}:{}]">
                              ...
                              <tr v-if="dt.id_type=='C1' || dt.id_type=='C2'|| dt.id_type=='LC'|| dt.id_type=='LT1'|| dt.id_type=='LT2'|| dt.id_type=='LG'">
                                <td>FRT</td>
                                <td>{{dt.frt_claim}}</td>
                                <td>Labour Cost</td>
                              ...
                              <tr>
                                <td v-if="dt.id_type=='C1' || dt.id_type=='C2' || dt.id_type=='LC'|| dt.id_type=='LT1'|| dt.id_type=='LT2'|| dt.id_type=='LG'">Estimasi Harga Jasa</td>
                            ...
                            <table class="table table-bordered" style="margin-bottom: 10px;width: 100%" v-bind:style="[dt.pekerjaan_batal==1?{'background':'#f1d6ce'}:{}]">
                              <tr v-if="dt.need_parts=='yes' || dt.need_parts=='Yes'">
                                ...
                                <td v-if="dt.id_type=='C1' || dt.id_type=='C2'|| dt.id_type=='LC'|| dt.id_type=='LT1'|| dt.id_type=='LT2'|| dt.id_type=='LG'"><b>HET/1.1</b></td>
                                <td v-else><b>HET</b></td>
                                <td><b>Total HET</b></td>
                                <td><b>Total Diskon</b></td>
                                <td><b>Subtotal</b></td>
                                <td v-if="dt.id_type=='C1' || dt.id_type=='C2'|| dt.id_type=='LC'|| dt.id_type=='LT1'|| dt.id_type=='LT2'|| dt.id_type=='LG'"><b>Part Utama</b></td>
                              ...
                              <tr v-for="(prt, index_prt) of dt.parts">
                                ...
                                <td>{{prt.jenis_order}}
                                  ...
                                  <span v-if="prt.jenis_order=='HLO' && mode=='detail_wo'"><br><b>No Booking : <br>{{prt.id_booking}}</b></span>
                                </td>
                                <td>{{prt.qty}}</td>
                                ...
                                <td v-if="dt.id_type=='C1' || dt.id_type=='C2'|| dt.id_type=='LC'|| dt.id_type=='LT1'|| dt.id_type=='LT2'|| dt.id_type=='LG'">{{prt.part_utama==1?'Yes':'No'}}</td>
                              ...
                              <tr v-if="mode=='update_wo' && dt.pekerjaan_batal!=1 && dt.need_parts=='Yes'">
                                ...
                                <td v-if="dt.id_type=='C1' || dt.id_type=='C2'|| dt.id_type=='LC'|| dt.id_type=='LT1'|| dt.id_type=='LT2'|| dt.id_type=='LG'">
                          ...
                          <td colspan=2>
                            ...
                            <table class="table table-condensed table-bordered">
                              ...
                              <tr>
                                ...
                                <td v-if="dtl.id_type=='C1' || dtl.id_type=='C2'|| dtl.id_type=='LC'|| dtl.id_type=='LT1'|| dtl.id_type=='LT2'|| dtl.id_type=='LG'"></td>
                                <td v-else>Promo</td>
                                <td v-if="dtl.id_type=='C1' || dtl.id_type=='C2'|| dtl.id_type=='LC'|| dtl.id_type=='LT1'|| dtl.id_type=='LT2'|| dtl.id_type=='LG'"></td>
                                <td v-else>
                              ...
                              <tr v-if="dtl.id_type=='C1' || dtl.id_type=='C2' || dtl.id_type=='LC'|| dtl.id_type=='LT1'|| dtl.id_type=='LT2'|| dtl.id_type=='LG'">
                                <td>FRT</td>
                                <td>
                                  <select name='frt_claim' v-model='dtl.frt_claim'>
                                    <option value=''>-choose-</option>
                                    <?php foreach ($options_frt as $option) : ?>
                              ...
                              <tr>
                                <td v-if="dtl.id_type=='C1' || dtl.id_type=='C2' || dtl.id_type=='LC'|| dtl.id_type=='LT1'|| dtl.id_type=='LT2'|| dtl.id_type=='LG'">Estimasi Harga Jasa</td>
                                <td v-else>Estimasi Biaya Service</td>
                            ...
                            <table class="table table-bordered" style="margin-bottom: 10px;width: 100%">
                              <tr v-if="dtl.need_parts=='yes'">
                                ...
                                <td v-if="dtl.id_type=='C1' || dtl.id_type=='C2' || dtl.id_type=='LC'|| dtl.id_type=='LT1'|| dtl.id_type=='LT2'|| dtl.id_type=='LG'"><b>HET/1.1</b></td>
                                <td v-else><b>HET</b></td>
                                <td><b>Total HET</b></td>
                                <td><b>Total Diskon</b></td>
                                <td><b>Subtotal</b></td>
                                <td v-if="dtl.id_type=='C1' || dtl.id_type=='C2' || dtl.id_type=='LC'|| dtl.id_type=='LT1'|| dtl.id_type=='LT2'|| dtl.id_type=='LG'"><b>Part Utama</b></td>
                                <td><b>Aksi</b></td>
                              </tr>
                              <tr v-for="(prt, index) of dtl.parts">
                                ...
                                <td>{{subTotalPart(prt,'total_diskon') | toCurrency }}</td>
                                <td>{{subTotalPart(prt,'subtotal') | toCurrency }}</td>
                                <td v-if="dtl.id_type=='C1' || dtl.id_type=='C2' || dtl.id_type=='LC'|| dtl.id_type=='LT1'|| dtl.id_type=='LT2'|| dtl.id_type=='LG'">
                  ...
                  <table class="table table-bordered table-condensed" style="background:#f9f9f9;font-weight:600">
                    ...
                    <tr>
                      <td>Total FRT</td>
                      <td>: {{tot_frt}} Menit</td>
                      <td>Total Harga Part <span style='color:blue' v-if="dtl.id_type=='C1' || dtl.id_type=='C2' || dtl.id_type=='C2'|| dtl.id_type=='LC'|| dtl.id_type=='LT1'|| dtl.id_type=='LT2'|| dtl.id_type=='LG'"><br><i>Untuk Claim C1/C2 harga parts adalah HET / 1.1</i></span></td>
      ...
      <script>
        ...
        function pilihJasa(js) {
          // console.log(js);
          let labour_cost = 0;
          if (js.id_type == 'C1' || js.id_type == 'C2' || js.id_type == 'LC' || js.id_type == 'LT1' || js.id_type == 'LT2' || js.id_type == 'LG') {
          ...
          form_.dtl = {
            ...
            pekerjaan_batal: js.pekerjaan_batal
          }
        ...
        var form_ = new Vue({
          ...
          methods: {
            is_claim: function(dtl) {
              ...
              if (dtl.id_type == 'LC') is_claim = 1;
              if (dtl.id_type == 'LT1') is_claim = 1;
              if (dtl.id_type == 'LT2') is_claim = 1;
              if (dtl.id_type == 'LG') is_claim = 1;
              return is_claim
            },
            ...
            estimasi_biaya_servis: function(dt) {
              let estimasi = 0;
              let waktu = 0;
              if (dt.id_type == 'C1' || dt.id_type == 'C2' || dt.id_type == 'LC' || dt.id_type == 'LT1' || dt.id_type == 'LT2' || dt.id_type == 'LG') {
            ...
            totals: function(tipe) {
              ...
              for (dt of this.details) {
                ...
                if (tipe == 'biaya_servis' && (dt.pekerjaan_batal == 0 || dt.pekerjaan_batal == undefined)) {
                  ...
                  tot += this.estimasi_biaya_servis(dt);
                  ...
                  if (dt.pekerjaan_batal == 0 || dt.pekerjaan_batal == undefined) {
                    ...
                    tot_biaya_servis += this.estimasi_biaya_servis(dt);
                  }
                  if (dt.parts.length > 0) {
                    for (prt of dt.parts) {
        ...
        function updateStatusLCR(status) {
          form_.status_lcr = status;
        }
            ...
            success: function(response) {
              ...
              if (response.status == 'sukses') {
                ...
                if (form_.mode == 'insert') {
                  if (form_.customer.no_mesin != null || form_.customer.no_mesin != '' || form_.customer.no_mesin != undefined) {
                    checkLCR(function(status) {
                      if (status === 'perlu_lcr_check') {
                        alert("Kendaraan Terdeteksi perlu mendapatkan \"Pengecekan\" ");

                      }
                      if (status === 'perlu_lcr_treatment') {
                        alert("Kendaraan Terdeteksi perlu mendapatkan \"Treatment\" ");
                      }
                      if (status === 'perlu_lcr_penggantian') {
                        alert("Kendaraan Terdeteksi perlu mendapatkan \"Penggantian\" ");
                      }
                    });
                    // checkLCR();
                  }
                }
                if (form_.customer.is_ev == 1) {
                  $("#div_informasi_bensin").hide();
                }
              }
            },
            error: function() {
        ...
        function checkLCR(callback) {
          $.ajax({
            beforeSend: function() {},
            url: '<?= base_url('dealer/sa_form/checkLCR') ?>',
            type: "POST",
            data: {
              id_customer: form_.customer.id_customer,
            ...
            success: function(response) {
              ...
              if (response.status === 'perlu_lcr_check') {
                $('#kesediaan_customer').attr('required', 'required');
                updateStatusLCR(response.status);
              } else if (response.status === 'perlu_lcr_treatment') {
                $('#kesediaan_customer_lcr_treatment').attr('required', 'required');
                $('#kesediaan_customer').removeAttr('required');
                $('#kesediaan_customer').hide();
                $('#div_kesediaan_customer').hide();
                updateStatusLCR(response.status);
              } else if (response.status === 'perlu_lcr_penggantian') {
                $('#kesediaan_customer_lcr_ganti').attr('required', 'required');
                $('#kesediaan_customer').removeAttr('required');
                $('#kesediaan_customer').hide();
                $('#div_kesediaan_customer').hide();
                updateStatusLCR(response.status);
          ...
          $.ajax({
            ...
            success: function(response) {
              if (response.status == 'sukses') {
                ...
                if (form_.mode == 'insert_wo' || form_.mode == 'update_wo') {
                  if (form_.customer.no_mesin != null || form_.customer.no_mesin != '' || form_.customer.no_mesin != undefined) {
                    checkLCR(function(status) {
                      if (status === 'perlu_lcr_check') {
                        alert("Kendaraan Terdeteksi perlu mendapatkan \"Pengecekan\" ");
        ...
        function pilihPart(part) {
          ...
          if (form_.dtl.id_type === 'C1' || form_.dtl.id_type === 'C2' || form_.dtl.id_type === 'LC' || form_.dtl.id_type === 'LT1' || form_.dtl.id_type === 'LT2' || form_.dtl.id_type === 'LG') {
            harga = Math.round(part.harga_dealer_user / <?php echo getPPN(1.1) ?>);
          } else {
        ...
        $('#submitBtn').click(function() {
          ...
          if ($('#form_').valid()) // check if form is valid
          {
            ...
            <?php if($mode == 'insert' || $mode == 'edit') {?>
              ...
              jasa_lt = 0 ;
              for(dt of form_.details){
                if(dt['desk_type'] === 'LCR Check' && (dt['pekerjaan_batal'] == 0 || dt['pekerjaan_batal'] == undefined)){
                  jasa_lcr_check += 1;
                }else if(dt['desk_type'] === 'LCR Treatment 1' && (dt['pekerjaan_batal'] == 0 || dt['pekerjaan_batal'] == undefined)){
                  jasa_lt += 1;
                }else if(dt['desk_type'] === 'LCR Ganti' && (dt['pekerjaan_batal'] == 0 || dt['pekerjaan_batal'] == undefined)) {
                  jasa_lg += 1;
                }else if((dt['desk_type'] !== 'LCR Treatment 1' || dt['desk_type'] !== 'LCR Check' || dt['desk_type'] !== 'LCR Ganti') && (dt['pekerjaan_batal'] == 0 || dt['pekerjaan_batal'] == undefined)) {
                  jasa_non_lcr += 1;
                }
              }

              if(jasa_lcr_check >0 && jasa_lt > 0 && jasa_non_lcr > 0){
                  alert("Jasa LCR Check, Treatment, dan jasa selain LCR tidak dapat digabung!");
                  return false;
              }else if(jasa_lt > 0 && (jasa_non_lcr > 0 || jasa_lg > 0 || jasa_lcr_check > 0)){
                  alert("Jasa LCR Treatment tidak boleh digabung dengan jasa lain"); 
                  return false;
              }else if(jasa_lg >0 && (jasa_lcr_check > 0 || jasa_lt > 0|| jasa_non_lcr > 0)){
                  alert("Jasa LCR Ganti tidak boleh digabung dengan jasa lain"); 
                  return false;
              }else if(jasa_lcr_check >0 && (jasa_lg > 0 || jasa_lt > 0|| jasa_non_lcr > 0)){
                  alert("Jasa LCR Check tidak boleh digabung dengan jasa lain"); 
                  return false;
              }
            <?php }?>
            <?php if ($mode == 'insert') { ?>
              if (form_.customer.is_ev == 1) {
                ...
                $('#informasi_bensin').val(null);
                if (form_.sa.soc == '' || form_.sa.soc == null) {
                  alert('State Of Charge (SOC) Wajib Diisi!');
                  return false
                } else {
                  $('#soc').on('input', function() {
                    var inputVal = $(this).val();

                    inputVal = inputVal.replace(/,/g, '.');

                    // Mengecek validitas input
                    if (!inputVal.match(/^\d*\.?\d*$/) || parseFloat(inputVal) > 100 || parseFloat(inputVal) < 0) {
                      alert('Input harus berupa angka dari 0 hingga 100. Gunakan titik untuk nilai desimal.');
                      $(this).val('');
                      return false;
                    }
                  });
                }
                if (form_.sa.serial_number_battery == '' || form_.sa.serial_number_battery == null || form_.sa.serial_number_battery == 0 || form_.sa.serial_number_battery.length < 7) {
                  alert('Serial Number Terakhir Wajib Diisi!');
                  return false
                } else {
                  let isValidSerialNumber = false;
                  ...
                  function check_serial_number() {
                    $.ajax({
                      ...
                      data: {
                        serial_number_battery: form_.sa.serial_number_battery
                      },
                      dataType: "json",
                      success: function(response) {
            ...
            <?php if ($mode == 'insert_wo') { ?>
              if ($('#kesediaan_customer').attr('required') === 'required') {
                kesediaan_customer = $("#kesediaan_customer").val();
                if (kesediaan_customer === '1') {
                  // $('#hasil_pengecekan').attr('required', 'required');
                  // alert()
                  hasil_pengecekan = $("#hasil_pengecekan").val();
                  if (hasil_pengecekan === '' || hasil_pengecekan === null || hasil_pengecekan === undefined) {
                    alert('"Hasil Pengecekan" LCR belum diisi!');
                    // return false
                  } 
                  // else if (hasil_pengecekan === '1') {
                  //   kesediaan_customer_lcr_treatment = $("#kesediaan_customer_lcr_treatment").val();
                  //   record_reason_lcr_treatment = $("#record_reason_lcr_treatment").val();
                  //   if (kesediaan_customer_lcr_treatment === '' || kesediaan_customer_lcr_treatment === null || kesediaan_customer_lcr_treatment === undefined) {
                  //     alert('"Kesediaan Customer LCR Treatment" wajib diisi!');
                  //     return false
                  //   } else if (kesediaan_customer_lcr_treatment === '3') {
                  //     if (record_reason_lcr_treatment === '' || record_reason_lcr_treatment === null || record_reason_lcr_treatment === undefined) {
                  //       alert('"Alasan Tidak Bersedia LCR Treatment" wajib diisi!');
                  //       return false
                  //     }
                  //   }
                  // } else if (hasil_pengecekan === '2') {
                  //   kesediaan_customer_lcr_ganti = $("#kesediaan_customer_lcr_ganti").val();
                  //   record_reason_lcr_ganti = $("#record_reason_lcr_ganti").val();
                  //   if (kesediaan_customer_lcr_ganti === '' || kesediaan_customer_lcr_ganti === null || kesediaan_customer_lcr_ganti === undefined) {
                  //     alert('"Kesediaan Customer LCR Ganti" wajib diisi!');
                  //     return false
                  //   } else if (kesediaan_customer_lcr_ganti === '3') {
                  //     if (record_reason_lcr_ganti === '' || record_reason_lcr_ganti === null || record_reason_lcr_ganti === undefined) {
                  //       alert('"Alasan Tidak Bersedia LCR Ganti" wajib diisi!');
                  //       return false
                  //     }
                  //   }
                  // }
                } else if (kesediaan_customer === '3') {
                  // $('#record_reason').attr('required', 'required');
                  record_reason = $("#record_reason").val();
                  if (record_reason === '' || record_reason === null || record_reason === undefined) {
              ...
              kesediaan_customer_lcr_treatment = $("#kesediaan_customer_lcr_treatment").val();
              kesediaan_customer_lcr_ganti = $("#kesediaan_customer_lcr_ganti").val();
              if (kesediaan_customer === '1' && hasil_pengecekan === '1') {
                let jasa_lcr = 0;
                for (dt of form_.details) {
                  if (dt['desk_type'] === 'LCR Check') {
                    jasa_lcr += 1;
                  }
                }
                if (jasa_lcr == 0) {
                  alert("Jasa LCR Check Wajib ditambahkan!");
                  return false;
                }
              }

              if (kesediaan_customer_lcr_treatment === '1') {
                let jasa_lcr_treatment = 0;
                for (dt of form_.details) {
                  if (dt['desk_type'] === 'LCR Treatment 1') {
                    jasa_lcr_treatment += 1;
                  }
                }
                if (jasa_lcr_treatment == 0) {
                  alert("Jasa LCR Treatment Wajib ditambahkan!");
                  return false;
                }
              }

              if (kesediaan_customer_lcr_ganti === '1') {
                let jasa_lcr_ganti = 0;
                for (dt of form_.details) {
                  if (dt['desk_type'] === 'LCR Ganti') {
                    jasa_lcr_ganti += 1;
                  }
                }
                if (jasa_lcr_ganti == 0) {
                  alert("Jasa LCR Ganti Wajib ditambahkan!");
                  return false;
                }
              }

              // if((kesediaan_customer_lcr_treatment === '1' || kesediaan_customer_lcr_treatment === '2') && ((kesediaan_customer === '1' || kesediaan_customer === '2') && hasil_pengecekan === '1')){
              //   let jasa_selain_lcr = 0;
              //   for (dt of form_.details) {
              //       if(((dt['desk_type'] !== 'LCR Treatment 1') ||(dt['desk_type'] !== 'LCR Check'))){
              //         jasa_selain_lcr += 1;
              //       }
              //   }
              //   if(jasa_selain_lcr > 0){
              //     alert("Terdapat jasa selain 'Jasa LCR Check dan LCR Treatment 1', jasa selain itu harus dibuat ke WO baru!");
              //     return false;
              //   }
              // }
              jasa_non_lcr = 0;
              ...
              jasa_lt = 0;
              for (dt of form_.details) {
                if (dt['desk_type'] === 'LCR Treatment 1' && (dt['pekerjaan_batal'] == 0 || dt['pekerjaan_batal'] == undefined)) {
                  if (kesediaan_customer_lcr_treatment === '' || kesediaan_customer_lcr_treatment === null || kesediaan_customer_lcr_treatment === undefined || kesediaan_customer_lcr_treatment === '3') {
                    alert("Jasa LCR Treatment dipilih, akan tetapi field 'Kesedian Customer LCR Treatment' tidak diisi / tidak bersedia");
                    return false;
                  }
                } else if (dt['desk_type'] === 'LCR Check' && (dt['pekerjaan_batal'] == 0 || dt['pekerjaan_batal'] == undefined)) {
                  if (kesediaan_customer === '' || kesediaan_customer === null || kesediaan_customer === undefined || kesediaan_customer === '3') {
                    alert("Jasa LCR Check dipilih, akan tetapi field 'Kesedian Customer LCR Check' tidak diisi / tidak bersedia");
                    return false;
                  }
                }
                ...
                if (dt['desk_type'] === 'LCR Check' && (dt['pekerjaan_batal'] == 0 || dt['pekerjaan_batal'] == undefined)) {
                  ...
                  jasa_lt += 1;
                } else if ((dt['desk_type'] !== 'LCR Treatment 1' || dt['desk_type'] !== 'LCR Check') && (dt['pekerjaan_batal'] == 0 || dt['pekerjaan_batal'] == undefined)) {
                  jasa_non_lcr += 1;
                }
            ...
            <?php } ?>
            <?php if ($mode == 'update_wo') { ?>
              if ($('#kesediaan_customer').attr('required') === 'required') {
                kesediaan_customer2 = $("#kesediaan_customer").val();
                if (kesediaan_customer2 === '1') {
                  // $('#hasil_pengecekan').attr('required', 'required');
                  // alert()
                  hasil_pengecekan2 = $("#hasil_pengecekan").val();
                  if (hasil_pengecekan2 === '' || hasil_pengecekan2 === null || hasil_pengecekan2 === undefined) {
                    alert('"Hasil Pengecekan" LCR wajib diisi!');
                    return false
                  } 
                  // else if (hasil_pengecekan2 === '1') {
                  //   kesediaan_customer_lcr_treatment = $("#kesediaan_customer_lcr_treatment").val();
                  //   record_reason_lcr_treatment = $("#record_reason_lcr_treatment").val();
                  //   if (kesediaan_customer_lcr_treatment === '' || kesediaan_customer_lcr_treatment === null || kesediaan_customer_lcr_treatment === undefined) {
                  //     alert('"Kesediaan Customer LCR Treatment" wajib diisi!');
                  ...
                  //   }
                  // }
                } else if (kesediaan_customer2 === '3') {
                  // $('#record_reason').attr('required', 'required');
                  record_reason2 = $("#record_reason").val();
                  if (record_reason2 === '' || record_reason2 === null || record_reason2 === undefined) {
                    alert('"Alasan Tidak Bersedia" wajib diisi!');
                    return false
                  }
                }
              ...
              if (kesediaan_customer_lcr_ganti === '1') {
                let jasa_lcr_ganti = 0;
                for (dt of form_.details) {
                  if (dt['desk_type'] === 'LCR Ganti' && (dt['pekerjaan_batal'] == 0 || dt['pekerjaan_batal'] == undefined)) {
                    jasa_lcr_ganti += 1;
                  }
                }
                if (jasa_lcr_ganti == 0) {
              ...
              // if((kesediaan_customer_lcr_treatment === '1' || kesediaan_customer_lcr_treatment === '2') && ((kesediaan_customer === '1' || kesediaan_customer === '2') && hasil_pengecekan === '1')){
              //   let jasa_selain_lcr = 0;
              //   console.log(dt['desk_type']);
              //   for (dt of form_.details) {
              //     if((dt['id_type'] !== 'LT1' ||dt['id_type'] !== 'LC')){
              //       // if(dt['id_type'] !== null || dt['id_type'] !== '' || dt['id_type'] !== null){
              //         jasa_selain_lcr += 1;
              //       // }
              //     }
              //   }
              ...
              for (dt of form_.details) {
                if (dt['desk_type'] === 'LCR Treatment 1' && (dt['pekerjaan_batal'] == 0 || dt['pekerjaan_batal'] == undefined)) {
                  ...
                  if (kesediaan_customer_lcr_ganti === '' || kesediaan_customer_lcr_ganti === null || kesediaan_customer_lcr_ganti === undefined || kesediaan_customer_lcr_ganti === '3') {
                    alert("Jasa LCR Ganti dipilih, akan tetapi field 'Kesedian Customer LCR Ganti' tidak diisi / tidak bersedia");
                    return false;
                  }
                }
                if (dt['desk_type'] === 'LCR Check' && (dt['pekerjaan_batal'] == 0 || dt['pekerjaan_batal'] == undefined)) {
            ...
            <div class="col-md-12">
              <form class="form-horizontal" id="form_" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">No Claim C2</label>
                  <div class="col-sm-4">
                    <input type="text" value="<?= $row->no_claim_c2 ?>" class="form-control" name="id_customer" readonly>
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">No. Polisi</label>
