...
<style>
    ...
    <table class="table" style="font-size: 10pt">
        ...
        <tr>
            ...
            <td width="3%" style="vertical-align: top">:</td><td style="border: 1px solid black"> <?=isset($jenis->uang_dibayar)?'Rp. '.mata_uang($jenis->uang_dibayar):'&nbsp;' ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="border: 1px solid black">Total Pembayaran <?=isset($jenis->uang_dibayar)?'Rp. '.mata_uang($jenis->uang_dibayar):'&nbsp;' ?> <!-- , Sisa Piutang Rp. <?php echo mata_uang($harga - $jenis->uang_dibayar) ?> --></td>
        </tr>
    </table>
    <br>
