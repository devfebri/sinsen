...
?>
 <table class="table table-borderedx">
    ...
    <tr>
        <?php $tota_harga = $spk->harga_on_road-$spk->voucher_tambahan_1-$spk->voucher_1; ?>
        <td>Total Harga</td><td>: <?= mata_uang($tota_harga) ?></td>
    </tr>
      <tr>
        <td>Sisa Pelunasan</td><td>: <?= mata_uang($tota_harga-$spk->tanda_jadi-$spk->diskon) ?></td>
    </tr>
  </table>
<?php } ?>
</body>
