  ...
  <section class="content">
    ...
    ?>
      ...
      <div class="box box-default">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    <div class="form-input">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="keterangan" :readonly="mode=='detail'" v-model="data.keterangan" class="form-control">
                      </div>
                    </div>
                  </div>
        ...
        <?php
        $data['data'] = ['modalVendorPO', 'modalBarangLuar'];
