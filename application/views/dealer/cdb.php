  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="dealer/cdb/save" method="post" enctype="multipart/form-data">
              <div class="box-body">                              
...
function cek_customer(){
  ...
  $.ajax({
      url: "<?php echo site_url('dealer/cdb/take_spk')?>",
      type:"GET",
      data:"no_spk="+no_spk,            
      cache:false,
...
function take_harga(){
  ...
  $.ajax({
      url: "<?php echo site_url('dealer/cdb/cek_bbn')?>",
      type:"POST",
...
function take_kec(){
  ...
  $.ajax({
      url: "<?php echo site_url('dealer/cdb/take_kec')?>",
      type:"POST",
