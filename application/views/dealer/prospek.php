    ...
    <?php if ($set == 'edit') : ?>
        ...
        <section class="content">
          ...
          ?>
            ...
            <div class="box box-default">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <form class="form-horizontal" action="dealer/prospek/<?= $form ?>" method="post" enctype="multipart/form-data" id="form_">
                      <div class="box-body">
                  ...
                  <div class="col-sm-4">
                    <input type="text" required class="form-control" id="id_customer" readonly placeholder="ID Customer" name="id_customer">                    
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input type="text" class="form-control" onkeypress="return number_only(event)" maxlength="5" placeholder="Kodepos" name="kodepos" id="kode_pos" value="<?= isset($row) ? $row->kodepos : '' ?>" :disabled="mode=='detail'">
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <select class="form-control" name="jenis_sebelumnya" :disabled="mode=='detail'" required>
                              <option value="">- choose -</option>
                              <?php
                        ...
                        ";
                          ...
                          <div class="col-sm-4">
                            <select class="form-control" name="merk_sebelumnya" id="merk_sebelumnya" onchange="cek_merk_sebelumnya()" :disabled="mode=='detail'" required>
                              <option value="">- choose -</option>
                              <?php
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input type="text" oninput="this.value = this.value.toUpperCase()" id="tipe_sebelumnya" name="tipe_sebelumnya" value="<?= isset($row) ? $row->tipe_sebelumnya : '' ?>" class="form-control" :disabled="mode=='detail'">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <select class="form-control" name="status_prospek" required v-model='status_prospek' :disabled="mode=='detail'">
                              <option value="">- choose -</option>
                              <option>Low</option>
                              <option>Hot</option>
                      ...
                      <option>Loss</option>   -->
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-4">
                            <select name="sumber_prospek" class="form-control" v-model='sumber_prospek' :disabled="mode=='detail'" required>
                              <option value="">--choose--</option>
                              <?php 
          ...
          ?>
            ...
            <div class="box box-default">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <form class="form-horizontal" action="dealer/prospek/<?= $form ?>" method="post" enctype="multipart/form-data">
                      <div class="box-body">
                        <button class="btn btn-block btn-primary btn-flat" disabled> DATA PROSPEK </button> <br>
                        <?php if (isset($row)) { ?>
                          <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">Alamat (NIB)*</label>
                          <div class="col-sm-10">
                        ...
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">Kodepos *</label>
                          <div class="col-sm-4">
                            <input type="text" class="form-control" maxlength="5" required onkeypress="return number_only(event)" placeholder="Kodepos" name="kodepos" id="kode_pos">
                          </div>
                          <label for="inputEmail3" class="col-sm-2 control-label">Status Prospek *</label>
                          <div class="col-sm-4">
          ...
          ?>
            ...
            <div class="box box-default">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <form class="form-horizontal" action="dealer/prospek/update_gc" method="post" enctype="multipart/form-data" id='form_'>
                      <div class="box-body">
                        <button class="btn btn-block btn-primary btn-flat" disabled> DATA PROSPEK </button> <br>
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">ID Prospek</label>
                        ...
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">Kodepos *</label>
                          <div class="col-sm-4">
                            <input required type="text" class="form-control" maxlength="5" value="<?php echo $row->kodepos ?>" onkeypress="return number_only(event)" placeholder="Kodepos" name="kodepos" id="kode_pos">
                          </div>
                          <label for="inputEmail3" class="col-sm-2 control-label">Status Prospek *</label>
                          <div class="col-sm-4">
          ...
          ?>
            <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title">
                  <?php if((date("H:i")>='16:30' || date("H:i") <='06:00') && date('Y-m-d') <='2022-10-16'){?>
                  <a href="dealer/prospek/add">
                  ...
                  <a href="dealer/prospek/history">
                    <button class="btn bg-blue btn-flat margin"><i class="fa fa-check"></i> Cek History</button>
                  </a>

                  <a data-toggle="modal" data-target="#downPros">
                    <button class="btn bg-blue btn-flat margin"><i class="fa fa-download"></i> Download Prospek</button>
                  </a>
                </h3>
                <div class="box-tools pull-right">
                  <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
              ...
              <div class="box-body">
                ...
                <!-- Modal -->
                <div id="downPros" class="modal fade" role="dialog">
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title">Download Prospek</h4>
                      </div>
                      <div class="modal-body">
                        <form action="<?php echo base_url() ?>dealer/prospek/download_prospek" method="GET">
                          <div class="form-group">
                ...
                ?>
                <table id="tbl_prospek" class="table table-bordered table-hover">
                  <thead>
                    <tr>
               ...
               <tr class='even pointer'>
                  <td class=''>$no</td>      
                  <td class=''>$row->id_prospek</td>    
                  <td class=''>$row->id_customer</td>      
                  <td class=''>
                    <a href='dealer/prospek/detail?id=$row->id_prospek'>";?>
                  ...
                  <td width='5%'>";
                    ?>
                      ...
                      <a href='dealer/prospek/edit?id=<?php echo $row->id_prospek ?>'>
          ...
          ?>
            <div class="box">
              ...
              <div class="box-body">
                ...
                ?>
                <table id="tbl_prospek_new" class="table table-bordered table-hover">
                  <thead>
                    <th>No</th>
                    <th>ID Prospek</th>
                    <th>ID Customer</th>
            ...
            <script>
              $(document).ready(function() {
                var dataTable = $('#tbl_prospek_new').DataTable({
                  processing: true,
                  serverSide: true,
                  "language": {
                    "infoFiltered": "",
                  ...
                  order: [],
                  ajax: {
                    url: "<?= base_url('dealer/prospek/fetch_data_prospek_datatables') ?>",
                    dataSrc: "data",
                    data: function(d) {
                      return d;
                    },
                ...
                <tr class='even pointer'>
                  ...
                  <td width='5%'>";
                    ?>
                      ...
                      <a href='dealer/prospek/edit_gc?id=<?php echo $row->id_prospek_gc ?>'>
                        <button <?php echo $this->m_admin->set_tombol($id_menu, $group, "edit"); ?> class='btn btn-flat btn-xs btn-primary'><i class='fa fa-edit'></i> Edit</button>
                      </a>
                      </td>
                      </tr>
            ...
            <div class="box">
              <div class="box box-default">
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12">
                      <form class="form-horizontal" id="form_" action="dealer/prospek/<?= $form ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
      ...
      <script type="text/javascript">
        function auto() {
          ...
          $.ajax({
            url: "<?php echo site_url('dealer/prospek/cari_id') ?>",
            type: "POST",
            data: "tgl=" + tgl_js,
            cache: false,
        ...
        function take_sales() {
          ...
          $.ajax({
            url: "<?php echo site_url('dealer/prospek/take_sales') ?>",
            type: "POST",
        ...
        function take_kec() {
          ...
          $.ajax({
            url: "<?php echo site_url('dealer/prospek/take_kec') ?>",
            type: "POST",
      ...
      <script type="text/javascript">
        ...
        function getProgramUmum() {
          ...
          $.ajax({
            ...
            url: "<?php echo site_url('dealer/prospek/getProgramUmum'); ?>",
            type: "POST",
            data: values,
            cache: false,
            dataType: 'JSON',
        ...
        function getProgramGabungan() {
          ...
          $.ajax({
            ...
            url: "<?php echo site_url('dealer/prospek/getProgramGabungan'); ?>",
            type: "POST",
            data: values,
            cache: false,
            dataType: 'JSON',
      ...
      <script type="text/javascript">
        ...
        function tampil_detail(a) {
          ...
          $.ajax({
            ...
            url: "<?php echo site_url('dealer/prospek/getDetail') ?>",
            type: "POST",
            data: value,
            cache: false,
            success: function(html) {
      ...
      <script type="text/javascript">
        // $(document).ready(function() {
        //   $("#merk_sebelumnya").change(function() {
        //     var value = $(this).val();
        //     console.log(value);
        //     if (value == '6' OR value == '') {
        //       $("#merk_sebelumnya").prop('disabled', true)
        //     } else {
