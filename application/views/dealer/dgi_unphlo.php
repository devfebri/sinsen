              ...
              <form class="form" id="frm" method="GET">
                ...
                <div class="box-body">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      <label>Nomor PKB</label>
                      <input type="text" class="form-control" id="id_work_order" name="id_work_order" readonly placeholder='Klik Untuk Memilih' onclick="showModalWOProses()">
                    </div>
                    <div class="col-sm-4">
                      <label>ID HLO Document</label>
                      <input type="text" class="form-control" id="po_id" name="po_id" readonly placeholder='Klik Untuk Memilih' onclick="showModalPOPart()">
                    </div>
                  </div>
                </div>
  ...
  <script>
    ...
    function getReport(tipe) {
      var values = {
        ...
        id_work_order: document.getElementById("id_work_order").value,
        tipe: tipe
      }
