...
header("Content-Disposition: attachment; filename=Report_CDB-".date('YmdHi').".xls");
...
header("Expires: 0");
 ?>
    ...
    <body>      
      <div style="text-align: center;font-size: 13pt"><b>Laporan Customer Database</b></div>        
...
<script>
    function getReport()
    {
      ...
      if (value.tipe == '') {
        ...
        $('.loader').show();
        $('#btnShow').disabled;
        $("#showReport").attr("src",'<?php echo site_url("dealer/report_cdb?") ?>tipe='+value.tipe+'&cetak='+value.cetak+'&start_date='+value.start_date+'&end_date='+value.end_date);
