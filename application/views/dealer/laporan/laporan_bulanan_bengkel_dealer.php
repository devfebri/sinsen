            ...
            <div class="col-md-12">
              <form class="form-horizontal" id="frm" method="post" enctype="multipart/form-data">
                <div class="box-body" style="padding-bottom:0px">
                  ...
                  <!--  </div>-->
                  <!--</div>-->
                  <input type="hidden" name="dealer" id="dealer" value="<?php echo $this->m_admin->cari_dealer();?>">
    ...
    <table class="table table-bordered" border=1>
		...
		$totalAmountJob = $this->db->query("				
		    ...
		    $totalPart = $this->db->query("select 
					...
					'TAS','TB1','TBVL') then B.harga_beli ELSE 0 END),0) AS spart,
					IFNULL(SUM(CASE WHEN A.kelompok_part in('GMO','ACB','ACG','FLUID','OIL') then B.harga_beli ELSE 0 END),0) AS oil,
