...
header("Content-Disposition: attachment; filename=Reporting H23 Detail Revenue per Sumber Activity Promotion Dealer_".$no." WIB.xls");
header("Pragma: no-cache");
header("Expires: 0");
?>

<table border="1"> 
	<caption><b>Reporting H23 Revenue Parts dan Oli per Sumber Activity Promotion Dealer <?php echo $start_date." s/d ".$end_date?> - <?php echo date('H:i')?> WIB<b></caption> 
 	<tr> 		
