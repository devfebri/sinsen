  ...
  <div class="content-wrapper">
    ...
    ?>
      ...
      <body>
        ...
        <div style="text-align: center;font-size: 13pt"><b>Daily Sales</b></div>
  ...
  <script>
    function getReport(tipe) {
      ...
      if (value.tipe == '') {
        ...
        $('.loader').show();
        $('#btnShow').disabled;
        $("#showReport").attr("src", '<?php echo site_url("dealer/daily_sales?") ?>cetak=' + value.cetak + '&tahun=' + value.tahun + '&bulan=' + value.bulan + '&tipe=' + tipe);
