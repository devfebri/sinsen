  ...
  <section class="content">
    ...
    <body>
      <?php if($tanggal2 != ''){ ?>
        ...
        <div style="text-align: center;font-size: 13pt"><b>Laporan Harian Penerimaan Sepeda Motor Per Nomor Rangka</b></div>        
        ...
        <table class='table table-bordered' style='font-size: 8pt' width='100%'>
          <tr>                
            ...
            <td bgcolor='yellow' class='bold text-center'>No. Penerimaan Unit</td>
            <td bgcolor='yellow' class='bold text-center'>Tgl. Penerimaan Unit</td>                
            <td bgcolor='yellow' class='bold text-center'>No. Surat Jalan</td>     
            <td bgcolor='yellow' class='bold text-center'>Tgl. Surat Jalan</td>                
            <td bgcolor='yellow' class='bold text-center'>Lokasi</td>                
            <td bgcolor='yellow' class='bold text-center'>Kode Item</td>                
            <td bgcolor='yellow' class='bold text-center'>Deskripsi</td>                
          ...
          $sql = $this->db->query("SELECT *,tr_scan_barcode.no_mesin AS nosin, tr_penerimaan_unit_dealer.tgl_penerimaan as tgl_penerimaan_dealer FROM tr_penerimaan_unit_dealer_detail INNER JOIN tr_penerimaan_unit_dealer 
...
function getReport(){
  ...
  if (value.tanggal2 == '' && value.tanggal3 == '') {
    ...
    $('.loader').show();
    $('#btnShow').disabled;
    $("#showReport").attr("src",'<?php echo site_url("dealer/rekap_penerimaan_frame?") ?>cetak='+value.cetak+'&tanggal2='+value.tanggal2+'&tanggal3='+value.tanggal3);
