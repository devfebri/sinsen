      ...
      <script>
        function getReport(tipe) {
          ...
          if (value.end_date == '' || value.start_date == '' || value.id_dealer == '') {
            ...
            $('.loader').show();
            $('#btnShow').disabled;
            $("#showReport").attr("src", '<?php echo site_url("dealer/laporan_part_apparel_dealer?") ?>cetak=' + value.cetak + '&params=' + values);
...
?>
  ...
  <body>
    ...
    <div style="text-align: center;font-size: 11pt"><b>LAPORAN PART APPAREL</b></div>
    <br>
    <br>
