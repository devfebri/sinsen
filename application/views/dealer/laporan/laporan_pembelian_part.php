  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="">H3</li>
        <li class="">Laporan Pembelian Part </li>
  ...
  <body>
    ...
    <table class="table table-bordered" border=1>
      ...
      foreach ($details as $rows) {
          $sum_harga[]=intval($rows->harga);
          $sum_total[]=intval($rows->total);
      ?>
        <tr>
          <td style="text-align:center;" width="30px"><?= $no ?></td>
          <td style="text-align:center;"><?= date_dmy(substr($rows->tanggal_receipt,0,10)) ?></td>
          <td style="text-align:left;"><?= $rows->id_reference ?></td>
          <td style="text-align:left;"><?= $rows->id_part ?></td>
          <td style="text-align:left;"><?= $rows->nama_part ?></td>
          <td style="text-align:center;"><?= $rows->qty ?></td>
          <td style="text-align:right;"><?= mata_uang_rp($rows->harga)?></td>
          <td style="text-align:right;"><?= mata_uang_rp($rows->total)?></td>
        </tr>
      <?php $no++;
      } ?>
     <tr>
         <th colspan="6" style="text-align:right">
          ...
          <th style="text-align:right;"><?=mata_uang_rp(array_sum($sum_harga))?></th>
