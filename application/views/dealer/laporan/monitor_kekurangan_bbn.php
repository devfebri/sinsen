  ...
  <section class="content">
    ...
    <div class="box box-default">
      <div class="box-header with-border">              
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="dealer/monitor_kekurangan_bbn/export_xls" id="frm" method="post" enctype="multipart/form-data">
              <div class="box-body">                                                              
...
<script>
    function getReport()
    {
      ...
      if (value.cetak == '') {
        ...
        $('.loader').show();
        $('#btnShow').disabled;
        $("#showReport").attr("src",'<?php echo site_url("dealer/monitor_kekurangan_bbn?") ?>cetak='+value.cetak);
