...
?>
  ...
  <body>
    <table>
      <tr>
        <td colspan="19"><?= kop_surat_dealer($this->m_admin->cari_dealer()); ?></td>
      </tr>
    </table>
    ...
    <table class="table table-bordered" border=1>
      ...
      $id = $this->db->query("select a.id_dealer,b.id_karyawan_dealer,c.id_user from ms_dealer a join ms_karyawan_dealer b on a.id_dealer=b.id_dealer 
      join ms_user c on c.id_karyawan_dealer=b.id_karyawan_dealer where c.id_user='{$_SESSION['id_user']}'")->row()->id_dealer;
    ...
    <table>
        ...
        <tr>
            <th style="text-align: right;font-size: 11pt;font-weight:normal">&nbsp;b.</th>
          <th style="text-align: left;font-size: 11pt;font-weight:normal" colspan="3">Oli</th>
            <th style="text-align: right;font-size: 11pt;font-weight:normal">:</th>
        ...
        <tr>
         ...
         <tr>
          ...
          <tr>
            ...
            <th style="text-align: left;font-size: 11pt;font-weight:normal" colspan="3"><b>Total</b></th>
            <th style="text-align: right;font-size: 11pt;font-weight:normal">:</th>
            <th style="text-align: right;font-size: 11pt;font-weight:normal" colspan="3"> <b style="margin-left:55px;"><?=number_format(($part_wo->spart + $part_wo->oil + $part_wo->oil_kpb + $part_wo->busi + $part_wo->tire + $part_wo->belt + $part_wo->battery + $part_wo->brake + $part_wo->other),0,',','.')?></b></th>
            <th style="text-align: right;font-size: 11pt;font-weight:normal"></th>
            <th colspan="2"></th>
            <th style="text-align: left;font-size: 11pt;font-weight:normal"></th>
            <th style="text-align: left;font-size: 11pt;padding-left:35px;font-weight:normal" colspan="3" >&nbsp;</th>
