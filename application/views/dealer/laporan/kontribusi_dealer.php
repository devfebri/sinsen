  ...
  <section class="content">
    ...
    <body>
      <table>
        ...
        <div style="text-align: center;font-size: 13pt"><b>Kontribusi Dealer</b></div>        
        ...
        <table class='table table-bordered' style='font-size: 9pt' width='100%'>
          <tr>                
            <td bgcolor='yellow' class='bold text-center' width='25%' rowspan="2">Jenis Motor</td>
          ...
          <?php   
          $gtotal=0;        
          $sql = $this->db->query("SELECT * FROM ms_segment");
            ...
            <tr>
              ...
              for ($i=1; $i <= 31; $i++) { 
                ...
                $cek_so2 = $this->db->query("SELECT COUNT(tr_sales_order.no_mesin) AS jum FROM tr_sales_order 
                  ...
                  WHERE LEFT(tr_sales_order.tgl_create_ssu,10) = '$tgl_surat_1' AND tr_sales_order.id_dealer = '$id_dealer'
                  AND ms_segment.id_segment = '$isi->id_segment'")->row()->jum;
          ...
          ?>
          <tr>
            <td bgcolor='yellow' class='bold text-center'>All Type</td>            
            <?php 
            $total=0;
            for ($i=1; $i <= 31; $i++) { 
              $bln = sprintf("%'.02d",$bulan);                                                                     
...
<script>
    function getReport()
    {
      ...
      if (value.tipe == '') {
        ...
        $('.loader').show();
        $('#btnShow').disabled;
        $("#showReport").attr("src",'<?php echo site_url("dealer/kontribusi_dealer?") ?>cetak='+value.cetak+'&tahun='+value.tahun+'&bulan='+value.bulan);
