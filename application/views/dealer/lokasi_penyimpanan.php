  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">
          <a href="dealer/lokasi_penyimpanan">
      ...
      <div class="box-body">
        ...
        <div id="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="dealer/lokasi_penyimpanan/save" method="post" enctype="multipart/form-data">
              <div class="box-body">                              
                ...
                <div class="form-group">                  
                  ...
                  <div class="col-sm-1">
                    <a href='dealer/lokasi_penyimpanan/gudang?id=<?php echo $_GET['id'] ?>' class="btn btn-flat btn-primary"><i class='fa fa-plus'></i> Gudang</a>
                  </div>
                  <span id="scan_nosin">
                    <label for="inputEmail3" class="col-sm-2 control-label">No Mesin</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="no_mesin" placeholder="No Mesin" name="no_mesin">                    
                    </div>
                    <div class="col-sm-1">
    ...
    <?php 
      ...
      $ksu = $this->db->query("SELECT * FROM tr_surat_jalan INNER JOIN tr_sppm ON tr_surat_jalan.no_surat_sppm = tr_sppm.no_surat_sppm         
        INNER JOIN tr_do_po ON tr_sppm.no_do = tr_sppm.no_do
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div id="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="dealer/lokasi_penyimpanan/save_ksu" method="post" enctype="multipart/form-data">
              <div class="box-body">              
                <div class="form-group">
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">
          ...
          <a href="dealer/lokasi_penyimpanan">
          <?php }else{ ?>
          <a href="dealer/lokasi_penyimpanan/history">
          <?php } ?>
            <button class="btn bg-maroon btn-flat margin"><i class="fa fa-chevron-left"></i> Kembali</button>
          </a>          
        </h3>
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          foreach($dt_sj->result() as $row) {     
            if($row->status == 'proses'){
              ...
              $tombol = "
                <a href=\"dealer/lokasi_penyimpanan/close?id=$row->id_surat_jalan\" onclick=\"return confirm('Are you sure to close this data?')\">
                  <button class=\"btn btn-flat btn-xs btn-danger\"><i class=\"fa fa-close\"></i> Close</button>
                </a>                
                <a href=\"dealer/lokasi_penyimpanan/unit?id=$row->id_surat_jalan\">
                  <button class=\"btn btn-flat btn-xs btn-success\"><i class=\"fa fa-check\"></i> Konfirmasi PU</button>
                </a>                
                <a href=\"dealer/lokasi_penyimpanan/ksu?id=$row->id_surat_jalan\">
            ...
            <tr>
              <td>$no</td>
              <td>
                <a href='dealer/lokasi_penyimpanan/view?id=$id_penerimaan_unit_dealer&p=n'>
                  $id_penerimaan_unit_dealer
                </a>
              </td>              
      ...
      <div class="box-body">
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          foreach($dt_sj->result() as $row) {     
            ...
            $tombol = "                                
              <a href='dealer/lokasi_penyimpanan/view?id=$id_penerimaan_unit_dealer'>
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div class="alert alert-<?php echo $_SESSION['tipe'] ?> alert-dismissable">
            <strong><?php echo $_SESSION['pesan'] ?></strong>
            <button class="clos e" data-dismiss="alert">
                <span aria-hidden="true">&times;</span>
                <span class="sr-only">Close</span>  
            </button>
        </div>
        ...
        <div id="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="dealer/lokasi_penyimpanan/gudang_save" method="post" enctype="multipart/form-data">
              <div class="box-body">              
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" required class="form-control" name="kode_gudang" placeholder="Otomatis" readonly>                    
                  </div>
                  <label for="inputEmail3" class="col-sm-2 control-label">Kode Rak</label>
                  <div class="col-sm-4">
                    <input type="text" required class="form-control" name="kode_rak" placeholder="Kode Rak">                    
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Kode Bin</label>
                  <div class="col-sm-4">
                    <input type="text" required class="form-control" name="kode_bin" placeholder="Kode Bin">                    
                  </div>
                </div>
                <div class="form-group">
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          foreach($dt_gudang->result() as $row) {               
            ...
            <tr>
              ...
              <td>";
              ?>
                <a data-toggle='tooltip' <?php echo $this->m_admin->set_tombol($id_menu,$group,"delete"); ?> title="Delete Data" onclick="return confirm('Are you sure to delete this data?')" class="btn btn-danger btn-sm btn-flat" href="dealer/lokasi_penyimpanan/gudang_delete?id=&idg=<?php echo $row->id_gudang_dealer ?>"><i class="fa fa-trash-o"></i></a>
                <a data-toggle='tooltip' <?php echo $this->m_admin->set_tombol($id_menu,$group,"edit"); ?> title="Edit Data" class='btn btn-primary btn-sm btn-flat' href='dealer/lokasi_penyimpanan/gudang_edit?id=&idg=<?php echo $row->id_gudang_dealer ?>'><i class='fa fa-edit'></i></a>
              </td>
            </tr>
          <?php
          $no++;
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div id="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="dealer/lokasi_penyimpanan/gudang_update" method="post" enctype="multipart/form-data">
              <div class="box-body">              
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select name="jenis" class="form-control select2">
                        ...
                        <option value="POS" <?php if($row->jenis=='POS'){ echo "selected"; } ?>> POS</option>
                        <option value="Dealer" <?php if($row->jenis=='Dealer'){ echo "selected"; } ?> > Dealer</option>
                    </select>
                  </div>
                </div>  
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Kode Gudang</label>
                  <div class="col-sm-4">
                    <input type="text" required class="form-control" name="kode_gudang" placeholder="Kode Gudang" value="<?php echo $row->kode_gudang ?>" readonly>                    
                  </div>
                  <label for="inputEmail3" class="col-sm-2 control-label">Kode Rak</label>
                  <div class="col-sm-4">
                    <input type="text" required class="form-control" name="kode_rak" placeholder="Kode Rak"value="<?php echo $row->kode_rak ?>">                    
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Kode Bin</label>
                  <div class="col-sm-4">
                    <input type="text" required class="form-control" name="kode_bin" placeholder="Kode Bin" value="<?php echo $row->kode_bin ?>">                    
                  </div>
                </div>       
                <div class="form-group">
                  <label for="field-1" class="col-sm-2 control-label"></label>            
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          foreach($dt_gudang->result() as $row) {               
            ...
            <tr>
              ...
              "; ?>            
              <td>                                
                <a data-toggle='tooltip' <?php echo $this->m_admin->set_tombol($id_menu,$group,"delete"); ?> title="Delete Data" onclick="return confirm('Are you sure to delete this data?')" class="btn btn-danger btn-sm btn-flat" href="dealer/lokasi_penyimpanan/gudang_delete?id=<?php echo $_GET['id'] ?>&idg=<?php echo $row->id_gudang_dealer ?>"><i class="fa fa-trash-o"></i></a>
                <a data-toggle='tooltip' <?php echo $this->m_admin->set_tombol($id_menu,$group,"edit"); ?> title="Edit Data" class='btn btn-primary btn-sm btn-flat' href='dealer/lokasi_penyimpanan/gudang_edit?id=<?php echo $_GET['id'] ?>&idg=<?php echo $row->id_gudang_dealer ?>'><i class='fa fa-edit'></i></a>
              </td>
            </tr>
          <?php
          $no++;
...
function auto(){  
  ...
  $.ajax({
      url : "<?php echo site_url('dealer/lokasi_penyimpanan/cari_id')?>",
      type:"POST",
      data:"no_sj="+no_sj,   
      cache:false,   
...
function kirim_data(){    
  ...
  if (window.XMLHttpRequest) { // Mozilla, Safari, ...
   ...
   //var data = "birthday1="+birthday1_js;          
    var data = "id_pu="+id_pu+"&jenis_pu="+jenis_pu+"&no_sj="+no_sj;                           
     xhr.open("POST", "dealer/lokasi_penyimpanan/t_data", true); 
...
function simpan_nosin(){
  ...
  if (id_pu == "" || no_mesin == "") {    
      ...
      $.ajax({
          url : "<?php echo site_url('dealer/lokasi_penyimpanan/save_nosin')?>",
          type:"POST",
          data:"no_mesin="+no_mesin+"&id_pu="+id_pu+"&jenis_pu="+jenis_pu,
          cache:false,
          success:function(msg){            
              data=msg.split("|");
              if(data[0]=="ok"){
...
function hapus_data(a,b,c){ 
    ...
    var mode      = c;       
    $.ajax({
        url : "<?php echo site_url('dealer/lokasi_penyimpanan/delete_data')?>",
        type:"POST",
...
function hapus_auto(a){
  var id_p = a;
  $.ajax({
      url : "<?php echo site_url('dealer/lokasi_penyimpanan/hapus_auto')?>",
      type:"POST",
      data:"id_p="+id_p,   
      cache:false,   
      success: function(msg){ 
