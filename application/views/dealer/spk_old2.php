            ...
            <form id="form_" class="form-horizontal" action="dealer/spk/save" method="post" enctype="multipart/form-data">
              <div class="box-body">              
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">                    
                    <input type="text" onchange="cek_tanya2()" class="form-control" name="id_customer" onpaste="return false;" onkeypress="return false;" id="id_customer" placeholder="ID Customer" required>                                                    
                  </div>
                  <div class="col-sm-4">                                        
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="number" class="form-control" placeholder="Total Penghasilan" name="penghasilan">                    
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-1">
                    <button type="button" data-toggle="modal" data-target="#Robdmodal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-search"></i> Browse</button>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <div class="col-md-12">
                    ...
                    <tr>
                      <td>
                        <select name="id_event" id="id_event" onchange="getEvent()" class="form-control select2" <?= $disabled ?>>
                          <option value="">--choose-</option>
                ...
                <span id="lbl_kredit" v-if="tipe_pembelian=='Kredit'">                                                      
                  ...
                  <div class="form-group">                  
                    ...
                    <div class="col-sm-3">                    
                      <input type="text" class="form-control" placeholder="Tenor" name="tenor" id="tenor" v-model="tenor" readonly required>
                    </div>                                  
                    <div class="col-sm-1">                    
                      Bulan
                    </div>             
...
<div class="form-group">
  <label for="inputEmail3" class="col-sm-2 control-label">No. KK *</label>
  <div class="col-sm-4">
     <input type="text" id="no_kk" class="form-control" maxlength="16" onkeypress="return number_only(event)" placeholder="No KK" name="no_kk" required>
  </div>          
            ...
            <form class="form-horizontal" action="dealer/spk/update_gc" method="post" enctype="multipart/form-data">
              <div class="box-body">              
                ...
                <div class="form-group">
                  ...
                  <label for="inputEmail3" class="col-sm-2 control-label">Nama BPKB/STNK</label>
                  <div class="col-sm-4">                    
                    <input type="text" class="form-control" placeholder="Nama BPKB/STNK" id="nama_bpkb" value="<?php echo $row->nama_bpkb ?>" name="nama_bpkb">                                        
                  </div>
                </div>                
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Apakah alamat domisili sama dengan alamat di NPWP? *</label>
                ...
                <span id="tampil_alamat">
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <?php
                      $id_kelurahan="";$kelurahan="";$id_kecamatan="";$kecamatan="";$id_kabupaten="";$kabupaten="";$id_provinsi="";$provinsi="";
              ...
              <div class="box-body">              
                ...
                <span id="lbl_kredit">                                                      
                  ...
                  <div class="form-group">                  
                    <label for="inputEmail3" class="col-sm-2 control-label">No KTP *</label>
                    <div class="col-sm-4">                    
                      <input type="text" class="form-control" maxlength="16" placeholder="No KTP Penjamin" name="no_ktp_penjamin" required minlength="16" maxlength="16" onkeypress="return number_only(event)"> 
                    </div>   
                    <label for="inputEmail3" class="col-sm-2 control-label">Tenor</label>
                    <div class="col-sm-3">                    
                      <input type="text" class="form-control" placeholder="Tenor" name="tenor" required> 
                    </div>                                  
                    <div class="col-sm-1">                    
                      Bulan
                    </div>             
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">                  
                  ...
                  <div class="col-sm-4">                    
                    ...
                    <select class="form-control" name="id_tipe_kendaraan" id="id_tipe_kendaraan" onchange="take_harga();getWarna();" required <?= $readonly ?>>
                      <?php $t = $this->m_admin->getByID("ms_tipe_kendaraan","id_tipe_kendaraan",$row->id_tipe_kendaraan)->row(); ?>
                 <!--      <option value="<?php echo $row->id_tipe_kendaraan ?>"><?php echo $row->id_tipe_kendaraan ?> | <?php echo $t->tipe_ahm ?></option> -->
                      <?php 
                      foreach($dt_tipe->result() as $val) {
                ...
                <div class="form-group">                  
                  ...
                  <div class="col-sm-4">                    
                    ...
                    <input type="text" class="form-control" value="Rp. <?php echo mata_uang2($row->harga) ?>" placeholder="Harga" readonly name="harga_r" id="harga_r" <?= $readonly ?>>
                  </div>
                  <label for="inputEmail3" class="col-sm-2 control-label">PPN</label>
                  <div class="col-sm-4">                    
                    <input type="hidden" name="ppn" id="ppn" value="<?= $row->ppn ?>">                  
                    <input type="text" class="form-control" value="Rp. <?php echo mata_uang2($row->ppn) ?>" placeholder="PPN" readonly name="ppn_r" id="ppn_r" <?= $readonly ?>>                  
                  </div>
                </div>
                <div class="form-group">                  
                  <label for="inputEmail3" class="col-sm-2 control-label">Harga Off The Road</label>
                  <div class="col-sm-4">                    
                    <input type="hidden" name="harga_off" id="harga_off" value="<?php echo $row->harga_off_road ?>">
                    <input type="text" class="form-control" placeholder="Harga Off The Road" value="Rp. <?php echo mata_uang2($row->harga_off_road) ?>" readonly name="harga_off_r" id="harga_off_r" <?= $readonly ?>>
                  </div>
                  <label for="inputEmail3" class="col-sm-2 control-label">Biaya BBN</label>
                  <div class="col-sm-4">                    
                    <input type="hidden" name="biaya_bbn" id="biaya_bbn" value="<?php echo $row->biaya_bbn ?>">                  
                    <input type="text" class="form-control" placeholder="Biaya BBN" value="Rp. <?php echo mata_uang2($row->biaya_bbn) ?>" readonly name="biaya_bbn_r" id="biaya_bbn_r" <?= $readonly ?>>                  
                  </div>
                </div>
                <div class="form-group">                  
                  <label for="inputEmail3" class="col-sm-2 control-label">Harga On The Road</label>
                  <div class="col-sm-4">                    
                    <input type="hidden" name="harga_on" id="harga_on" value="<?php echo $row->harga_on_road ?>">
                    <input type="text" class="form-control" placeholder="Harga On The Road" value="Rp. <?php echo mata_uang2($row->harga_on_road) ?>" readonly name="harga_on_r" id="harga_on_r" <?= $readonly ?>>
                  </div>
                  <label for="inputEmail3" class="  col-sm-2 control-label">Diskon</label>
                  <div class="col-sm-4">                    
                    <input type="text" class="form-control" readonly name="diskon" id="diskon" value="<?= $row->diskon ?>" <?= $readonly ?>>
                  </div>
                </div>
                 <div class="form-group">                  
                  <label for="inputEmail3" class="col-md-offset-6 col-sm-2 control-label">Tanda Jadi *</label>
                ...
                <span id="lbl_cash" v-if="tipe_pembelian=='Cash'">
                  ...
                  <div class="form-group">                  
                    ...
                    <div class="col-sm-4">                    
                      <select class="form-control" name="program_umum" onchange="cek_program_tambahan()" id="program_umum" <?= $readonly ?>>
                        <!-- <option><?php echo $row->program_khusus_1 ?></option>
                        <?php 
                        // $tgl = date("Y-m-d");
                        // $cek = $this->db->query("SELECT * FROM tr_sales_program WHERE '$tgl' BETWEEN periode_awal AND periode_akhir AND (jenis_bayar = 'Cash' OR jenis_bayar = 'Cash & Kredit')");
                        // foreach ($cek->result() as $isi) {
                  ...
                  <div class="form-group">                  
                    ...
                    <div class="col-sm-4">                    
                      <input type="hidden" id="total_bayar" name="total_bayar" value="<?php echo $row->total_bayar ?>" >
                      <input type="text" value="Rp. <?php echo mata_uang2($row->total_bayar) ?>"  class="form-control" id="total_bayar_r" readonly placeholder="Total Bayar" name="total_bayar_r" <?= $readonly ?>>
                    </div>                  
                  </div>  
                </span>
                <span id="lbl_kredit" v-if="tipe_pembelian=='Kredit'">                                                      
                  ...
                  <div class="form-group">                  
                    ...
                    <label for="inputEmail3" class="col-sm-2 control-label">Tenor *</label>
                    <div class="col-sm-3">                    
                      <input type="text" class="form-control" placeholder="Tenor" value="<?php echo $row->tenor ?>" name="tenor" readonly required>
                    </div>                                  
                    <div class="col-sm-1">                    
                      Bulan
                    </div>
                  ...
                  <div class="form-group">                  
                    <label for="inputEmail3" class="col-sm-2 control-label">No KTP *</label>
                    <div class="col-sm-4">                    
                      <input type="text" class="form-control" maxlength="16" value="<?php echo $row->no_ktp_penjamin ?>" placeholder="No KTP Penjamin" name="no_ktp_penjamin" required minlength="16" maxlength="16" onkeypress="return number_only(event)" <?= $readonly ?>>
                    </div>                                      
                    <label for="inputEmail3" class="col-sm-2 control-label">Angsuran *</label>
                    <div class="col-sm-4">
...
<div class="form-group">
  <label for="inputEmail3" class="col-sm-2 control-label">No. KK *</label>
  <div class="col-sm-4">
     <input type="text" id="no_kk" class="form-control" maxlength="16" onkeypress="return number_only(event)" placeholder="No KK" name="no_kk" value="<?= $row->no_kk ?>" required <?= $readonly ?>>
  </div>          
  <label for="inputEmail3" class="col-sm-2 control-label">Alamat Kartu Keluarga *</label>
  <div class="col-sm-4">
...
<div class="form-group">
  <div class="col-sm-4">
    <table class="table">
      <tr><td></td><td><b>List Anggota</b></td><td></td></tr>
      <tr v-for="(agt, index) of anggota_">
        <td>{{index+1}}. </td><td><input type="text" name="anggota_kk[]" class="form-control"  <?= $readonly ?> v-model="agt.anggota"></td>
        <td>
      ...
      <tr v-for="(fl, index) of file_pendukung_">
        ...
        <td align="right" v-if="readonly==''"> <button type="button" @click.prevent="delFile(index)" class="btn btn-sm btn-danger btn-flat"><i class="fa fa-trash"></i></button></td>
              ...
              <div class="box-footer">
                ...
                <div class="col-sm-10" v-if="readonly==''">
      ...
      <div class="box-body">
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          foreach($dt_spk->result() as $row) {     
            ...
            $status ='';$tombol_cetak='';$tombol='';$tombol2='';$tombol3='';$tombol4='';$tombol5=''; 
            ...
            if($row->status_spk =='input'){
              ...
              $tombol3 = "<a data-toggle='tooltip' $edit title='Edit' href='dealer/spk/edit?id=$row->no_spk'><button class='btn btn-flat btn-xs btn-primary'><i class='fa fa-edit'></i> Edit</button></a>";
              $tombol4='';
              ...
              $tombol3 = "<a data-toggle='tooltip' $edit title='Edit' href='dealer/spk/edit?id=$row->no_spk'><button class='btn btn-flat btn-xs btn-primary'><i class='fa fa-edit'></i> Edit</button></a>";
              $tombol4='';
              // $tombol5 = '<a class="btn btn-danger btn-xs" onclick="return closePrompt(\''.$row->no_spk.'\')"><i class=\'fa fa-close\'></i> Cancel</a>';
               $tombol5 = "<a data-toggle='tooltip' title='Cancel' class='btn btn-danger btn-xs btn-flat' href='dealer/spk/cancel?id=$row->no_spk'><i class='fa fa-close'></i> Cancel</a>";
              $tombol_cetak="";
            }elseif($row->status_spk =='rejected'){
              $status = "<span class='label label-danger'>$row->status_spk</span>";
              $tombol = "";$tombol2 = "";$tombol3 = "";$tombol4 = "";$tombol_cetak='';$tombol5='';
            }elseif($row->status_spk =='approved'){
              $status = "<span class='label label-success'>$row->status_spk</span>";
              $tombol = "";$tombol2 = "";$tombol3 = "<a $edit data-toggle='tooltip' title='Edit' href='dealer/spk/edit?id=$row->no_spk'><button $edit class='btn btn-flat btn-xs btn-primary'><i class='fa fa-edit'></i> Edit</button></a>";$tombol4 = "";
              ...
              // $tombol5 = "<a data-toggle='tooltip' onclick=\"return confirm('Are you sure to close this data?')\" title='Close' class='btn btn-danger btn-xs btn-flat' href='dealer/spk/close?id=$row->no_spk'><i class='fa fa-close'></i> Close</a>";
                // $tombol5 = '<button class="btn btn-danger btn-xs" onclick="return closePrompt(\''.$row->no_spk.'\')"><i class=\'fa fa-close\'></i> Cancel</button>';
                $tombol5 = "<a data-toggle='tooltip' title='Cancel' class='btn btn-danger btn-xs btn-flat' href='dealer/spk/cancel?id=$row->no_spk'><i class='fa fa-close'></i> Cancel</a>";
              ...
              $status = "";
              $tombol = "";$tombol2 = "";$tombol3 = "";$tombol4 = "";$tombol5="";
              $tombol_cetak='';
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          foreach($dt_spk->result() as $row) {     
            ...
            if($row->status =='input'){
              ...
              $tombol = "";$tombol2 = "";$tombol3 = "<a href='dealer/spk/edit_gc?id_c=$row->no_spk_gc' data-toggle='tooltip' $edit title='Edit'><button class='btn btn-flat btn-xs btn-primary'><i class='fa fa-edit'></i> Edit</button></a>";
              $tombol4 = "";
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          foreach($dt_spk->result() as $row) {     
            ...
            <tr>
              ...
              <td>$war</td>            
              <td>$row->no_ktp</td>                       
              <td><a  data-toggle='tooltip' title='Cetak' href='dealer/spk/cetak?id=$row->no_spk'>
                  <button $print class='btn btn-flat btn-xs btn-warning'><i class='fa fa-print'></i> Cetak SPK</button>
                </a></td>
            </tr>";          
            $no++;
