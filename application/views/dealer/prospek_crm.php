...
<?php if (isset($_GET['id'])) { ?>
  ...
  <?php  } else { ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          ?>
            ...
            <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title">
                  ...
                  if (in_array($this->m_admin->cari_dealer(), $myArrayDealer)) { 
                    if ($button_lead !=='sales' ){?>
                        <button class="btn btn-maroon btn-flat margin"  onclick="showModalUploadToApi2()"><i class="fa fa-upload"></i> Upload Leads</button>
                    <?}
                    ?>
                    <button class="btn btn-success btn-flat margin" onclick="showModalExportLeads()" ><i class="fa fa-download"></i> Export Leads</button>
              ...
              <div class="box-body">
                ...
                <table class='table table-condensed table-bordered table-striped serverside-tables' style="width:100%">
                  <thead>
                    <th width='10px'>#</th>
                    <th width='10%'>ID Prospek</th>
                    <!-- <th width='15%'>ID List Appoinment</th> -->
                    <th width='8%'>Leads ID</th>
                    <th width='8%'>Nama Konsumen</th>
                    <th>Nama Sales</th>
                    <th>Tgl. Dispatch</th>
                    <th  width='7%'>No Hp</th>
                    <!-- <th title="(Tipe Kendaraan, Warna)">Keterangan </th> -->
                    <th>Platform Data</th>
                    <th>Source Leads</th>
            ...
            <div class="modal fade" id="modalExportLeads">
            <div class="modal-dialog" style='width:40%'>
              <div class="modal-content">
                <div class="modal-header bg-red disabled color-palette">
                  <button style='color:white' type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title" align='center'>Export Leads</h4>
                </div>
                <div class="modal-body">

                <form  action="/dealer/prospek_crm/export_leads_set" class='form-horizontal'  method="post">
                    <div class="form-group">
                  ...
                  <div class="modal-footer">
                    <div class="row">
                      <div class="col-sm-12 col-md-12" align='center'>
                        <button type="button" class="btn btn-default btn-flat"><i class='fa fa-times'></i> Cancel</button>
                        <button type="submit" class="btn btn-info btn-flat"><i class='fa fa-search'></i> Download Excel</button>
                      </div>
                    </form>
                  </div>
                </div>
            ...
            <div class="modal-dialog" style='width:40%'>
              <div class="modal-content">
                <div class="modal-header bg-red disabled color-palette">
                  <button style='color:white' type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title" align='center'>Upload Leads</h4>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                  <div class="row">
                    ...
                    <?php
                      ...
                      // $myArrayDealer = array(103,4,77,47,46);  
                      // $myArrayDealer = array(70,101,1,98,80,22,51,18,4,2,82,105,85,39,104,13,96,86,25,46,47,4,103,78,77);
	                  	$myArrayDealer = array(1,2,3,4,8,13,18,22,25,37,39,40,41,43,44,45,46,47,51,65,66,70,71,74,77,78,80,81,82,83,84,85,86,90,93,94,95,96,97,98,100,101,102,103,104,105,106,107);
                      if (in_array($this->m_admin->cari_dealer(), $myArrayDealer)) { 
                        ?>
                        <a href="<?=base_url('./downloads/crm/new_template_upload_leads.xlsx') ?>" class="btn btn-success btn-flat">Template Upload</a>
                    <?php } ?>
                  ...
                  Swal.fire({
                    ...
                    if (result.isConfirmed) {
                      ...
                      $.ajax({
                        ...
                        enctype: 'multipart/form-data',
                        url: "<?php   echo site_url('dealer/prospek_crm/upload_to_api2')?>",
                        type: "POST",
                        data: values,
                        processData: false,
                        contentType: false,
                ...
                var dataTable = $('.serverside-tables').DataTable({
                  ...
                  "ajax": {
                    ...
                    data: function(d) {
                      ...
                      d.belum_assign_sales_people = $('#belum_assign_sales_people').val()
    ...
    function showModalUploadToApi2() {
      Swal.fire(
        'Template Leads',
        'Mohon untuk dapat mengunakan template terbaru (template upload)',
        'info'
      );
...
<script>
    function showModalExportLeads() {
      $('#modalExportLeads').modal('show');
     }
     </script>