...
<?php if (isset($_GET['id'])) { ?>
  ...
  <?php } elseif (isset($_GET['id_c'])) { ?>
    ...
    <?php } else { ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          ?>
                    ...
                    <form class="form-horizontal" action="dealer/sales_order/save" method="post" enctype="multipart/form-data">
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <select class="form-control select2 set_no_spk_ev" name="no_spk" required id="no_spk">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            ...
                            <div class="is-ev">
                            <label for="inputEmail3" class="col-sm-2 control-label">Battery EV (Serial Number) </label>
                              <div class="col-sm-4">
                                <input readonly='readonly' type='text' class='form-control serial_number_set_input'  name='serial_number[serial_number][]' value="" readonly> 
                              </div>
                              <span id="add_ev_acc" class='add_ev_acc'></span>
                              <div class="col-sm-1">
                                  <button class="btn btn-primary btn-flat btn-sm" data-toggle="modal"  type="button" id="browseEV" ><i class="fa fa-search"></i> Browse</button>
                              </div>
                          </div>
            ...
            <div class="modal fade" id="EvAccModal">
      ...
      <script>
        function chooseEV(serial_number) {
          $.ajax({
            url: "<?php echo site_url('dealer/sales_order/cek_ev_acc') ?>",
            type: "POST",
            data: {
            ...
            success: function(response) {
              ...
              if (data.status === 'success') {
                ...
                $(".serial_number_set_input").val(responseData.serial_number);
                $("#EvAccModal").modal('hide');
                Swal.fire({
                        icon: 'success',
                        title: 'Serial Number : '+responseData.serial_number+' Berhasil Di Pilih',
      ...
      $(document).ready(function() {
        $(".is-ev").hide();
        $("#browseEV").on("click", function () {
          var no_spk = $(".set_no_spk_ev").val();
                $.ajax({
                  beforeSend: function() {
                      // $('#loading-status').show() 
                      // $("#browseEV").attr('disabled', true);
                      // $("#browseEV").html('<i class="fa fa-spinner fa-spin"></i> Process');
                    },
                    url: "<?php echo site_url('dealer/sales_order/browse_serial_number_ev') ?>",
                    type: "POST",
                    data: {
                    no_spk: no_spk
                  },
                    success: function (data) {
                      $('#showBrowseEv').html(data);
                      $("#EvAccModal").modal('show');
                    },
                    error: function () {
                ...
                <table id="example4" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    foreach ($dt_sales_order->result() as $row) {
                      ...
                      <a href='dealer/sales_order/cetak_barcode_gc_v2?id=$row->id_sales_order_gc' target='_blank' >
                      <button $print class='btn btn-flat btn-xs btn-warning'><i class='fa fa-print'></i> Cetak Barcode AHASS V2</button>
                      </a>";
                  ...
                  <div class="modal-body" id="show_detail">
                    <form class="form-horizontal" method="GET" action="dealer/sales_order/bastk" id="form_">
                        ...
                        <span id="dikirim">
                          <div class="col-sm-6">
                            ...
                            <select class="form-control" name="id_master_plat" id="id_master_plat" required>
                              <?php
                              $id_dealer = $this->m_admin->cari_dealer();
                              $driver = $this->db->query("SELECT * FROM ms_plat_dealer WHERE id_dealer ='$id_dealer' and active = 1");
                              if ($driver->num_rows() > 0) {
                                foreach ($driver->result() as $dr) {
                                  echo "<option value='$dr->id_master_plat'>$dr->no_plat | $dr->driver </option>";
                                }
                      ...
                      <div class="form-group">
                        ...
                        <?php 
                        $id_dealer = $this->m_admin->cari_dealer();
                        // $no_nsc = $this->db->query("SELECT * from tr_h3_serial_ev_tracking evh3  left join tr_sales_order so on so.no_mesin = evh3.no_mesin WHERE so.id_sales_order ='' ");

                        if ($id_dealer == '103'){?>
                        <!-- <div class="col-sm-5">
                          <label>Kelengkapa EV (NSC)</label>
                          <input type="text" name="nsc" class="form-control" id="nsc" autocomplete="off" required readonly>
			...
			<!--
                      <div class="form-group">
                        <div class="col-sm-6">
                          ...
                          <input type="text" name="lat123" class="form-control" id="lat123" autocomplete="off" required>
                        </div>
                        <div class="col-sm-6">
                          <label>Longitude</label>
                          <input type="text" name="lot123" class="form-control" id="lot123" autocomplete="off" required>
                        </div>
                      </div>
			-->
                      <div class="form-group">
                    ...
                    <form class="form-horizontal" action="dealer/sales_order/save" method="post" enctype="multipart/form-data">
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input class="form-control" readonly type="hidden" id="id_sales_order_set" value="<?php echo $konsumen ?>">
          ...
          <?php
                    ...
                    <form class="form-horizontal" method="post" action="dealer/sales_order/cetak_invoice" enctype="multipart/form-data">
                      ...
                      <div class="box-body">
                        ...
                        <?php  
                          ...
                          <div class="col-sm-4">
                            <input type="text" readonly class="form-control" autocomplete="off" value="<?= mata_uang_rp($row->subsidi_pemerintah) ?>">
                            </div>
                           </div>
                        <?}?>
                      ...
                      <div class="col-sm-12" align="center">
                          ...
                          <?php  
                          if ($is_ev == 1){ ?>
                          <a id="printLink" href="/dealer/sales_order/cetak_invoice_ev?id=<?=$row->id_sales_order?>" class="btn btn-primary btn-flat"><i class="fa fa-print"></i> (SISAPIRA) Faktur Penjualan </a>
                          <?}?>
                        </div>
                      </div>
                    </form>
            ...
            <script>
                $('#printLink').click(function(event) {
                  var test = <?=$row->no_invoice?>;
                  if(test !=NULL){
                    event.preventDefault(); 
                    Swal.fire({
                        icon: 'info',
                        title: 'Print Invoice terlebih dahulu',
                        confirmButtonText: 'OK'
                    });
                  }
                });
      ...
      <script type="text/javascript">
        ...
        function take_ev(data) {
          var tipe_kendaraan = data;
          $.ajax({
            url: "<?php echo site_url('dealer/sales_order/is_ev') ?>",
            type: "POST",
            data: "tipe_kendaraan=" + data,
            cache: false,
            success: function(response) {
        ...
        function get_ksu() {
          ...
          var id_sales_order_set = $("#id_sales_order_set").val();
          var mode = $("#mode").val();
          $.ajax({
            url: "<?php echo site_url('dealer/sales_order/get_ksu') ?>",
            type: "POST",
            data: "id_tipe_kendaraan=" + id_tipe_kendaraan + "&mode=" + mode + "&id_sales_order_set=" + id_sales_order_set,
            cache: false,
      ...
      <script type="text/javascript">
        ...
        function get_ev_serial_number(tipe_kendaraan){
          $.ajax({
            url: "<?php echo site_url('dealer/sales_order/get_ev_serial_number') ?>",
            type: "POST",
            data: "tipe_kendaraan=" + tipe_kendaraan,
            cache: false,
            success: function(response) {
              if (response == 1) {
              // Swal.fire({
              //           icon: 'info',
              //           title: 'Tipe Kendaraan EV | Mohon untuk pilih Serial Number Battery',
              //           confirmButtonText: 'OK'
              //       });

                $(".serial-is-ev").empty().append("<th>Serial Number</th>");
                $(".serial-is-ev-detail").empty().append("<input readonly type='text' autocomplete='off' name='serial_number_gc' class='form-control serial_number_gc' id='serial_number_gc' placeholder='Serial Number'>");
              } else {
          ...
          function get_serial_number_ev(data){
            $(".serial_number_gc").val(data);
        ...
        function addDetail_gc() {
          var no_mesin = $("#no_mesin_gc").val();
          var no_spk_gc = $("#no_spk_gc").val();
          var serial_number_gc = $("#serial_number_gc").val();

          $.ajax({
            url: "<?php echo site_url('dealer/sales_order/addDetail') ?>",
            type: "POST",
            data: "no_mesin=" + no_mesin + "&no_spk_gc=" + no_spk_gc + "&serial_number_gc=" + serial_number_gc,
            cache: false,
            success: function(data) {
              if (data == 'nihil') {
                tampil_nosin();
...
<script>
        function check_approve_reject(id_sales_order) {
            
              $('#check_aprrove_reject').click(function(){
              $.ajax({
                  beforeSend: function() {},
                  url: "<?php echo site_url('dealer/sales_order/check_approve_reject'); ?>",
                  type: "POST",
                  data: "id=" + id_sales_order,
                  cache: false,
                  dataType: 'JSON',
                  success: function(resp) {
                    ...
                    if(resp.status == 0){
                      alert('Mohon Periksa SPK Order/Hasil Approve');
                    };
