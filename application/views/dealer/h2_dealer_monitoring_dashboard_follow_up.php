            ...
            <div class="col-sm-2">
              <div class="small-box bg-olive">
                <div class="inner">
                  ...
                  <div style="font-weight:bold; font-size:20px; margin-top:-10px;"><?php echo $customer_reminder->row()->status_komunikasi ?></div>
              ...
              <div class="box-body chat" >
                ...
                <!-- <div class="row"  align="center">
                  <div class="col-sm-3" >
                    <div class="small-box bg-olive">
                      <div class="inner">
                        <div style="font-weight:bold; font-size:20px; margin-top:-10px;"><?php echo $persen_actual_customer .'%'?></div>
                        <p>Actual of Total Customer</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="small-box bg-olive">
                      <div class="inner">
                        <div style="font-weight:bold; font-size:20px; margin-top:-10px;"><?php echo $persen_actual_fu .'%'?></div>
                        <p>Actual of Follow Up</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="small-box bg-olive">
                      <div class="inner">
                        <div style="font-weight:bold; font-size:20px; margin-top:-10px;"><?php echo $persen_actual_contacted .'%'?></div>
                        <p>Actual of Contacted</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="small-box bg-olive">
                      <div class="inner">
                        <div style="font-weight:bold; font-size:20px; margin-top:-10px;"><?php echo $persen_actual_booking .'%'?></div>
                        <p>Actual of Booking Service</p>
                      </div>
                    </div>
                  </div>
                </div> -->
        ...
        <div class="row">
          ...
          <div class="col-md-4" id="divGrafikLeaderboard">
            <div class="box box-warning">
              <div class="box-header">
                <i class="fa fa-graphic"></i>
                <h3 class="login-box-msg" style="font-size: 16px;"><b>Grafik Leaderboard</b></h3>
                <!-- <div class="box-tools pull-right">
