...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    ?>
              ...
              <form class="form-horizontal" id="form_" action="dealer/invoice_pelunasan/<?= $form ?>" method="post" enctype="multipart/form-data">
                <div class="box-body">
                  <div class="form-group" v-if="mode=='detail'">
                    ...
                    <div class="col-sm-4">
                      <input type="text" required class="form-control" value="<?= isset($row) ? $row->id_inv_pelunasan : '' ?>" autocomplete="off" readonly>
                    </div>
                    <label for="inputEmail3" class="col-sm-2 control-label">Creation Date</label>
                    <div class="col-sm-4">
                      <input type="text" required class="form-control" value="<?= isset($row) ? $row->created_lunas_at : '' ?>" autocomplete="off" readonly>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" required class="form-control text-rata-kanan" :value="row.diskon | toCurrency" autocomplete="off" readonly>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Amount TJS</label>
                    <div class="col-sm-4">
                      <input type="text" required class="form-control text-rata-kanan" :value="row.tanda_jadi | toCurrency" autocomplete="off" readonly>
                    </div>
                    <label for="inputEmail3" class="col-sm-2 control-label">Amount DP</label>
                    <div class="col-sm-4">
                      <input type="text" required class="form-control text-rata-kanan" :value="row.amount_dp | toCurrency" autocomplete="off" readonly>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Total Harga</label>
                    <div class="col-sm-4">
                      <input type="text" required class="form-control text-rata-kanan" :value="row.total_bayar | toCurrency" autocomplete="off" readonly>
                    </div>
                    <label for="inputEmail3" class="col-sm-2 control-label">Sisa Pelunasan</label>
                    <div class="col-sm-4">
                      <input type="text" required class="form-control text-rata-kanan" :value="row.sisa_pelunasan | toCurrency" autocomplete="off" readonly>
                    </div>
                  </div>
      ...
      <?php
      $data['data'] = ['modalSO', 'id_inv_pelunasan_null', 'jenis_beli_cash', 'status_tjs_close'];
      ...
      <script>
        ...
        $('#submitBtn').click(function() {
          ...
          var values = {
            total_bayar: form_.row.total_bayar
          };
    ...
    ?>
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">
            <a href="dealer/invoice_pelunasan/add">
              <button class="btn bg-blue btn-flat margin"><i class="fa fa-plus"></i> Add New</button>
            </a>
            <a href="dealer/invoice_pelunasan/history">
      ...
      <script>
        $(document).ready(function() {
          var dataTable = $('#datatable_server').DataTable({
            ...
            "ajax": {
              url: "<?php echo site_url('dealer/invoice_pelunasan/fetch'); ?>",
              type: "POST",
              dataSrc: "data",
              data: function(d) {
                d.status_in = "'input'";
