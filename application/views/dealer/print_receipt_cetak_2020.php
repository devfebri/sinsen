...
<body>
  ...
  ?>
      ...
      <tr>
        ...
        if (!in_array($id_dealer, $skip_dealer)) { ?>
          <td width='65%' style='vertical-align:top'>
            ...
            <span style='font-size:9pt'><?= $dealer->alamat ?><br> TELP. <?= $dealer->no_telp ?> <?php if($dealer->fax!=''){ echo "FAX. ". $dealer->fax; } ?></span>
          </td>
        <?php } else { ?>
          <td width='65%'></td>
        <?php } ?>
        <td>
          <table class='table' style='font-size:9pt'>
            <tr>
              <td>Tgl. Pembelian</td>
              <td>: <?= date_dmy($row->tgl_spk) ?></td>
            </tr>
            <tr>
              <td>Tgl. Pembayaran</td>
              <td>: <?= date_dmy($row->tgl_pembayaran) ?></td>
            </tr>
            <tr>
              <td>No. SPK</td>
              <td>: <?= $row->id_spk ?></td>
    ...
    <table class="table table-borderedx" style='font-size:11pt'>
      <tr>
        <td width="100%" align="center" colspan="6" style='<?= in_array($id_dealer, $skip_dealer) ? 'color:white;' : '' ?>'><b>KWITANSI</b><br>&nbsp;</td>
      </tr>
      <tr>
