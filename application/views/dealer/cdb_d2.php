                  ...
                  <div class="col-sm-4">      
                    <select class="form-control" name="aktivitas_penjualan" id="aktivitas_penjualan" required>
                      <?php 
                        ...
                        $this->db->order_by('aktivitas_penjualan','ASC');
                        $aktivitas_penjualan = $this->db->get('ms_aktivitas_penjualan');
                        if ($aktivitas_penjualan->num_rows()>0) {
                          echo "<option value=''>-choose-</option>";
                          foreach ($aktivitas_penjualan->result() as $rs) {
                            echo "<option value='$rs->id_aktivitas_penjualan'>$rs->aktivitas_penjualan</option>";
                          }
                        }
                      ?>
                    </select>
