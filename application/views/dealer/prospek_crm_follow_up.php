                ...
                <div class="box-body">
                  ...
                  <?php if (isset($row)) { ?>
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <input type="hidden" class="form-control" name="input_from_crm" value="<?= isset($row) ? $row->input_from : '' ?>" readonly>
                        <input type="hidden" class="form-control" name="leads_id" value="<?= isset($row) ? $row->leads_id : '' ?>" readonly>
                  ...
                  <div class="row">
                    ...
                    <?php $this->load->view('dealer/prospek_crm_modal_interaksi'); ?>
                  </div>
          ...
          methods: {
            ...
            addDetails: function() {
              ...
              if (this.detail.kodeHasilStatusFollowUp == '1') {
                ...
                if (this.detail.status_prospek == '') {
                  alert("Silahkan Tentukan Status Prospek");
                  return false;
                }
              }
              if (this.detail.tgl_next_fol_up != '') {
