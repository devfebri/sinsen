 ...
 <body onload="kirim_data()">
    ...
    ?>
                 ...
                 <div class="box-header with-border">
                     <h3 class="box-title">
                         <a href="dealer/guest_book">
                             <button <?php echo $this->m_admin->set_tombol($id_menu,$group,"select"); ?>
                                 class="btn bg-maroon btn-flat margin"><i class="fa fa-eye"></i> View Data</button>
                         </a>
                     </h3>
        ...
        ?>
                     <div class="row">
                         <div class="col-md-12">
                             <form class="form-horizontal" action="dealer/guest_book/save_new" method="post"
                                 enctype="multipart/form-data">
                                 <button class="btn btn-block btn-warning btn-flat" disabled> DATA GUEST BOOK </button>
                                 <br>
                                 <div class="box-body">
                                     <div class="form-group">
                                         ...
                                         <div class="col-sm-4">
                                             <input type="text" class="form-control" required
                                                 placeholder="Nama Konsumen" id="nama_konsumen" name="nama_konsumen">
                                         </div>
                                         ...
                                         <div class="col-sm-4">
                                             <select class="form-control select2" name="id_tipe_kendaraan"
                                                 id="id_tipe_kendaraan" onchange="getWarna()">
                      ...
                      ?>
                                     ...
                                     <div class="form-group">
                                         ...
                                         <div class="col-sm-4">
                                             <input type="number" class="form-control" required placeholder="No HP"
                                                 id="no_hp" name="no_hp">
                                         </div>
                      ...
                      ?>
                                         ...
                                         <div class="col-sm-4">
                                             <input type="text" class="form-control" placeholder="Akun Instargram"
                      ...
                      ?>
                                         ...
                                         <div class="col-sm-4">
                                             <input type="text" class="form-control" placeholder="Akun Facebook"
                                     ...
                                     <div class="form-group">
                                         <label for="inputEmail3" class="col-sm-2 control-label">Rencana
                                             Pembayaran</label>
                                         <div class="col-sm-4">
                                     ...
                                     <div class="box-footer">
                                         ...
                                         <div class="col-sm-10">
                                             <button type="submit"
                                                 onclick="return confirm('Are you sure to save all data?')" name="save"
                                                 value="save" class="btn btn-info btn-flat"><i class="fa fa-save"></i>
                                                 Save
                                                 All</button>
                                             <button type="reset" class="btn btn-default btn-flat"><i
                                                     class="fa fa-refresh"></i> Cancel All</button>
                                         </div>
                                     </div><!-- /.box-footer -->
                             </form>
                         </div>
    ...
    ?>
             ...
             <div class="box box-default">
                 <div class="box-header with-border">
                     <h3 class="box-title">
                         <a href="dealer/guest_book">
                             <button class="btn bg-maroon btn-flat margin"><i class="fa fa-chevron-left"></i>
                                 Kembali</button>
                         </a>
                     </h3>
                     <div class="box-tools pull-right">
                     ...
                     <div class="row">
                         <div class="col-md-12">
                             <form class="form-horizontal"
                                 action="dealer/guest_book/update_new/<?php echo $row->id_guest_book ?>" method="post"
                                 enctype="multipart/form-data">
                                 <div class="box-body">
                                     <button class="btn btn-block btn-warning btn-flat" disabled> DATA GUEST BOOK
                                     </button> <br>
                                     ...
                                     <div class="form-group">
                                         ...
                                         <div class="col-sm-4">
                                             <input type="text" class="form-control"
                                                 value="<?php echo $row->nama_konsumen ?>" required
                                                 placeholder="Nama Konsumen" id="nama_konsumen" name="nama_konsumen">
                                         </div>
                                         <input type="hidden" id="id_guest_book" name="id"
                                             value="<?php echo $row->id_guest_book ?>">


                                         <label for="inputEmail3" class="col-sm-2 control-label">Type Motor</label>
                                         <div class="col-sm-4">
                                             <select class="form-control select2" name="id_tipe_kendaraan"
                                                 onchange="getWarna()" id="id_tipe_kendaraan">
                      ...
                      ?>
                                     ...
                                     <div class="form-group">
                                         <label for="inputEmail3" class="col-sm-2 control-label">No HP *</label>
                                         <div class="col-sm-4">
                                             <input type="text" class="form-control" value="<?php echo $row->no_telp ?>"
                                                 required placeholder="No HP" id="no_hp" name="no_hp">
                                         </div>
                      ...
                      ?>
                                     ...
                                     <div class="form-group">
                                         ...
                                         <div class="col-sm-4">
                                             <select class="form-control select2" name="sales" id="id_sales">
                                                 <option value="<?php echo $row->id_karyawan_dealer ?>">- choose -
                                                 </option>
                                                 <?php 
                      $id_dealer = $this->m_admin->cari_dealer();
                      $sales = $this->db->query("SELECT a.id_karyawan_dealer,a.nama_lengkap FROM ms_karyawan_dealer as a, ms_jabatan as b WHERE a.id_jabatan=b.id_jabatan and a.active = 1 AND b.jabatan 
                      ...
                      ?>
                                         ...
                                         <label for="inputEmail3" class="col-sm-2 control-label">Instagram</label>
                                         <div class="col-sm-4">
                                             <input type="text" class="form-control" placeholder="Akun Instagram"
                                                 value="<?php echo $row->instagram ?>" name="instagram">
                                         </div>
                      ...
                      ?>
                                         ...
                                         <div class="col-sm-4">
                                             <input type="text" class="form-control" placeholder="Akun Facebook"
                                                 value="<?php echo $row->facebook ?>" name="facebook">
                                         </div>
                                     ...
                                     <div class="form-group">
                                         ...
                                         <div class="col-sm-4">
                                             <select class="form-control" name="rencana_bayar">
                                                 <option value="<?php echo $row->rencana_bayar ?>">
                                                     <?php echo $row->rencana_bayar ?></option>
                                                 <option>Cash</option>
                                                 <option>Kredit</option>
                                             </select>
                                         </div>
                                 ...
                                 <div class="box-footer">
                                     ...
                                     <div class="col-sm-10">
                                         <button type="submit"
                                             onclick="return confirm('Are you sure to update all data?')" name="save"
                                             value="save" class="btn btn-info btn-flat"><i class="fa fa-save"></i>
                                             Update All</button>
                                         <button type="reset" class="btn btn-default btn-flat"><i
                                                 class="fa fa-refresh"></i> Cancel All</button>
    ...
    ?>
        ...
        ?>
                     <div class="row">
                         <div class="col-md-12">
                             <form class="form-horizontal" action="dealer/guest_book/update" method="post"
                                 enctype="multipart/form-data">
                                 <div class="box-body">
                                     <button class="btn btn-block btn-warning btn-flat" disabled> DATA CUSTOMER
                                     </button> <br>
                                     <div class="form-group">
                                         <input type="hidden" id="id_guest_book" name="id"
                                             value="<?php echo $row->id_guest_book ?>">
                                         <label for="inputEmail3" class="col-sm-2 control-label">ID List
                                             Appointment</label>
                                         <div class="col-sm-4">
                                             <input type="text" name="" readonly
                                                 value="<?= $row->id_list_appointment ?> " class="form-control">
                                         </div>
                                         <label for="inputEmail3" class="col-sm-2 control-label">No HP</label>
                                         <div class="col-sm-4">
                                             <input type="text" class="form-control" value="<?php echo $row->no_hp ?>"
                                                 readonly placeholder="No HP" id="no_hp" name="no_hp">
                                         </div>
                                     </div>
                                     <div class="form-group">
                                         <label for="inputEmail3" class="col-sm-2 control-label">Nama Konsumen</label>
                                         <div class="col-sm-10">
                                             <input type="text" class="form-control"
                                                 value="<?php echo $row->nama_konsumen ?>" readonly
                                                 placeholder="Nama Konsumen" id="nama_konsumen" name="nama_konsumen">
                                         </div>
                                     </div>
                                     <div class="form-group">
                                         ...
                                         <div class="col-sm-10">
                                             <input type="text" class="form-control" placeholder="Alamat"
                                                 value="<?php echo $row->alamat2 ?>" name="alamat" id="alamat" disabled>
                                         </div>
                                     </div>
                                     <div class="form-group">
                                         <label for="inputEmail3" class="col-sm-2 control-label">Jenis Customer</label>
                                         ...
                                         <div class="col-sm-4">
                                             <input type="text" name="" class="form-control"
                                                 value="<?= $row->rencana_bayar ?>" disabled>
                                         </div>
                                     </div>
                                     <button class="btn btn-block btn-primary btn-flat" disabled> DATA KENDARAAN
                                     </button> <br>
                                     <div class="form-group">
                                         <label for="inputEmail3" class="col-sm-2 control-label">Type Motor</label>
                                         <div class="col-sm-4">
                        ...
                        ?>
                                             ...
                                             <input type="text" name="" class="form-control" value="<?= $kendaraan ?>"
                                                 disabled>
                        ...
                        ?>
                                     ...
                                     <div class="form-group">
                                         <label for="inputEmail3" class="col-sm-2 control-label">Deskripsi Warna
                                             Motor</label>
                                         <div class="col-sm-10">
                                             <input type="text" class="form-control" placeholder="Deskripsi Warna Motor"
                                                 value="<?php echo $row->deskripsi_warna ?>" name="deskripsi_warna"
                                                 disabled>
                                         </div>
                                     </div>
                                     <div class="form-group">
                                         <label for="inputEmail3" class="col-sm-2 control-label">Deskripsi Motor
                                             MKT</label>
                                         <div class="col-sm-10">
                                             <input type="text" class="form-control" placeholder="Deskripsi Motor MKT"
                                                 value="<?php echo $row->deskripsi_mkt ?>" name="deskripsi_mkt"
                                                 disabled>
                                         </div>
                                     </div>
                                 </div><!-- /.box-body -->
    ...
    ?>
            ...
            ?>
                         ...
                         <a href="dealer/guest_book/add">
                             <button <?php echo $this->m_admin->set_tombol($id_menu,$group,"insert"); ?>
                                 class="btn bg-blue btn-flat margin"><i class="fa fa-plus"></i> Add New</button>
                    ...
                    <script type="text/javascript">
                      $(document).ready(function(e){
                        ...
                        $('#datatable').DataTable({
                           ...
                           "ajax":{
                                    url :  base_url+'dealer/guest_book/getData',
                                    type : 'POST'
                                  },
                        }); // End of DataTable
     ...
     function simpan_data() {
         ...
         if (id_guest_book == "" || hasil_fu == "") {
             ...
             $.ajax({
                 ...
                 type: "POST",
                 data: "id_guest_book=" + id_guest_book + "&tgl_fu=" + tgl_fu + "&next_fu=" + next_fu +
                     "&hasil_fu=" + hasil_fu + "&status_fu=" + status_fu,
                 cache: false,
                 success: function(msg) {
                     data = msg.split("|");
                     if (data[0] == "nihil") {
         ...
         if (elem) {
             elem.keydown(function() {
                 if (elem.val().length >= 200) {
                     $('#validAlamat').html(
                         '<span style="color: red">Alamat tidak boleh lebih 200 Karakter</span>');
                 } else {
                     $('#validAlamat').html('');
                 }
             });
