...
if ($set == 'cetak') { ?>
  ...
  <body>
    ...
    <table class="table" style="margin-top:20px">
      <tr>
        <td style="font-weight:bold;text-align:left">Penambahan/Pergantian Kode Part Yang Direject</td>
      </tr>
    </table>
    <table class="table table-bordered">
      <tr>
      ...
      <?php $no = 1;
      foreach ($detail_revisi['detail'] as $val2) { ?>
        <tr>
          <td><?= $no ?></td>
          <td><?= $val2->id_part ?></td>
          <td><?= $val2->nama_part ?></td>
          <td align="center"><?= $val2->kuantitas ?></td>
          <td align="right">Rp. <?= mata_uang_rp($val2->harga_saat_dibeli) ?></td>
          <td align="right">Rp. <?= mata_uang_rp($val2->uang_muka) ?></td>
          <td align="right">Rp. <?= mata_uang_rp($val2->subtotal) ?></td>
        </tr>
      <?php $no++;
      } ?>
      <!-- <tr>
    ...
    <table class="table" style="margin-top:20px">
      <tr>
        <td style="font-weight:bold;text-align:left">Kode Part Yang Direject</td>
      </tr>
    </table>
    <table class="table table-bordered">
      <tr>
      ...
      <?php $no = 1;
      foreach ($detail_reject->result() as $val2) { ?>
        <tr>
          <td><?= $no ?></td>
          <td><?= $val2->id_part ?></td>
          <td><?= $val2->nama_part ?></td>
          <td align="center"><?= $val2->kuantitas ?></td>
          <td><?= $val2->alasan_part_revisi_md ?></td>
        </tr>
      <?php $no++;
      } ?>
      <!-- <tr>
    ...
    <table class="table" style="margin-top:20px;">
      <tr>
        <td style="text-align:right">Dibuat Oleh 
      <br><br><br><br><br> <br>
      <?php //echo $nama_user->nama_lengkap ?>
        </td>
      </tr>
      <tr>        <td style="text-align:right;padding: right 20px;"> (Kasir)
        </td></tr>
    </table>
  </body>
