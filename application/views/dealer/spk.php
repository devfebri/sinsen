                  ...
                  <div class="col-sm-4">
                    <input type="text" id="no_kk" class="form-control" maxlength="15" onkeypress="return number_only(event)" placeholder="No KK" name="no_kk" required>                    
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input type="text" class="form-control" maxlength="5" placeholder="Kodepos" id="kodepos" name="kodepos" required>
                          </div>
                        </div>
                        <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Latitude,Longitude"  name="denah_lokasi">                                        
                        ...
                        <span id="tampil_alamat">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-4">
                              <input type="text" class="form-control" maxlength="5" placeholder="Kodepos Sesuai KTP" name="kodepos2" id="kodepos2">
                            </div>
                          </div>
                          <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <select class="form-control" id="sub_pekerjaan" name="sub_pekerjaan" required>
                              <option value="">- choose -</option>
                              <?php
                              foreach ($dt_subpekerjaan->result() as $val) {
                                echo "<option value='$val->id_sub_pekerjaan'>$val->sub_pekerjaan</option>";
                              }
                              ?>
                            </select>
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <label for="inputEmail3" class="col-sm-2 control-label">Email *<br>Jika tidak ada, diisi N</label>
                          <div class="col-sm-4">
                            <!-- <input type="email" maxlength="100" class="form-control" placeholder="Email" id="email" name="email" required> -->
                            <input type="text" maxlength="100" class="form-control" placeholder="Email" id="email" name="email" pattern="((\w+\.)*\w+)@(\w+\.)+(com|kr|net|us|info|biz)"  required="required">
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <button class="btn btn-block btn-info btn-flat" disabled> DATA BBN KENDARAAN </button> <br>
                        
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">Isi Data BBN dari Data Konsumen (Pemohon)?*</label>
                          <div class="col-sm-4">
                            <input type="radio" id="no" name="bpkb_yes" checked="checked" value="no">
                            <label for="no">Tidak</label>
                            <input type="radio" id="yes" name="bpkb_yes" value="yes">
                        ...
                        <div class="form-group"> 
                          ...
                          <div class="col-sm-4">
                            <input type="text" class="form-control"  placeholder="NIK" id='nik_bpkb' name="no_ktp_bpkb" required minlength="16" maxlength="16" onkeypress="return number_only(event)">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input type="text" class="form-control" placeholder="Nama" id="nama_bpkb" name="nama_bpkb" required>
                          </div>
                        </div>
                                   
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">Tempat/Tgl.Lahir BPKB/STNK*</label>
                          <div class="col-sm-4">
                            <input type="text" id="bpkb_stnk_birth_place" class="form-control" placeholder="Tempat Lahir" name="bpkb_stnk_birth_place" required>
                          </div>
                          <div class="col-sm-4">
                            <input type="text" class="form-control tgl_lahir" onchange="cek_umur()" id="tanggal5" placeholder="Tgl Lahir" name="bpkb_stnk_birth_date" required>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" placeholder="Alamat" id='alamat_ktp_bpkb' name="alamat_ktp_bpkb" required>
                          </div>
                        </div>

                        <div class="form-group">     
                          <label for="inputEmail3" class="col-sm-2 control-label">Kelurahan BPKB *</label>
                          <div class="col-sm-4">
                            <input type="hidden" readonly name="id_kelurahan_bpkb" id="id_kelurahan_bpkb">
                            <input required type="text" onpaste="return false" onkeypress="return nihil(event)" name="kelurahan_bpkb" data-toggle="modal" placeholder="Kelurahan BPKB" data-target="#KelurahanmodalBpkb" class="form-control" id="kelurahan_bpkb" onchange="take_kec()" autocomplete="off">
                            <div id="kecBpkb" style="display: none;">
                              <label>Kec. </label><input type="text" class="form-control" id="kecamatan_bpkb" readonly="">
                              <label>Kab. </label><input type="text" class="form-control" id="kabupaten_bpkb" readonly="">
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="col-sm-4">
                      <input id="nama_bpkb" type="text" required class="form-control" placeholder="Nama STNK/BPKB" name="nama_bpkb">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input type="text" onkeypress="return number_only(event)" class="form-control" name="tanda_jadi" id="tanda_jadi" required>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input type="text" class="form-control" maxlength="5" onkeypress="return number_only(event)" placeholder="Kode POS KK" id="kode_pos_kk" name='kode_pos_kk' required>
                          </div>
                        </div>
                        <?php /*
                        <div class="form-group">
...
*/ ?>
            ...
            <script>
              ...
              $('input[type=radio][name=bpkb_yes]').change(function() {
                if (this.value == 'yes') {
                  $('#bpkb_stnk_birth_place').val($('#tempat_lahir').val());
                  $('#tanggal5').val($('#tanggal2').val());
                  $('#nama_bpkb').val($('#nama_konsumen').val());
                  $('#alamat_ktp_bpkb').val($('#alamat').val());
                  $('#nik_bpkb').val($('#no_ktp').val());

                  chooseitemBpkb($('#id_kelurahan').val());                             
                }else if (this.value == 'no') {                  
                  $('#bpkb_stnk_birth_place').val('');
                  $('#tanggal5').val('');
                  $('#nama_bpkb').val('');
                  $('#alamat_ktp_bpkb').val('');
                  $('#nik_bpkb').val('');
                  $('#id_kelurahan_bpkb').val('');
                  $('#kelurahan_bpkb').val('');
                  $('#kecamatan_bpkb').val('');
                  $('#kabupaten_bpkb').val('');
                  $('#kecBpkb').hide();
              ...
              function checkFormat_email() {
                  if (document.getElementById("email").value == '') {
                      alert("Email is required");
                      return false;
                  } else if (!document.getElementById("email").checkValidity() && document.getElementById("email").value !='N') {
          ...
          ?>
            ...
            <div class="box box-default">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <form id="form_" class="form-horizontal" action="dealer/spk/save_gc" method="post" enctype="multipart/form-data">
                      <div class="box-body">
                        <button class="btn btn-block btn-primary btn-flat" disabled> SPK </button> <br>
                        <div class="form-group">
                        ...
                        <span id="tampil_alamat">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-4">
                              <input type="text" class="form-control" maxlength="5" placeholder="Kodepos Sesuai NPWP" id="kodepos2" name="kodepos2">
                            </div>
                          </div>
                          <div class="form-group">
          ...
          ?>
            <div class="box box-default">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <form class="form-horizontal" action="dealer/spk/update_gc" method="post" enctype="multipart/form-data">
                      <div class="box-body">
                        <button class="btn btn-block btn-primary btn-flat" disabled> SPK </button> <br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">Kodepos *</label>
                          <div class="col-sm-4">
                            <input type="text" class="form-control" maxlength="5" placeholder="Kodepos" id="kodepos" name="kodepos" value="<?php echo $row->kodepos ?>" required <?= $readonly ?>>
                          </div>
                          <label for="inputEmail3" class="col-sm-2 control-label">Nama BPKB/STNK</label>
                          <div class="col-sm-4">
                        ...
                        <span id="tampil_alamat">
                          ...
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">Kodepos NPWP</label>
                            <div class="col-sm-4">
                              <input type="text" class="form-control" maxlength="5" placeholder="Kodepos Sesuai NPWP" id="kodepos2" value="<?php echo $row->kodepos2 ?>" name="kodepos2" <?= $readonly ?>>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">Alamat Sesuai NPWP</label>
          ...
          ?>
            <div class="box box-default">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <form class="form-horizontal" action="dealer/spk/save_demo" method="post" enctype="multipart/form-data">
                      <div class="box-body">
                        <button class="btn btn-block btn-primary btn-flat" disabled> SPK </button> <br>
                        <div class="form-group">
                          <input type="hidden" readonly class="form-control" id="id_spk" readonly placeholder="No SPK" name="no_spk">
          ...
          <?php
            ...
            if ($form == 'detail') {
              $readonly = 'readonly';
              $mode_edit = 'false';
              $disabled = 'disabled  style="-webkit-appearance: none; -moz-appearance: none; text-indent: 1px;text-overflow:"';
            }
          ?>
            <script src="<?= base_url("assets/vue/vue.min.js") ?>" type="text/javascript"></script>
            <script src="<?= base_url("assets/vue/accounting.js") ?>" type="text/javascript"></script>
            ...
            <div class="box box-default">
              <div class="box-header with-border">
                <h3 class="box-title">
                  <a href="dealer/spk<?= isset($out) ? '/outstanding' : '' ?>">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <form id="form_" class="form-horizontal" action="dealer/spk/update" method="post" enctype="multipart/form-data">
                      <input type="hidden" id="mode_edit" value="<?php echo $mode_edit ?>">
                      <input type="hidden" id="tipe_customer" value="<?= $row->tipe_customer ?>">
                      <input type="hidden" id="no_spk" value="<?= $row->no_spk ?>">
                      <div class="box-body">
                        <button class="btn btn-block btn-primary btn-flat" disabled> SPK </button> <br>
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">Sales People</label>
                  ...
                  <div class="col-sm-4">
                        ...
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">Kodepos *</label>
                          <div class="col-sm-4">
                            <input type="text" value="<?php echo $row->kodepos ?>" maxlength="5" class="form-control" placeholder="Kodepos" id="kodepos" name="kodepos" required <?= $readonly ?>>
                          </div>
                        </div>
                    ...
                    <input type="text" class="form-control" value="<?php echo $row->denah_lokasi ?>" placeholder="Latitude,Longitude"  name="denah_lokasi">                                        
                        ...
                        <span id="tampil_alamat">
                          ...
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">Kodepos Sesuai KTP</label>
                            <div class="col-sm-4">
                              <input value="<?php echo $row->kodepos2 ?>" type="text" maxlength="5" class="form-control" placeholder="Kodepos Sesuai KTP" name="kodepos2" <?= $readonly ?>>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">Alamat Sesuai KTP</label>
				...
				<?php /* 12-07-2021 : perbaikan status rumah */ ?>
                              <option>Rumah Sendiri</option>
                              <option>Rumah Sewa</option>
                              <option>Rumah Orang Tua</option>
                            </select>
                        ...
                        <div class="form-group">
                          <label for="inputEmail4" class="col-sm-2 control-label">Pekerjaan Saat Ini *</label>
                          <div class="col-sm-4">
                            <select class="form-control" id="sub_pekerjaan" name="sub_pekerjaan" <?= $readonly ?> required>
                              <option value="<?php echo $row->sub_pekerjaan ?>">
                                <?php
                                $dt_cust1    = get_data('ms_sub_pekerjaan','id_sub_pekerjaan',$row->sub_pekerjaan,'sub_pekerjaan');
                                if ($dt_cust1 != '') {
                                  echo $dt_cust1;
                                } else {
                                  echo "- choose -";
                              ...
                              <?php
                              $dt_subpekerjaan = $this->db->query("select required_instansi, id_sub_pekerjaan, sub_pekerjaan, active from ms_sub_pekerjaan where active = '1' order by sub_pekerjaan asc");
                              foreach ($dt_subpekerjaan->result() as $val) {
                                echo "<option value='$val->id_sub_pekerjaan'>$val->sub_pekerjaan</option>";
                              }
                              ?>
                        ...
                        <div class="form-group">
                          ...
                          <label for="inputEmail3" class="col-sm-2 control-label">Email *<br>Jika tidak ada, diisi N</label>
                          <div class="col-sm-4">
                            <input type="text" maxlength="100" class="form-control" value="<?php echo $row->email ?>" placeholder="Email" id="email" name="email" pattern="((\w+\.)*\w+)@(\w+\.)+(com|kr|net|us|info|biz)" required <?= $readonly ?> >
                            <?php /* <input type="email" class="form-control" value="<?php echo $row->email ?>" maxlength="100" placeholder="Email" id="email" name="email" required <?= $readonly ?>> */?>
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">Refferal ID</label>
                        ...
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">Tempat/Tgl.Lahir BPKB/STNK*</label>
                          <div class="col-sm-4">
                            <input type="text" class="form-control" placeholder="Tempat Lahir" name="bpkb_stnk_birth_place" value="<?= $row->bpkb_stnk_birth_place ?>" required <?= $readonly ?>>
                          </div>
                          <div class="col-sm-4">
                            <input type="text" class="form-control tgl_lahir" id="tanggal5" onchange="cek_umur()" value="<?php echo $row->bpkb_stnk_birth_date ?>" placeholder="Tgl Lahir" name="bpkb_stnk_birth_date" required <?= $readonly ?>>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">Kelurahan BPKB *</label>
                          <div class="col-sm-4">
                            <input type="hidden" readonly name="id_kelurahan_bpkb" id="id_kelurahan_bpkb" value="<?= $row->id_kelurahan_bpkb ?>">
                            <input required type="text" value="<?php echo get_data('ms_kelurahan','id_kelurahan',$row->id_kelurahan_bpkb,'kelurahan') ?>" onpaste="return false" onkeypress="return nihil(event)" name="kelurahan_bpkb" <?= $readonly ?> data-toggle="modal" placeholder="Kelurahan BPKB" data-target="#KelurahanmodalBpkb" class="form-control" id="kelurahan_bpkb" onchange="take_kec()" autocomplete="off">
                            <?php if ($row->id_kelurahan_bpkb != ''): ?>
                              <div id="kecBpkb">
                                <?php 
                                $region = explode("-", $this->m_admin->getRegion($row->id_kelurahan_bpkb));
                                 ?>
                                <label>Kec. </label><input type="text" class="form-control" id="kecamatan_bpkb" value="<?php echo $region[5] ?>" readonly="">
                                <label>Kab. </label><input type="text" class="form-control" id="kabupaten_bpkb" value="<?php echo $region[6] ?>" readonly="">
                              </div>

                            <?php else: ?>

                            	<div id="kecBpkb" style="display: none;">
	                                <label>Kec. </label><input type="text" class="form-control" id="kecamatan_bpkb" value="" readonly="">
	                                <label>Kab. </label><input type="text" class="form-control" id="kabupaten_bpkb" value="" readonly="">
                             	</div>
                    ...
                    <button onclick="take_harga()" type="button">generate</button>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-2" v-if="readonly==''">
                            <button style='width:100%' class="btn btn-primary btn-flat" type="button" onclick="get_beli();take_harga()"><i class="fa fa-refresh"></i> Reload Harga</button>
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">Waktu Pengiriman *</label>
                        ...
                        <div class="form-group">
                          ...
                          <?php
                          	 $is_ev = $this->m_admin->checkIsEv($row->id_tipe_kendaraan);
                             if ($is_ev > 0) { ?>
                                  <label for="inputEmail3" class="col-sm-2 control-label">Subsidi Pemerintah</label>
                                  <div class="col-sm-4">
                                    <input type="text" class="form-control" value="Rp. <?php echo mata_uang2($row->subsidi_pemerintah) ?>" placeholder="Subsidi Pemerintah"  <?= $readonly ?>>
                                  </div>
                        ...
                        <div class="form-group">
                          <label for="inputEmail3" class="col-md-offset-6 col-sm-2 control-label">Tanda Jadi *</label>
                          <div class="col-sm-4">
                            <input type="text" onkeypress="return number_only(event)" class="form-control" name="tanda_jadi" id="tanda_jadi" value="<?= $row->tanda_jadi ?>" <?= $readonly ?>>
                          </div>
                        </div>
                        <button class="btn btn-block btn-primary btn-flat" disabled> EVENT </button> <br>
                        <div class="form-group">
                        ...
                        <span id="lbl_cash" v-if="tipe_pembelian=='Cash'">
                          ...
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">Program</label>
                            <div class="col-sm-4">
                              <select class="form-control" name="program_umum" onchange="cek_program_tambahan()" id="program_umum" <?= $readonly ?> <?= $disabled ?>>
                              </select>
                            </div>
                            <label for="inputEmail3" class="col-sm-2 control-label" id="nilai_voucher_lbl">Nilai Voucher</label>
                            <div class="col-sm-4">
                          ...
                          <div class="form-group">
                            <span id="program_gabungan_lbl">
                              <label for="inputEmail3" class="col-sm-2 control-label">Program Gabungan</label>
                              <div class="col-sm-4">
                                <select class="form-control" name="program_gabungan" id="program_gabungan" onchange="getVoucherGabungan()" <?= $readonly ?><?= $disabled ?>>
                                </select>
                              </div>
                            </span>
                            <label for="inputEmail3" class="col-sm-2 control-label">Voucher Tambahan</label>
                        ...
                        <span id="lbl_kredit" v-if="tipe_pembelian=='Kredit'">
                          ...
                          <div class="form-group">
                            ...
                            <label for="inputEmail3" class="col-sm-2 control-label">Program</label>
                            <div class="col-sm-4">
                              <select class="form-control" name="program_umum" id="program_umum" onchange="cek_program_tambahan()" <?= $readonly ?> <?= $disabled ?>>
                                <?php
                                $tgl = date("Y-m-d");
				if($form == 'detail'){
					$cek = $this->db->query("SELECT * FROM tr_sales_program WHERE id_program_md = '$row->program_umum'");
                       		}else{
					$cek = $this->db->query("SELECT * FROM tr_sales_program WHERE '$tgl' BETWEEN periode_awal AND periode_akhir");
                          ...
                          <div class="form-group">
                            ...
                            <span id="program_gabungan_kredit_lbl">
                              <label for="inputEmail3" class="col-sm-2 control-label">Program Gabungan</label>
                              <div class="col-sm-4">
                                <select class="form-control" name="program_gabungan_k" id="program_gabungan_kredit" onchange="getVoucherGabungan(<?php echo $row->program_gabungan ?>)" <?= $disabled ?> >
                                  <?php
                                  // $tgl = date("Y-m-d");
                                  // $cek = $this->db->query("SELECT * FROM tr_sales_program WHERE '$tgl' BETWEEN periode_awal AND periode_akhir AND (jenis_bayar = 'Cash' OR jenis_bayar = 'Cash & Kredit')");
                                  // foreach ($cek->result() as $isi) {
                        ...
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">Kode POS KK *</label>
                          <div class="col-sm-4">
                            <input type="text" class="form-control" maxlength="5" onkeypress="return number_only(event)" placeholder="Kode POS KK" id="kode_pos_kk" name='kode_pos_kk' required value="<?= $row->kode_pos_kk ?>">
                          </div>
                        </div>
                        <?php /*
                        <div class="form-group">
...
*/ ?>
            ...
            <script>
              ...
              function checkFormat_email() {
                  if (document.getElementById("email").value == '') {
                    ...
                    $('#submitBtn').attr('disabled', true);
                    // $('#form_').submit();
                    var response = confirm("Apakah anda yakin ingin melakukan perubahan data ini ??");
                    if (response == true) {
                      $('#submitBtn').attr('disabled', true);
                      $("#form_").submit();
                    }else{
          ...
          ?>
            <div class="box">
              ...
              <div class="box-body">
                ...
                ?>
                <table id="table_spk_dealer" class="table table-bordered table-hover">
                  <thead> 
                    <tr>
            ...
            <script>
              function closePrompt(no_spk) {
                ...
                if (alasan_close != null || alasan_close == "") {
                  window.location = '<?= base_url("dealer/spk/close?id=") ?>' + no_spk + '&alasan_close=' + alasan_close;
                  return false;
                }
                return false
              }
            ...
            <script>
              ...
              $('#table_spk_dealer').DataTable({
                    ...
                    "order": [],
                    "ajax": {
                      "url": "<?php  echo site_url('dealer/spk/fetch_data_spk_datatables')?>",
                        "type": "POST"
                    },  
                  ...
                  <tbody>
                    ...
                    foreach ($dt_spk->result() as $row) {
                      ...
                      if ($row->status_spk == 'input') {
                        ...
                        $tombol = "<a data-toggle='tooltip' $approval onclick=\"return confirm('Are you sure to approve this data?')\" title='Approve' class='btn btn-success btn-xs btn-flat' href='dealer/spk/approve?id=$row->no_spk'><i class='fa fa-check'></i> Approve</a>";
                        $tombol2 = "<a data-toggle='tooltip' $approval onclick=\"return confirm('Are you sure to reject this data?')\" title='Reject' class='btn btn-danger btn-xs btn-flat' href='dealer/spk/reject?id=$row->no_spk'><i class='fa fa-close'></i> Reject</a>";
                        $tombol3 = "<a data-toggle='tooltip' $edit title='Edit' href='dealer/spk/edit?id=$row->no_spk&set=outstanding'><button class='btn btn-flat btn-xs btn-primary'><i class='fa fa-edit'></i> Edit</button></a>";
                        $tombol4 = '';
                        $tombol5 = "<a data-toggle='tooltip' title='Cancel' class='btn btn-danger btn-xs btn-flat' href='dealer/spk/cancel?id=$row->no_spk'><i class='fa fa-close'></i> Cancel</a>";
                        $tombol_cetak = "<a  data-toggle='tooltip' title='Cetak' target='_blank' href='dealer/spk/cetak?id=$row->no_spk'>
                      ...
                      if ($cek_s->num_rows() > 0) {
                        ...
                        if ($status_s == 'rejected' and $tombol3 == "") {
                          $tombol4 = "<a data-toggle='tooltip' title='Edit' href='dealer/spk/edit?id=$row->no_spk'><button $edit class='btn btn-flat btn-xs btn-primary'><i class='fa fa-edit'></i> Edit</button></a>";
                        }
                      }
          ...
          ?>
            ...
            <button class="btn bg-blue btn-flat margin"><i class="fa fa-check"></i> Cek History SPK</button>
                  ...
                  <tbody>
                    ...
                    foreach ($dt_spk->result() as $row) {
                      ...
                      if ($row->status == 'input' || $row->status == null || $row->status == '') {
                        ...
                        $tombol = "<a data-toggle='tooltip' $approval onclick=\"return confirm('Are you sure to approve this data?')\" title='Approve' class='btn btn-success btn-xs btn-flat' href='dealer/spk/approve_gc?id=$row->no_spk_gc'><i class='fa fa-check'></i> Approve</a>";
                        $tombol2 = "<a data-toggle='tooltip' $approval onclick=\"return confirm('Are you sure to reject this data?')\" title='Reject' class='btn btn-danger btn-xs btn-flat' href='dealer/spk/reject_gc?id=$row->no_spk_gc'><i class='fa fa-close'></i> Reject</a>";
                        $tombol3 = "<a href='dealer/spk/edit_gc?id_c=$row->no_spk_gc' data-toggle='tooltip' $edit title='Edit'><button class='btn btn-flat btn-xs btn-primary'><i class='fa fa-edit'></i> Edit</button></a>";
                        $tombol4 = '';
                        $tombol_cetak = "";
                        ...
                        $tombol3 = "<a href='dealer/spk/edit_gc?id_c=$row->no_spk_gc' data-toggle='tooltip' $edit title='Edit'><button class='btn btn-flat btn-xs btn-primary'><i class='fa fa-edit'></i> Edit</button></a>";
                        $tombol4 = "";
                        $tombol_cetak = "<a href='dealer/spk/cetak_gc?id_c=$row->no_spk_gc' $print title='Print' class='btn btn-flat btn-xs btn-warning'><i class='fa fa-print'></i> Cetak SPK</a>";
                        // $tombol5 = "<a data-toggle='tooltip' onclick=\"return confirm('Are you sure to close this data?')\" title='Close' class='btn btn-danger btn-xs btn-flat' href='dealer/spk/close?id=$row->no_spk'><i class='fa fa-close'></i> Close</a>";
                      ...
                      if ($cek_s->num_rows() > 0) {
                        ...
                        $status_s = $rr->status_approval;
                        if ($status_s == 'rejected' and $tombol3 == "") {
                          $tombol4 = "<a data-toggle='tooltip' title='Edit' href='dealer/spk/edit_gc?id_c=$row->no_spk_gc'><button $edit class='btn btn-flat btn-xs btn-primary'><i class='fa fa-edit'></i> Edit</button></a>";
                        }
                      }
              ...
              <tr>
                <td>$no</td>
                <td><a href='" . base_url('dealer/spk/detail_gc?id_c=') . "$row->no_spk_gc'>$row->no_spk_gc</a></td>
                <td>$row->nama_npwp</td>
                <td>$row->no_npwp</td>
                <td>$row->alamat</td>                              
                <td>$status</td>         
          ...
          ?>
            ...
            <tr>
              ...
              <td>$war</td>            
              <td>$row->no_ktp</td>                       
              <td><a  data-toggle='tooltip' title='Cetak' target='_blank' href='dealer/spk/cetak?id=$row->no_spk'>
                  <button $print class='btn btn-flat btn-xs btn-warning'><i class='fa fa-print'></i> Cetak SPK</button>
                </a></td>
            </tr>";
                      $no++;
            ...
            <script>
              $(document).ready(function() {
                $('#tbl_history_gc').DataTable({
                  ...
                  order: [],
                  ajax: {
                    url: "<?= base_url('dealer/spk/fetch_history_gc') ?>",
                    dataSrc: "data",
                    data: function(d) {
                      return d;
                    },
            ...
            <script>
              $(document).ready(function() {
                $('#tbl_outstanding_gc').DataTable({
                  ...
                  order: [],
                  ajax: {
                    url: "<?= base_url('dealer/spk/fetch_outstanding_gc') ?>",
                    dataSrc: "data",
                    data: function(d) {
                      return d;
                    },
            ...
            <script type="text/javascript">
              $(document).ready(function(e){
                ...
                $('#datatable').DataTable({
                   ...
                   "ajax":{
                            url :  base_url+'dealer/spk/get_history_spk',
                            type : 'POST'
                          },
                }); // End of DataTable
          ...
          ?>
            ...
            <div class="box">
              ...
              <div class="box-body">
                <div class="row">
                  <div class="col-md-12">
                    <form class="form-horizontal" id="form_" action="dealer/spk/save_cancel" method="post" enctype="multipart/form-data">
                      <div class="box-body">
                        <div class="form-group">
                          <label for="inputEmail3" class="col-sm-2 control-label">No. SPK</label>
                          <div class="col-sm-4">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <select name="id_reasons" required class="form-control select2" onchange="cekLain(this)">
                        ...
                        <?php if ($row->indent > 0) : ?>
                          <div class="form-group">
                            ...
                            <div class="col-sm-4">
                              <select name="id_alasan_cancel" required class="form-control select2" onchange="cekLainIndent(this)">
      ...
      <div class="modal fade" id="KelurahanmodalBpkb">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              Search Kelurahan
            ...
            <div class="modal-body">
              <table id="table_kel_bpkb" class="table table-bordered table-hover">
                <thead>
                  <tr>
                    <th width="5%">No</th>
                    <th>Kelurahan</th>
	  ...
	  $.ajax({
        ...
        function getSkemaKredit() {
          ...
          $.ajax({
            beforeSend: function() {},
            url: '<?= base_url('dealer/spk/getSkemaKredit') ?>',
            type: "POST",
            data: values,
            cache: false,
            dataType: 'JSON',
        ...
        function chooseitemBpkb(id_kelurahan) {
          document.getElementById("id_kelurahan_bpkb").value = id_kelurahan;
          take_kec_bpkb();
          $("#KelurahanmodalBpkb").modal("hide");
        }

        function take_kec_bpkb() {
          var id_kelurahan = $("#id_kelurahan_bpkb").val();
          $.ajax({
            ...
            success: function(msg) {
              data = msg.split("|");
              $("#kecBpkb").show();
              $("#kecamatan_bpkb").val(data[1]);
              $("#kabupaten_bpkb").val(data[3]);
              $("#kelurahan_bpkb").val(data[6]);
            }
          })
        }
        ...
        function cek_umur() {
          ...
          if (age < 17) {
            ...
            $('.tgl_lahir').val('');
          }else if(birthDate.getFullYear() < 1945){
	...
	function take_selected_event() {
          var id_prospek_gc = $("#id_prospek_gc").val();
          $.ajax({
            url: "<?php echo site_url('dealer/spk/cek_selected_event') ?>",
            type: "POST",
            data: "id_prospek_gc=" + id_prospek_gc,
            cache: false,
            success: function(msg) {
...
<!-- 3 -->
      <script type="text/javascript">
        ...
        $(document).ready(function() {
          //datatables
          table = $('#table_kel_bpkb').DataTable({
            "processing": true, //Feature control the processing indicator.
            "serverSide": true, //Feature control DataTables' server-side processing mode.
            "order": [], //Initial no order.
            // Load data for the table's content from an Ajax source
            "ajax": {
              "url": "<?php echo site_url('dealer/spk/ajax_list_bpkb') ?>",
              "type": "POST"
            },
            //Set column definition initialisation properties.
            "columnDefs": [{
