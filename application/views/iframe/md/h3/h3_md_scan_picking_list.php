                        ...
                        <form class="form-horizontal">
                           <div class="box-body">
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                    <input v-model='picking_list.id_do_sales_order' type="text" class="form-control" disabled>
                                 </div>
                              </div>
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                    <input type="text" readonly class="form-control" v-model="picking_list.tanggal" />
                                 </div>
                              </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                    <input type="text" readonly class="form-control" v-model="picking_list.nama_picker" />
                                 </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-4">
                                    <input type="text" readonly class="form-control" v-model="picking_list.kategori_po" />
                                 </div>
                              ...
                              <div class="form-group">
                                 <label class="col-sm-2 control-label">Start Scan</label>
                                 <div class="col-sm-4">
                                    <input type="text" class="form-control" v-model='picking_list.start_scan' readonly>
                                 </div>
                                 <label class="col-sm-2 control-label">Tipe PO</label>
                                 <div class="col-sm-4">
                                    <input type="text" class="form-control" v-model='picking_list.po_type' readonly>
                                 </div>
                              </div>
                              <div class="form-group">
                                 <label class="col-sm-2 control-label">End Scan</label>
                                 <div class="col-sm-4">
                                    <input type="text" class="form-control" v-model='picking_list.end_scan' readonly>
                                 </div>
                                 <label class="col-sm-2 control-label">Jumlah Koli</label>
                                 <div class="col-sm-4">
                                    <input type="text" class="form-control" v-model='picking_list.jumlah_koli' readonly>
                                 </div>
                              </div>
                              <div class="form-group">
                                 <div class="col-sm-12">
                                    ...
                                    <table id="table" class="table table-condensed table-responsive">
                                       <thead>
                                          <tr class='bg-blue-gradient'>
                                             ...
                                             <th>Kode Part</th>
                                             <th>Nama Part</th>
                                             <th width='5%' class='text-center'>Qty Scan</th>
                                          </tr>
                                       </thead>
                                       <tbody>
                                          <tr v-for="(part, index) in picking_list_parts">
                                             <td class="align-middle">{{ index + 1 }}.</td>
                                          ...
                                          <tr v-if="picking_list_parts.length < 1">
                                             <td class="text-center" colspan="12">Tidak ada data.</td>
                                          </tr>
                                       </tbody>
                                    </table>
            ...
            <script>
               app = new Vue({
                  ...
                  data: {
                     ...
                     picking_list_parts: <?= json_encode($picking_list_parts); ?>,
                  },
                  methods: {
