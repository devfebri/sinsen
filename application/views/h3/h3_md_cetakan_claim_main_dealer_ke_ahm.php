...
<body>
        ...
        <div style='width: 45%; float: left; margin-left: 2%;'>
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td width='60%'><?= $header['id_claim'] ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width='60%'><?= $header['invoice_number'] ?></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div style='width: 100%; border: 1px solid black; padding: 3px 6px; margin-top: 5px;'>
        ...
        <div style='width: 100%; padding-bottom: 5px;'>
            ...
            <div style='width: 25%; float: left;'>
                <?php if($header['packing_ticket'] == 1): ?>
        ...
        <div style='width: 100%; padding-bottom: 5px;'>
            ...
            <div style='width: 50%; float: left;'>
                <?php if($header['lain_lain'] != ''): ?>
                <img style='width: 11px;' src="<?= base_url('assets/panel/icon/checked-checkbox.png') ?>" alt=""> <?= $header['lain_lain'] ?>
                <?php else: ?>
        ...
        <div style='width: 100%; padding-bottom: 5px;'>
            <div style='width: 25%; float: left;'>
                <?php if($header['label_timbangan'] == 1): ?>
