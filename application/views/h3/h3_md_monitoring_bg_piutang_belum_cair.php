          ...
          <div class="col-md-12">
            <form class="form-horizontal" method="post" enctype="multipart/form-data">
              <div class="box-body">
                  ...
                  <div v-bind:class="{ 'has-error': error_exist('referensi') }" class="col-sm-4">                    
                    <div class="input-group">
                      ...
                      <div class="input-group-btn">
                        <button type='button' v-if='!ada_referensi || mode == "detail"' :disabled='mode == "detail"' data-toggle='modal' data-target='#h3_md_referensi_penagihan_pihak_kedua' class="btn btn-flat btn-primary"><i class="fa fa-search" aria-hidden="true"></i></button>
                ...
                <?php $this->load->view('modal/h3_md_referensi_penagihan_pihak_kedua') ?>
                <script>
                  function pilih_referensi(data){
                    app.penagihan.referensi = data.referensi;
                    app.penagihan.tipe_referensi = data.tipe_referensi;
                    app.penagihan.nama_vendor = data.nama_vendor;
                    app.penagihan.nominal_pembayaran = data.nominal_pembayaran;
                    app.penagihan.nomor_bg = data.nomor_bg;
                    app.penagihan.nominal_bg = data.nominal_bg;
                ...
                <div v-bind:class="{ 'has-error': error_exist('no_surat') }" class="form-group">                  
                  ...
                  <div class="col-sm-4">                    
                    <input :disabled='mode == "detail"' type="text" class="form-control" v-model='penagihan.no_surat'>
                ...
                <div v-bind:class="{ 'has-error': error_exist('tgl_surat') }" class="form-group">                  
                  ...
                  <div class="col-sm-4">                    
                    <date-picker :disabled='mode == "detail"' v-model='penagihan.tgl_surat' class='form-control' readonly></date-picker>
                ...
                <div v-bind:class="{ 'has-error': error_exist('tgl_jatuh_tempo') }" class="form-group">                  
                  ...
                  <div class="col-sm-4">                    
                    <date-picker :disabled='mode == "detail"' v-model='penagihan.tgl_jatuh_tempo' class='form-control' readonly></date-picker>
                ...
                <div class="form-group">                  
                  ...
                  <div class="col-sm-4">                    
                    <vue-numeric :disabled='mode == "detail"' currency='Rp' thousand-separator='.' class="form-control" v-model='penagihan.nominal'></vue-numeric>
                  </div>
                </div>
                <div class="form-group">                  
                  <label class="col-sm-2 control-label">Keterangan</label>
                  <div class="col-sm-4">                    
                    <textarea :disabled='mode == "detail"' v-model='penagihan.keterangan' rows="5" class="form-control"></textarea>
                  </div>
                </div>
                <div class="form-group">
                      ...
                      <div class="col-sm-12">
                        ...
                        <table class="table table-condensed table-striped table-hover">
                          ...
                          <tr v-if='penagihan_tujuan.length > 0' v-for='(row, index) in penagihan_tujuan'>
                            ...
                            <td v-if='mode != "detail"'>
                              <button @click.prevent='hapus_vendor(index)' class="btn btn-flat btn-sm btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                            </td>
                          </tr>
      ...
      <div class="box-body">
        <table id="penagihan_datatable" class="table table-bordered table-hover">
          <thead>
            <tr>
              ...
              <th>Jatuh Tempo</th>              
              <th>Nominal Giro</th>              
              <th>Nominal Bank Tujuan</th>              
              <th>Nominal Rek Tujuan</th>              
            </tr>
          </thead>
          <tbody></tbody>
        </table>
        ...
        $(document).ready(function(){
          penagihan_datatable = $('#penagihan_datatable').DataTable({
            ...
            order: [],
            ajax: {
                url: "<?= base_url('api/md/h3/monitoring_bg_piutang_belum_cair') ?>",
                dataSrc: "data",
                type: "POST",
                data: function(d){
                }
