...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="">H3</li>
    <li class="">Reporting ETA Hotline</li>
  ...
  <section class="content">
    <div class="box box-default">
      <div class="box-header with-border">        
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" id="frm" method="post" action= "h3/h3_md_reporting_eta_hotline/downloadReport" enctype="multipart/form-data">
              <div class="box-body">                                                              
    ...
    <?php if($dashboard){?>
      <?php if($report){?>
        ...
        foreach($report->result() as $row){
          // $request_document_part = $this->db->query("SELECT eta_terlama,eta_revisi from tr_h3_dealer_request_document_parts where id_booking='$row->id_booking' and id_part='$row->id_part'")->row();
