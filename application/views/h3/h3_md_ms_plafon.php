                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div v-bind:class="{ 'has-error': error_exist('nilai_penambahan_plafon') }" class="col-sm-4">
                      <vue-numeric :readonly='mode == "detail"' v-model='plafon.nilai_penambahan_plafon' thousand-separator='.' currency='Rp ' class='form-control'></vue-numeric>
                  ...
                  <div class="form-group">
                    ...
                    <div v-bind:class="{ 'has-error': error_exist('nilai_penambahan_sementara') }" class="col-sm-4">
                      <vue-numeric :readonly='mode == "detail"' v-model='plafon.nilai_penambahan_sementara' thousand-separator='.' currency='Rp ' class='form-control'></vue-numeric>
                  ...
                  <div class="form-group">
                    ...
                    <div v-bind:class="{ 'has-error': error_exist('nilai_pengurang_plafon') }" class="col-sm-4">
                      <vue-numeric :readonly='mode == "detail"' v-model='plafon.nilai_pengurang_plafon' thousand-separator='.' currency='Rp ' class='form-control'></vue-numeric>
                  ...
                  <div class="form-group">
                    ...
                    <div v-bind:class="{ 'has-error': error_exist('keterangan') }" class="col-sm-4">
                      <textarea :disabled='mode == "detail"' v-model='plafon.keterangan' rows="3" class="form-control"></textarea>
                    ...
                    <div v-bind:class="{ 'has-error': error_exist('kontribusi') }" class="col-sm-4">
                      <vue-numeric v-if='mode == "detail"' readonly v-model='plafon.total_plafon_baru' thousand-separator='.' currency='Rp ' class='form-control'></vue-numeric>
                      <vue-numeric v-if='mode != "detail"' readonly v-model='total_plafon_baru' thousand-separator='.' currency='Rp ' class='form-control'></vue-numeric>
                  ...
                  <div class="form-group">
                    ...
                    <div v-bind:class="{ 'has-error': error_exist('nilai_po_part') }" class="col-sm-4">
                      <vue-numeric readonly v-model='nilai_po_part' thousand-separator='.' currency='Rp ' class='form-control'></vue-numeric>
                      <small v-if="error_exist('nilai_po_part')" class="form-text text-danger">{{ get_error('nilai_po_part') }}</small>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-offset-6 col-sm-2 control-label">Nilai PO - Oli</label>
                    <div v-bind:class="{ 'has-error': error_exist('nilai_po_oli') }" class="col-sm-4">
                      <vue-numeric readonly v-model='nilai_po_oli' thousand-separator='.' currency='Rp ' class='form-control'></vue-numeric>
                      <small v-if="error_exist('nilai_po_oli')" class="form-text text-danger">{{ get_error('nilai_po_oli') }}</small>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-offset-6 col-sm-2 control-label">Grand Total Nilai PO</label>
                    <div v-bind:class="{ 'has-error': error_exist('grand_total_nilai_po') }" class="col-sm-4">
                      <vue-numeric readonly v-model='grand_total_nilai_po' thousand-separator='.' currency='Rp ' class='form-control'></vue-numeric>
                      <small v-if="error_exist('grand_total_nilai_po')" class="form-text text-danger">{{ get_error('grand_total_nilai_po') }}</small>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <a v-if='mode == "detail" && plafon.status == "Open"' :href="'h3/h3_md_ms_plafon/edit?id=' + plafon.id" class="btn btn-flat btn-sm btn-warning">Edit</a>
                      </div>
                      <div class="col-sm-6 text-right">
                        <button v-if='mode == "detail" && plafon.status == "Open"' class="btn btn-flat btn-sm btn-success" @click.prevent='approve'>Approve</button>
                        <button v-if='mode == "detail" && plafon.status == "Open"' class="btn btn-flat btn-sm btn-danger" @click.prevent='close'>Close</button>
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                              <table class="table table-condensed">
                                ...
                                <tr v-if='rincian_pembayaran.length < 1'>
  ...
  var form_ = new Vue({
      ...
      data: {
        ...
        plafon: {
          ...
          nilai_penambahan_plafon_finance: 0,
          nilai_penambahan_sementara_finance: 0,
          nilai_pengurang_plafon_finance: 0,
          nilai_penambahan_plafon_pimpinan: 0,
          nilai_penambahan_sementara_pimpinan: 0,
          nilai_pengurang_plafon_pimpinan: 0,
          total_plafon_baru: 0,
          nilai_po_part: 0,
          nilai_po_oli: 0,
          approve_at: null,
          approved_finance_at: null,
          approved_pimpinan_at: null,
        },
        tagihan: [],
        sales_orders: [],
        <?php endif; ?>
      ...
      methods:{
        ...
        get_sales_orders: function(){
          this.loading = true;
          axios.get('h3/<?= $isi ?>/get_sales_orders', {
            params: {
              id_dealer: this.plafon.id_dealer,
              id: this.plafon.id,
              mode: this.mode
      ...
      computed: {
        ...
        total_plafon_baru: function(){
          return parseInt(this.sisa_plafon) + parseInt(this.plafon.nilai_penambahan_plafon) + parseInt(this.plafon.nilai_penambahan_sementara) - parseInt(this.plafon.nilai_pengurang_plafon);
        },
        ...
        <script>
          $(document).ready(function() {
            master_plafon = $('#master_plafon').DataTable({
                ...
                order: [],
                ajax: {
                  url: "<?= base_url('api/md/h3/master_plafon') ?>",
                  dataSrc: "data",
                  type: "POST",
                  data: function(d){
                ...
                columns: [
                    ...
                    { 
                      data: 'nilai_penambahan_sementara',
                      width: '130px',
                      render: function(data){
                        if(data != null){
                          return accounting.formatMoney(data, 'Rp ', 0, '.', ',');
            ...
            $('#master_plafon').on('click', 'input[type=checkbox].plafon-checkbox', function(e){
              ...
              id = $(e.target).data('id');
              if(checked){
                axios.get("<?= base_url('api/md/h3/master_plafon/set_plafon_id') ?>", {
                  params: {
                    id: id
                  }
                })
                ...
                axios.get("<?= base_url('api/md/h3/master_plafon/unset_plafon_id') ?>", {
                  params: {
                    id: id
                  }
                })
