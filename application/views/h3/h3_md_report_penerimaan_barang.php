  ...
  <section class="content">
    <div class="box box-default">
      <div class="box-header with-border">        
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" id="frm" method="post" action= "h3/H3_md_report_penerimaan_barang/downloadExcel" enctype="multipart/form-data">
              <div class="box-body">                                                              
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select class="form-control select2" name="type" id="type">
                        <option value="status_closed">Penerimaan Barang Status Closed</option>
                    </select>
                  </div>                                    
                </div> 
                <!-- <div class="form-group">
