...
<form class="form-horizontal" action="h1/wo/save" method="post" enctype="multipart/form-data">                  
  <div class="form-group">                  
    ...
    <div class="col-sm-4">
      <input type="text" name="tgl_checker" value="<?php echo $row->no_so_oil ?>" placeholder="No SO" class="form-control" readonly>
    </div>                  
...
<table id="example2" class="table table-bordered table-hovered myTable1" width="100%">
  ...
  <tbody>
    <?php 
    $dt = $this->db->query("SELECT * FROM tr_so_oil_detail LEFT JOIN ms_part ON tr_so_oil_detail.id_part = ms_part.id_part
