  ...
  <section class="content">   
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="h3/do_spare_part/save" method="post" enctype="multipart/form-data">
              <div class="box-body">              
                ...
                <div class="form-group">                  
                  ...
                  <div class="col-sm-4">                    
                    <input type="text" name="no_do_spare_part" id="no_do_spare_part"  value="<?php echo $row->no_do_spare_part ?>" readonly placeholder="Auto" class="form-control">                    
                  </div>
                ...
                <div class="form-group">                  
                  ...
                  <div class="col-sm-4">                    
                    <input type="text" name="no_so_spare" id="no_so_spare" readonly value="<?php echo $row->no_so_spare ?>" class="form-control">                    
                  </div>
                ...
                <div class="form-group">                  
                  ...
                  <div class="col-sm-4">                    
                    <input type="text" name="tgl_pemenuhan" readonly value="<?php echo $row->nama_lengkap ?>" class="form-control">                    
                  </div>
              ...
              <div class="box-footer">
                ...
                <div class="col-sm-10">
                  ...
                  <button type='button' data-toggle='modal' data-target='.modal_reject' onclick="detail_popup('<?php echo $row->no_do_spare_part ?>')" class='btn btn-danger btn-flat'><i class="fa fa-close"></i> Reject</button>                                                
                </div>
              </div><!-- /.box-footer -->      
              <div class="col-sm-10">
                <div class="form-group">                                    
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          <?php 
          $no=1; 
          foreach($dt_do_spare_part->result() as $row) {            
            ...
            $amount = $this->db->query("SELECT SUM(amount) AS amount FROM tr_create_do_spare_detail WHERE no_do_spare_part = '$row->no_do_spare_part'")->row();            
            echo "          
            <tr>
              <td>$no</td>              
              <td>$row->tgl_so</td>              
              <td>$row->tgl_do</td>              
              <td>$row->no_do_spare_part</td>              
              <td>$row->nama_dealer</td>              
              <td>$row->alamat</td>              
              <td>".mata_uang2($amount->amount)."</td>              
              <td>                
                <a class='btn btn-warning btn-flat btn-xs' href='h3/do_spare_part/detail?id=$row->no_do_spare_part'><i class='fa fa-eye'></i> View</a>                
                <a class='btn btn-success btn-flat btn-xs' href='h3/do_spare_part/cetak?id=$row->no_do_spare_part'><i class='fa fa-print'></i> Cetak</a>
              </td>              
            </tr>";          
          $no++;
          }
...
function detail_popup(no_do_spare_part)
  {
    $.ajax({
         url:"<?php echo site_url('h3/do_spare_part/detail_popup');?>",
         type:"POST",
...
function cek_tampil(){    
  $("#tampil_create").show();
  var no_do_spare_part = $("#no_do_spare_part").val();        
  var xhr;
  if (window.XMLHttpRequest) { // Mozilla, Safari, ...
   ...
   //var data = "birthday1="+birthday1_js;          
    var data = "no_do_spare_part="+no_do_spare_part;
     xhr.open("POST", "h3/do_spare_part/t_detail", true); 
