...
<head>
    ...
    <title>Laporan Penerimaan By Packing Sheet & Amount</title>
    <style>
        @media print {
            @page {
...
<body>
    ...
    <table class="table">
        <tr>
            ...
            <td class='text-bold table-header text-center'>Tgl. Faktur</td>
            <td class='text-bold table-header text-center'>No. Faktur</td>
            ...
            <td class='text-bold table-header text-center'>HET</td>
            <td class='text-bold table-header text-center'>HPP</td>
            <td class='text-bold table-header text-center'>Jumlah Harga</td>
        ...
        <?php foreach($data as $index => $row): ?>
            ...
            <tr>
                ...
                <td class='table-item <?= $borderBottom ? 'border-bottom': null ?>'><?= $item['invoice_date'] ?></td>
                <td class='table-item <?= $borderBottom ? 'border-bottom': null ?>'><?= $item['invoice_number'] ?></td>
                ...
                <td class='table-item <?= $borderBottom ? 'border-bottom': null ?>'><?= $item['het'] ?></td>
                <td class='table-item <?= $borderBottom ? 'border-bottom': null ?>'><?= $item['hpp'] ?></td>
                <td class='table-item <?= $borderBottom ? 'border-bottom': null ?>'><?= $item['jumlah_harga'] ?></td>
