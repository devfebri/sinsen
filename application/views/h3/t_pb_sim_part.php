    ...
    foreach ($sql->result() as $isi) {
      ...
      echo "
        <tr>
          <td>$no</td>
          <td>"; ?>
            <input type='text' id='no_so_part' value='<?php echo $isi->no_so_part ?>' data-toggle='modal' data-target='.modal_detail' id_part='<?php echo $isi->no_so_part ?>' onclick="detail_popup('<?php echo $isi->no_so_part ?>')" placeholder='View' readonly class='form-control isi'>                        
          </td>
          <?php 
          echo "
          <td>$isi->tgl_so</td>
          ...
          <td>
            ...
            <input type='hidden' name='no_so_part_$no' value='$isi->no_so_part'>
