  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="h3/create_do_sim_part/save" method="post" enctype="multipart/form-data">
              <div class="box-body">              
                <div class="form-group">                  
                  <label for="inputEmail3" class="col-sm-2 control-label">No Proses Bagi Barang</label>
                  <div class="col-sm-2">                    
                    <input type="text" name="no_create_do_sim_part" placeholder="Auto" id="no_create_do_sim_part" readonly class="form-control">                    
                  </div>                  
                </div>                 
                <div class="form-group">                  
              ...
              <div class="box-body">              
                ...
                <div class="form-group">                  
                  ...
                  <div class="col-sm-4">                    
                    <select id="id_part" name="id_part" class="form-control select2" onchange="cek_tampil()">
                      ...
                      <?php 
                      $sql = $this->db->query("SELECT * FROM ms_part LIMIT 0,10");
                ...
                <div class="form-group">                                    
                  ...
                  <div class="col-sm-10">
                    <?php 
                    $alasan_reject="";
                    $cek = $this->db->query("SELECT * FROM tr_create_do_sim WHERE no_so_part = '$row->no_so_part'");
                    if($cek->num_rows() > 0){
    ...
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">
          <!-- <a href="h3/create_do_sim_part/add">
          ...
          foreach($dt_pb_sim_part->result() as $row) {            
            ...
            <tr>
              ...
              <td>
                ...
                <a class='btn btn-danger btn-flat btn-xs' href='h3/create_do_sim_part/delete?id=$row->no_so_part&d=$row->no_pb_sim_part'><i class='fa fa-close'></i> Del</a>
                <a class='btn btn-warning btn-flat btn-xs' href='h3/create_do_sim_part/detail?id=$row->no_so_part'><i class='fa fa-eye'></i> View</a>
...
function detail_popup(no_so_part)
  {
    $.ajax({
         url:"<?php echo site_url('h3/create_do_sim_part/detail_popup');?>",
         type:"POST",
...
function auto(){
  var id_dealer = 1;
  $.ajax({
      url : "<?php echo site_url('h3/create_do_sim_part/cari_id')?>",
      type:"POST",
      data:"id_dealer="+id_dealer,   
      cache:false,   
      success: function(msg){ 
        data=msg.split("|");
        $("#no_create_do_sim_part").val(data[0]);                              
      }        
  })
}
function kalikan(){
...
function cek_tampil(){    
  ...
  if (window.XMLHttpRequest) { // Mozilla, Safari, ...
   ...
   //var data = "birthday1="+birthday1_js;          
    var data = "no_so_part="+no_so_part+"&id_part="+id_part+"&kelompok_part="+kelompok_part;                           
     xhr.open("POST", "h3/create_do_sim_part/t_detail", true); 
