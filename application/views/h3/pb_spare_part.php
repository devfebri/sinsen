  ...
  <section class="content">
    ...
    <div class="box box-default">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" action="h3/pb_spare_part/save" method="post" enctype="multipart/form-data">
              <div class="box-body">              
                <div class="form-group">                  
                  <label for="inputEmail3" class="col-sm-2 control-label">No Proses Bagi Barang</label>
                  <div class="col-sm-2">                    
                    <input type="text" name="no_pb_spare_part" placeholder="Auto" id="no_pb_spare_part" readonly class="form-control">                    
                  </div>                  
                </div>                 
                <div class="form-group">                  
            ...
            <form class="form-horizontal" action="h3/pb_spare_part/save" method="post" enctype="multipart/form-data">
              <div class="box-body">              
                <div class="form-group">                  
                  ...
                  <div class="col-sm-4">                    
                    <input type="text" name="no_po" readonly value="<?php echo $row->id_pb_spare_part ?>" placeholder="Auto" class="form-control">                    
                  </div>
                ...
                <div class="form-group">
                  <table id="myTable1" class="table myt order-list" border="0">     
                    ...
                    <tbody>            
                      ...
                      $sql2 = $this->db->query("SELECT tr_pb_spare_part_detail.*,ms_part.nama_part,ms_part.id_part FROM tr_pb_spare_part_detail LEFT JOIN ms_part ON tr_pb_spare_part_detail.id_part = ms_part.id_part
                        WHERE tr_pb_spare_part_detail.id_pb_spare_part = '$row->id_pb_spare_part'");
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <table id="example2" class="table table-bordered table-hover">
          ...
          <?php 
          $no=1; 
          foreach($dt_pb_spare_part->result() as $row) {            
            $amount = $this->db->query("SELECT SUM(amount) AS amount FROM tr_pb_spare_part_detail WHERE no_pb_spare_part = '$row->no_pb_spare_part'")->row();
              // <td>
              //   <a class='btn btn-warning btn-flat btn-xs' href='h3/pb_spare_part/detail?id=$row->no_pb_spare_part'><i class='fa fa-eye'></i> View</a>
              // </td>              
            echo "          
            <tr>
              <td>$no</td>              
              <td>$row->no_pb_spare_part</td>              
...
function detail_popup(no_so_spare)
  {
    $.ajax({
         url:"<?php echo site_url('h3/pb_spare_part/detail_popup');?>",
         type:"POST",
         data:"no_so_spare="+no_so_spare,
         cache:false,
...
function auto(){
  var id_dealer = 1;
  $.ajax({
      url : "<?php echo site_url('h3/pb_spare_part/cari_id')?>",
      type:"POST",
      data:"id_dealer="+id_dealer,   
      cache:false,   
      success: function(msg){ 
        data=msg.split("|");
        $("#no_pb_spare_part").val(data[0]);                              
      }        
  })
}
  ...
  if (window.XMLHttpRequest) { // Mozilla, Safari, ...
   ...
   //var data = "birthday1="+birthday1_js;          
    var data = "start_date="+start_date+"&end_date="+end_date;                           
     xhr.open("POST", "h3/pb_spare_part/t_detail", true); 
