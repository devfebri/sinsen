              ...
              <form class="form-horizontal">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div v-bind:class="{ 'has-error': error_exist('nilai_penambahan_plafon') }" class="col-sm-4">
                      <vue-numeric :readonly='mode == "detail"' v-model='plafon.nilai_penambahan_plafon_pimpinan' thousand-separator='.' currency='Rp ' class='form-control'></vue-numeric>
                  ...
                  <div class="form-group">
                    ...
                    <div v-bind:class="{ 'has-error': error_exist('nilai_penambahan_sementara') }" class="col-sm-4">
                      <vue-numeric :readonly='mode == "detail"' v-model='plafon.nilai_penambahan_sementara_pimpinan' thousand-separator='.' currency='Rp ' class='form-control'></vue-numeric>
                  ...
                  <div class="form-group">
                    ...
                    <div v-bind:class="{ 'has-error': error_exist('nilai_pengurang_plafon') }" class="col-sm-4">
                      <vue-numeric :readonly='mode == "detail"' v-model='plafon.nilai_pengurang_plafon_pimpinan' thousand-separator='.' currency='Rp ' class='form-control'></vue-numeric>
                  ...
                  <div class="form-group">
                    ...
                    <div v-bind:class="{ 'has-error': error_exist('keterangan_pimpinan') }" class="col-sm-4">
                      <textarea :disabled='mode == "detail"' rows="5" v-model='plafon.keterangan_pimpinan' class="form-control"></textarea>
                      <small v-if="error_exist('keterangan_pimpinan')" class="form-text text-danger">{{ get_error('keterangan_pimpinan') }}</small>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div v-bind:class="{ 'has-error': error_exist('kontribusi') }" class="col-sm-4">
                      <vue-numeric readonly v-model='plafon.nilai_po_part' thousand-separator='.' currency='Rp ' class='form-control'></vue-numeric>
                      <small v-if="error_exist('kontribusi')" class="form-text text-danger">{{ get_error('kontribusi') }}</small>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div v-bind:class="{ 'has-error': error_exist('kontribusi') }" class="col-sm-4">
                      <vue-numeric readonly v-model='plafon.nilai_po_oli' thousand-separator='.' currency='Rp ' class='form-control'></vue-numeric>
                      <small v-if="error_exist('kontribusi')" class="form-text text-danger">{{ get_error('kontribusi') }}</small>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <a v-if='mode == "detail" && plafon.status == "Approved by Finance"' :href="'h3/<?= $isi ?>/edit?id=' + plafon.id" class="btn btn-flat btn-sm btn-warning">Edit</a>
                      </div>
                      <div class="col-sm-6 text-right">
                        <button v-if='mode == "detail" && plafon.status == "Approved by Finance"' class="btn btn-flat btn-sm btn-success" @click.prevent='approve'>Approve</button>
                        <button v-if='mode == "detail" && plafon.status == "Approved by Finance"' class="btn btn-flat btn-sm btn-danger" @click.prevent='close'>Close</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <table class="table-condensed table">
                  ...
                  <tr v-if='sales_orders.length > 0' v-for='(sales_order, index) of sales_orders'>
                    ...
                    <td>
                      <input :disabled='mode != "insert"' type="checkbox" true-value='1' false-value='0' v-model='sales_order.checked'>
                    </td>
                  </tr>
  ...
  var form_ = new Vue({
      ...
      methods:{
        <?= $form ?>: function(){
          post = _.pick(this.plafon, [
            ...
            'total_plafon_baru','nilai_po_part','nilai_po_oli', 'keterangan', 'keterangan_pimpinan',
          ]);
          ...
          post.sales_orders = _.map(this.sales_orders, function(sales_order){
            return _.pick(sales_order, ['id_sales_order']);
          });
      ...
      computed: {
        ...
        total_plafon_baru: function(){
          return parseInt(this.sisa_plafon) + parseInt(this.plafon.nilai_penambahan_plafon_pimpinan) + parseInt(this.plafon.nilai_penambahan_sementara_pimpinan) - parseInt(this.plafon.nilai_pengurang_plafon_pimpinan);
        },
        ...
        grand_total_nilai_po: function(){
          return parseInt(this.plafon.nilai_po_part) + parseInt(this.plafon.nilai_po_oli);
        },
      }
  });
</script>
        ...
        <script>
          $(document).ready(function() {
            master_plafon = $('#master_plafon').DataTable({
                ...
                order: [],
                ajax: {
                  url: "<?= base_url('api/md/h3/master_plafon_pimpinan') ?>",
                  dataSrc: "data",
                  type: "POST",
                  data: function(d){
                ...
                columns: [
                    ...
                    { 
                      data: 'nilai_penambahan_plafon_pimpinan',
                      width: '130px',
                      render: function(data){
                        if(data != null){
                          return accounting.formatMoney(data, 'Rp ', 0, '.', ',');
                    ...
                    { 
                      data: 'nilai_penambahan_sementara_pimpinan',
                      width: '130px',
                      render: function(data){
                        if(data != null){
                          return accounting.formatMoney(data, 'Rp ', 0, '.', ',');
                    ...
                    { 
                      data: 'nilai_pengurang_plafon_pimpinan',
                      width: '130px',
                      render: function(data){
                        if(data != null){
                          return accounting.formatMoney(data, 'Rp ', 0, '.', ',');
            ...
            $('#master_plafon').on('click', 'input[type=checkbox].plafon-checkbox', function(e){
              ...
              id = $(e.target).data('id');
              if(checked){
                axios.get("<?= base_url('api/md/h3/master_plafon_pimpinan/set_plafon_id') ?>", {
                  params: {
                    id: id
                  }
                })
                ...
                axios.get("<?= base_url('api/md/h3/master_plafon_pimpinan/unset_plafon_id') ?>", {
                  params: {
                    id: id
                  }
                })
