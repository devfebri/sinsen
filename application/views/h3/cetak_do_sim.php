...
<body>
	...
	<table class="table">
		<tr>
			<td colspan="2" align="center" style="font-size: 15pt"><b>DO SIM PART</b></td>
		</tr>		
	</table><br>	
	...
	<table width="100%" border="0">		
		...
		<tr>
			<td>No DO</td><td>:</td>
			<td><?php echo $sql->no_do_sim_part ?></td><td></td>
		...
		<tr>
			<td>No SO</td><td>:</td>
			<td><?php echo $sql->no_so_part ?></td><td></td>			
		</tr>
		<tr>
			<td colspan="7">
			    ...
			    $sql2 = $this->db->query("SELECT * FROM tr_create_do_sim_detail LEFT JOIn ms_part ON tr_create_do_sim_detail.id_part = ms_part.id_part 			
