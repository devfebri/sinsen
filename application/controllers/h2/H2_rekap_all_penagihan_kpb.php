...
class H2_rekap_all_penagihan_kpb extends CI_Controller
{

  var $folder = "h2/laporan";
  var $page   = "h2_rekap_all_penagihan_kpb";
  var $title  = "Rekapan All Penagihan KPB";
  ...
  public function index()
  {
    if (isset($_GET['cetak'])) {
      ...
      $data['details'] = $this->m_lap->getRekapAllPenagihanKPB($filter);
      // send_json($data);
