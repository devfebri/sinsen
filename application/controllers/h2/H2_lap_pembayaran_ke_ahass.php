...
class H2_lap_pembayaran_ke_ahass extends CI_Controller
{

  var $folder = "h2/laporan";
  var $page   = "h2_lap_pembayaran_ke_ahass";
  var $title  = "Laporan Pembayaran Ke AHASS";
  ...
  public function index()
  {
    if (isset($_GET['cetak'])) {
      ...
      $data['details'] = $this->m_lap->getLaporanPembayaranKeAHASS($filter);
      // send_json($data);
