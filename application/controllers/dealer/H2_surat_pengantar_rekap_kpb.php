...
class H2_surat_pengantar_rekap_kpb extends CI_Controller
{

  var $folder = "dealer";
  var $page   = "h2_surat_pengantar_rekap_kpb";
  var $title  = "Surat Pengantar Rekap KPB";
  ...
  public function make_query($recordsFiltered = null)
  {
    ...
    if ($recordsFiltered == true) {
      $filter['select'] = 'count';
      return $this->m_fin->getRekapKPB($filter)->row()->count;
    } else {
