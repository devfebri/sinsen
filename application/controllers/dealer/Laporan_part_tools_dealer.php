<?php
class Laporan_part_tools_dealer extends CI_Controller{
  var $folder =   "dealer/laporan";
  var $page    =    "laporan_part_tools_dealer";
  var $title  =   "Laporan Part Tools Dealer";
  ...
  public function index()
  {
    if (isset($_GET['cetak'])) {
      ...
      $data['detail'] = $this->db->query("select part.id_part,part.nama_part,part.kelompok_part,stok.stock from ms_part part left join ms_h3_dealer_stock stok on part.id_part =stok.id_part where part.kelompok_part ='TL' and stok.stock>0 and stok.id_dealer ='{$filter['id_dealer']}'");
