...
class H23_laporan_harian_ahass extends CI_Controller
{

  var $folder =   "dealer/laporan";
  var $page    =    "h23_laporan_harian_ahass";
  var $title  =   "Laporan Harian AHASS";
  ...
  public function index()
  {
    if (isset($_GET['cetak'])) {
      ...
      $data['details'] = $this->m_lap->getLaporanHarianAHASS($filter);
