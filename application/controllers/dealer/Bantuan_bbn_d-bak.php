...
class Bantuan_bbn_d extends CI_Controller {
  ...
  var $title  =   "Bantuan BBN";
	...
	{				
		...
		$id = $this->input->get("id");		
		$ds['status'] 			= "waiting_approval";
		$ds['updated_at'] 	= $waktu;
		$ds['updated_by'] 	= $login_id;
		$this->m_admin->update("tr_bantuan_bbn_luar",$ds,"id_bantuan_bbn_luar",$id);								
		$_SESSION['pesan'] 	= "Data has been updated successfully";
		$_SESSION['tipe'] 	= "success";		
		echo "<meta http-equiv='refresh' content='0; url=".base_url()."dealer/bantuan_bbn_d/index?p=luar_provinsi	'>";				
	}
	...
	{				
		...
		if($isi=='joint_promo'){			
			...
			$da['nama_gadis_ibu'] 		= $this->input->post("nama_gadis_ibu");		
			$da['id_pekerjaan'] 		= $this->input->post("id_pekerjaan");		
