...
class Hasil_survey extends CI_Controller
{
...

	{
		...
		// $this->db->select("prospek.leads_id,spk.tgl_pengiriman,spk.no_hp,spk.no_spk,prospek.input_from");
		...
		// 	$last_status_ce_apps = $this->mokita_model->last_tracking($cek_spk->no_spk);
		// 	$array_post = [
		// 		'AppsOrderNumber'   => '',
		// 		'DmsOrderNumber'    => '',
