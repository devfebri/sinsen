...
class Dms_h23_queue_management extends CI_Controller
{

  var $folder = "dealer";
  var $page   = "dms_h23_queue_management";
  var $title  = "Queue Management";
  ...
  public function make_query($recordsFiltered = null)
  {
    ...
    if ($recordsFiltered == true) {
      return $this->m_dms->getH23QueuePitManagement($filter)->num_rows();
    } else {
      return $this->m_dms->getH23QueuePitManagement($filter)->result();
    }
  }
}
