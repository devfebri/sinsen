...
class M_list_appoinment extends CI_Controller {

    var $tables =   "tr_prospek";	
		var $folder =   "dealer";
		var $page		=		"m_list_appoinment";
    var $pk     =   "id_prospek";
    var $title  =   "Monitor List Appointment";
	...
	{				
		...
		$data['dt_list'] = $this->db->query("SELECT * FROM tr_prospek LEFT JOIN ms_karyawan_dealer 
			ON tr_prospek.id_karyawan_dealer = ms_karyawan_dealer.id_karyawan_dealer WHERE tr_prospek.id_dealer = '$id_dealer' 
			ORDER BY tr_prospek.id_prospek DESC");						
		$this->template($data);	
