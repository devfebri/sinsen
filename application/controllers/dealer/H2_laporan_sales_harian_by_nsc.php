...
class H2_laporan_sales_harian_by_nsc extends CI_Controller
{

  var $folder =   "dealer/laporan";
  var $page    =    "h2_laporan_sales_harian_by_nsc";
  var $title  =   "Laporan Sales Harian By NSC";
  ...
  public function index()
  {
    if (isset($_GET['cetak'])) {
      ...
      $data['details'] = $this->m_lap->getLaporanSalesHarianByNSC($filter)->result();
