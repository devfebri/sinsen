<?php
class Laporan_bulanan_bengkel_dealer extends CI_Controller{
  var $folder =   "dealer/laporan";
  var $page    =    "laporan_bulanan_bengkel_dealer";
  ...
  public function index()
  {
    if (isset($_GET['cetak'])) {
      ...
      $filter = [
        'start_date' => $this->db->escape_str($params->start_date),
        'end_date' => $this->db->escape_str($params->end_date),
        'id_dealer'=>$this->db->escape_str($params->id_dealer),
      ];
      ...
      if ($this->db->escape_str($params->tipe) == 'preview') {
