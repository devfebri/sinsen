...
class Laporan_aging_bpkb extends CI_Controller {
	
	var $folder =   "dealer/laporan";
	var $page		=		"laporan_aging_bpkb";
	var $title  =   "Laporan Aging Schedule BPKB";
	...
	{				
      ...
      $html = $this->load->view('dealer/laporan/laporan_aging_bpkb', $data, true);
