...
class Laporan_aging_stnk extends CI_Controller {
	
	var $folder =   "dealer/laporan";
	var $page		=		"laporan_aging_stnk";
	var $title  =   "Laporan Aging Schedule STNK";
	...
	{				
      ...
      $html = $this->load->view('dealer/laporan/laporan_aging_stnk', $data, true);
