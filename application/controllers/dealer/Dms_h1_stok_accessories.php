...
class Dms_h1_stok_accessories extends CI_Controller
{

  var $folder = "dealer";
  var $page   = "dms_h1_stok_accessories";
  var $title  = "Stok Accessories";
  ...
  public function make_query($recordsFiltered = null)
  {
    ...
    if ($recordsFiltered == true) {
      return $this->m_stock->getAccessories($filter)->num_rows();
    } else {
      return $this->m_stock->getAccessories($filter)->result();
    }
  }
}
