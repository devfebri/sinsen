...
class Rekap_pengeluaran_frame extends CI_Controller {
	
	var $folder =   "dealer/laporan";
	var $page		=		"rekap_pengeluaran_frame";
	...
	{				
      ...
      $html = $this->load->view('dealer/laporan/rekap_pengeluaran_frame', $data, true);
