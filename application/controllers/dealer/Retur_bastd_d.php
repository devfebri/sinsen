...
class Retur_bastd_d extends CI_Controller {
    var $tables =   "tr_prospek";	
	var $folder =   "dealer";
	var $page	=	"retur_bastd_d";
    var $pk     =   "id_prospek";
    var $title  =   "Retur BASTD oleh MD (Reject MD)";
	...
	{				
		...
		$data['dt_bastd']   = $this->db->query("SELECT * FROM tr_faktur_stnk WHERE status_faktur = 'rejected' AND id_dealer='$id_dealer'");						
		$this->template($data);	
