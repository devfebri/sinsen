...
class H23_laporan_sales_kelompok_part extends CI_Controller
{

  var $folder =   "dealer/laporan";
  var $page    =    "h23_laporan_sales_kelompok_part";
  var $title  =   "Laporan Sales Kelompok Produk";
  ...
  public function index()
  {
    if (isset($_GET['cetak'])) {
      ...
      $data['details'] = $this->m_lap->getLaporanSalesKelompokPart($filter);
