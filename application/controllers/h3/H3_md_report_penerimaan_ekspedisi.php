...
class H3_md_report_penerimaan_ekspedisi extends Honda_Controller
{
	protected $folder = "h3";
	protected $page   = "h3_md_report_penerimaan_ekspedisi";
	protected $title  = "Report Penerimaan Ekspedisi";
