...
// TODO: Pelunasan berita acara penerimaan barang baru tampilan
class H3_md_pelunasan_berita_acara_penerimaan_barang extends Honda_Controller {

	protected $folder = "h3";
    protected $page   = "h3_md_pelunasan_berita_acara_penerimaan_barang";
