...
class H3_md_purchase_urgent extends Honda_Controller {

	protected $folder = "h3";
    protected $page   = "h3_md_purchase_urgent";
    protected $title  = "Purchase Urgent";
	...
	{		
		...
		$this->load->model('h3_md_purchase_urgent_model', 'purchase_urgent');
		$this->load->model('h3_md_purchase_urgent_parts_model', 'purchase_urgent_parts');
	...
	public function index(){
		$data['mode'] = 'index';
		$data['set'] = 'index';
		$data['purchase_urgent'] = $this->purchase_urgent->all();
		$this->template($data);
	}
