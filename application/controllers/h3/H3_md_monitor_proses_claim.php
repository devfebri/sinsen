...
class H3_md_monitor_proses_claim extends Honda_Controller {

	protected $folder = "h3";
    protected $page   = "h3_md_monitor_proses_claim";
    protected $title  = "Monitor Proses Claim";
	...
	public function index(){
		$data['mode'] = 'index';
		$data['set'] = 'index';
		$data['claim_ahm'] = $this->claim_ahm->all();
		$this->template($data);
	}
