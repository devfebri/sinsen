...
class Panel extends CI_Controller
{
	...
	public function cetak_wo_html()
	{
		$this->load->model('m_h2_work_order', 'm_wo');
		$params = [
        'id_user' => 499,
        'id_dealer' => 103,
        'id_sa_form' => "00888/211204/SA-FORM/03335",
        'save_server' => false
      ];
      echo $this->m_wo->cetak_wo_html($params);
	}
...
// 		print_r( $this->session->userdata());
	...
	public function login()
	{
		...
		if(date('Y-m-d H:i') >='2024-02-19 21:01' && $username!='admin'){
			$_SESSION['pesan'] 	= "Masih ada maintenance";
			$_SESSION['tipe'] 	= "danger";
			echo "<meta http-equiv='refresh' content='0; url=" . base_url() . "panel'>";
		}else{
			if ($kode == $mycaptcha) {
