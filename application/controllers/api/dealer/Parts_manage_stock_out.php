...
class Parts_manage_stock_out extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($records as $each) {
            $sub_arr = (array) $each;
            $sub_arr['action'] = $this->load->view('additional/action_parts_manage_stock_out', [
    ...
    public function make_query()
    {
        ...
        ->select('concat("Rp ", format(p.harga_md_dealer, 0, "ID_id")) as harga_beli')
