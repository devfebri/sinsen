...
class Kabupaten_filter_sales_order_index extends CI_Controller {
    ...
    public function index() {
        ...
        foreach ($rows as $row) {
            $sub_array = (array) $row;
            $sub_array['action'] = $this->load->view('additional/md/h3/action_kabupaten_filter_sales_order_index', [
