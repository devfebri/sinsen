...
class Part_filter_online_stock_dealer_index extends CI_Controller {
    ...
    public function index() {
        ...
        foreach ($this->db->get()->result_array() as $row) {
            $row['action'] = $this->load->view('additional/md/h3/action_part_filter_online_stock_dealer_index', [
