...
class Kelompok_part_sales_campaign_detail_poin extends CI_Controller {
    ...
    public function index() {
        ...
        foreach ($rows as $row) {
            $sub_array = (array) $row;
            $sub_array['action'] = $this->load->view('additional/md/h3/action_kelompok_part_sales_campaign_detail_poin', [
