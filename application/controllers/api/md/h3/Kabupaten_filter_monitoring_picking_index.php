...
class Kabupaten_filter_monitoring_picking_index extends CI_Controller {
    ...
    public function index() {
        ...
        foreach ($rows as $row) {
            $sub_array = $row;
            $sub_array['action'] = $this->load->view('additional/md/h3/action_kabupaten_filter_monitoring_picking_index', [
