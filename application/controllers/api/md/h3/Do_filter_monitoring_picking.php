...
class Do_filter_monitoring_picking extends CI_Controller {
    ...
    public function index() {
        ...
        foreach ($rows as $row) {
            $sub_array = $row;
            $sub_array['action'] = $this->load->view('additional/md/h3/action_do_filter_monitoring_picking', [
    ...
    public function get_record_total(){
        return $this->db->from('tr_h3_md_do_sales_order')->count_all_results();
    }
}
