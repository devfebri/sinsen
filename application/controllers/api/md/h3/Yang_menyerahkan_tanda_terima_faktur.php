...
class Yang_menyerahkan_tanda_terima_faktur extends CI_Controller {
    ...
    public function index() {
        ...
        foreach ($this->db->get()->result_array() as $row) {
            $row['action'] = $this->load->view('additional/md/h3/action_yang_menyerahkan_tanda_terima_faktur', [
