...
class Picking_list_filter_monitoring_picking_index extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($this->db->get()->result_array() as $row) {
            $row['action'] = $this->load->view('additional/md/h3/action_picking_list_filter_monitoring_picking_index', [
