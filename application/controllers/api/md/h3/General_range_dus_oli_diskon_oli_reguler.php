...
class General_range_dus_oli_diskon_oli_reguler extends CI_Controller {
    ...
    public function index() {
        ...
        foreach ($fetch_data as $row) {
            $sub_array = (array) $row;
            $sub_array['action'] = $this->load->view('additional/md/h3/action_general_range_dus_oli_diskon_oli_reguler', [
