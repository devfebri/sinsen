...
class Diketahui_berita_acara_penyerahan_faktur extends CI_Controller {
    ...
    public function index() {
        ...
        foreach ($rows as $row) {
            $sub_array = (array) $row;
            $sub_array['action'] = $this->load->view('additional/md/h3/action_diketahui_berita_acara_penyerahan_faktur', [
