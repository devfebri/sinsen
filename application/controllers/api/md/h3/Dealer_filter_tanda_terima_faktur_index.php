...
class Dealer_filter_tanda_terima_faktur_index extends CI_Controller {
    ...
    public function index() {
        ...
        foreach ($rows as $row) {
            $sub_array = (array) $row;
            $sub_array['action'] = $this->load->view('additional/md/h3/action_dealer_filter_tanda_terima_faktur_index', [
