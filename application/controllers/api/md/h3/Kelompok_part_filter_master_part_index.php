...
class Kelompok_part_filter_master_part_index extends CI_Controller {
    ...
    public function index() {
        ...
        foreach ($this->db->get()->result_array() as $row) {
            $row = (array) $row;
            $row['action'] = $this->load->view('additional/md/h3/action_kelompok_part_filter_master_part_index', [
