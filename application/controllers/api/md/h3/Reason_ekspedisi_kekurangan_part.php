...
class Reason_ekspedisi_kekurangan_part extends CI_Controller
{
    ...
    public function make_query()
    {
        ...
        ->where('pbr.id_penerimaan_barang_item', $this->input->post('id_penerimaan_barang_item_for_reason_ekspedisi'))
