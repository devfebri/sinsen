...
class Dealer_resmi extends CI_Controller {
    ...
    public function index() {
        ...
        foreach ($rows as $row) {
            $sub_array = (array) $row;
            $sub_array['action'] = $this->load->view('additional/md/h3/action_dealer_resmi', [
    ...
    public function make_query() {
        ...
        ->from('ms_dealer as d')
        ->where('d.active = 1')
        ->where('d.kode_dealer_ahm is not null')
        ->where('d.kode_dealer_ahm_link is not null')
        ;
    }
