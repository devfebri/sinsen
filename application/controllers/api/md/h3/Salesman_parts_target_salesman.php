...
class Salesman_parts_target_salesman extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($records as $each) {
            $sub_arr = (array) $each;
            $sub_arr['action'] = $this->load->view('additional/md/h3/action_salesman_parts_target_salesman', [
    ...
    public function make_query()
    {
        ...
        ->where('kd.id_dealer', $this->input->post('id_dealer'))
        ;
    }
