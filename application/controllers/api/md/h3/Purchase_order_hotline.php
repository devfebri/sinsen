...
class Purchase_order_hotline extends CI_Controller

{
    ...
    public function make_query()
    {
        ...
        ->join('ms_dealer as d', 'd.id_dealer = po_dealer.id_dealer')
        ->join('tr_h3_dealer_request_document as rd', 'rd.id = po_dealer.id_booking_int')
        ->join('ms_customer_h23 as customer', 'customer.id_customer_int = rd.id_customer_int')
