...
class Satuan extends CI_Controller {
		...
		var $tables 	=   "ms_satuan";	
		var $folder 	=   "master";
		var $page			=		"satuan";
		var $pk     	=   "id_satuan";
		var $title  	=   "Master Data Satuan Barang";
...
$name = $this->session->userdata('nama');
	...
	{		
		...
		if($cek == 0){
			...
			echo "<meta http-equiv='refresh' content='0; url=".base_url()."master/satuan/add'>";			
		}else{
	...
	{		
		...
		$id 			= $this->input->get('id');
		$d 				= array($pk=>$id);		
		$data['dt_satuan'] = $this->m_admin->kondisi($tabel,$d);
		$data['isi']    = $this->page;		
		$data['title']	= $this->title;		
		$data['set']	= "edit";									
		$this->template($data);	
