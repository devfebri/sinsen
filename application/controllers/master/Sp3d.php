...
class Sp3d extends CI_Controller {

    var $tables =   "ms_sp3d";	
		var $folder =   "master";
		var $page		=		"sp3d";
    var $pk     =   "no_sp3d";
    var $title  =   "Master Data SP3D";
...
$name = $this->session->userdata('nama');
	...
	{				
		...
		$data['set']		= "view";
		$data['dt_sp3d'] = $this->m_admin->getAll($this->tables);
		$this->template($data);	
	}
	public function add()
	{				
	...
	{		
		...
		if($cek == 0){
			...
			$data['tgl_sp3d'] 					= $this->input->post('tgl_sp3d');		
			$data['berlaku_sd'] 				= $this->input->post('berlaku_sd');				
			...
			echo "<meta http-equiv='refresh' content='0; url=".base_url()."master/sp3d/add'>";
		}else{
	...
	{		
		...
		if($cek_approval == 'salah'){
			...
			echo "<meta http-equiv='refresh' content='0; url=".base_url()."master/sp3d'>";
		}
	}
	...
	{		
		...
		$id 				= $this->input->get('id');
		$d 					= array($pk=>$id);		
		$data['dt_sp3d'] = $this->m_admin->kondisi($tabel,$d);
