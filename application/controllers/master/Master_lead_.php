...
$name = $this->session->userdata('nama');
	...
	{				
		...
		$data['set']	= "view";
		$dq = "SELECT ms_master_lead_detail.*,ms_dealer.nama_dealer FROM ms_master_lead_detail INNER JOIN ms_dealer ON ms_master_lead_detail.id_dealer=ms_dealer.id_dealer";
