...
class Kategori extends CI_Controller {
    ...
    var $tables =   "ms_kategori";	
		var $folder =   "master";
		var $page		=		"kategori";
    var $pk     =   "id_kategori";
    var $title  =   "Master Data Kategori";
...
$name = $this->session->userdata('nama');
	...
	{		
		...
		if($cek == 0){
			...
			echo "<meta http-equiv='refresh' content='0; url=".base_url()."master/kategori/add'>";
		}else{
	...
	{		
		...
		$id 				= $this->input->get('id');
		$d 					= array($pk=>$id);		
		$data['dt_kategori'] = $this->m_admin->kondisi($tabel,$d);
