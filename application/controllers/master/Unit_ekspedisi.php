...
class Unit_ekspedisi extends CI_Controller {

    var $tables =   "ms_unit_transporter";	
		var $folder =   "master";
		var $page		=		"unit_ekspedisi";
    var $pk     =   "id_unit_transporter";
    var $title  =   "Master Data Unit Ekspedisi";
...
$name = $this->session->userdata('nama');
	...
	{		
		...
		if($cek == 0){
			...
			echo "<meta http-equiv='refresh' content='0; url=".base_url()."master/unit_ekspedisi/add'>";
		}else{
	...
	{		
		...
		if($cek_approval == 'salah'){
			...
			echo "<meta http-equiv='refresh' content='0; url=".base_url()."master/unit_ekspedisi'>";
		}
	}
