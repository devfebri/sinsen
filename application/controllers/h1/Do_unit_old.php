...
class Do_unit extends CI_Controller {
	...
	{				
		...
		$data['set']	= "view";		
		$data['dt_do'] = $this->db->query("SELECT * FROM tr_do_po INNER JOIN ms_dealer ON tr_do_po.id_dealer = ms_dealer.id_dealer");	
...
///---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	{		
		...
		$no_do_suggest = $this->cari_id_real($source);		
		$no_do 			= $no_do_suggest;
