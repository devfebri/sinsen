...
class Cetak_faktur extends CI_Controller {
	...
	function get_data_generate_ulang($tgl_mohon_samsat)
	{
		return $get_data = $this->db->query("SELECT * FROM(
					SELECT tgl_mohon_samsat, no_faktur,tr_pengajuan_bbn_detail.no_mesin,no_rangka,id_tipe_kendaraan,id_warna,id_kelurahan,kelurahan,kecamatan,kabupaten,(SELECT tahun_produksi FROM tr_fkb WHERE no_mesin_spasi=tr_pengajuan_bbn_detail.no_mesin) AS tahun_produksi,nama_konsumen,no_ktp,alamat,nama_ibu,tgl_ibu,pekerjaan,tgl_jual,biaya_bbn 
					FROM tr_pengajuan_bbn_detail
					WHERE tgl_mohon_samsat='$tgl_mohon_samsat' AND status_bbn='generated'
					UNION
					SELECT tgl_samsat AS tgl_mohon_samsat, no_faktur, tr_bantuan_bbn.no_mesin,no_rangka,id_tipe_kendaraan,id_warna,id_kelurahan,kelurahan,kecamatan,kabupaten,tahun_produksi,nama_konsumen,no_ktp,alamat,nama_ibu,tgl_ibu,pekerjaan, tgl_samsat AS tgl_jual,biaya_bbn FROM tr_bantuan_bbn
					WHERE tr_bantuan_bbn.tgl_samsat='$tgl_mohon_samsat'
 ...
 //                          WHERE tr_faktur_stnk_detail.no_bastd = '$no_bastd' ORDER BY tr_scan_barcode.tipe_motor ASC");
	...
	// 	}		
	// 	$_SESSION['tipe'] 	= "success";		
	// 	echo "<meta http-equiv='refresh' content='0; url=".base_url()."h1/cetak_faktur/check?id=".$no_bastd."'>";				
	// }
 ...
 //        	$html = $this->load->view('h1/cetak_faktur_cetak', $data, true);
 ...
 //        }
	...
	// 	$this->load->view("h1/t_generatecetak_faktur",$data);
 ...
 //       // head	  
	...
	//   // $pdf->Image(base_url().'/assets/panel/images/STNK LAMA-1.jpg', 0, 0, 209.6);
	//   $pdf->SetFont('COURIER','',12);
	//   $pdf->SetXY(12,55);
	...
	//   //Lama
	//   $pdf->SetXY(46,73); //+2
	//   $pdf->Cell(103, 5, $r->merk, 0, 0, 'L');
	//   $pdf->Cell(80, 5, $r->warna_samsat, 0, 1, 'L');
	//   $pdf->SetX(46);
	...
	//   $pdf->SetXY(46,162);
	//   $pdf->Cell(103, 5, $r->nama_konsumen, 0, 1, 'L');
	//   $pdf->SetX(46);
	//   $pdf->MultiCell(55, 5, $r->alamat ,0,'T',false);
