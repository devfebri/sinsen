...
class Laporan_penjualan_bulanan extends CI_Controller {
	
	var $folder =   "h1/laporan";
	var $page		=		"laporan_penjualan_bulanan";	
	var $title  =   "Laporan Penjualan Bulanan";
	...
	{				
      ...
      $html = $this->load->view('h1/laporan/laporan_penjualan_bulanan', $data, true);
