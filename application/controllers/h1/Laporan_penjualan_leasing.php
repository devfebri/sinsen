...
class Laporan_penjualan_leasing extends CI_Controller {
	
	var $folder =   "h1/laporan";
	var $page		=		"laporan_penjualan_leasing";	
	var $title  =   "Laporan Penjualan Leasing";
	...
	{				
      ...
      $html = $this->load->view('h1/laporan/laporan_penjualan_leasing', $data, true);
