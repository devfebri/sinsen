...
class Penerimaan_unit extends CI_Controller {
	...
	{				
		...
		$data['set']	= "view";
		$data['dt_penerimaan_unit'] = $this->db->query("SELECT * FROM tr_penerimaan_unit WHERE status <> 'close' and tgl_penerimaan > '2019-12-01' ORDER BY id_penerimaan_unit DESC");		
