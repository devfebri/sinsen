...
class H1_md_penerimaan_kas_harian extends CI_Controller
{

  var $folder = "h1/laporan";
  var $page   = "h1_md_penerimaan_kas_harian";
  ...
  public function __construct()
  {
    ...
    $this->load->model('h1_md_penerimaan_kas_harian_model', 'm_fin');
  ...
  public function index()
  {
    if (isset($_GET['cetak'])) {
      ...
      $filter = [
        ...
        // 'tgl_pembayaran2' => date_ymd($params->tgl_pembayaran2),
      ...
      $data['title']  = $this->title;
      $data['set']    = "view";
      $data['dt_dealer'] = $this->m_fin->getDataDealer();
      $this->template($data);
    }
  }
