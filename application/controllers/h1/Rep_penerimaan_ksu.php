...
class Rep_penerimaan_ksu extends CI_Controller {
	
	var $folder =   "h1/report";
	var $page		=		"rep_penerimaan_ksu";	
	var $isi		=		"laporan_3";	
	...
	{						
		...
		$data['dt_vendor']	= $this->db->query("SELECT * FROM ms_vendor WHERE active = 1 AND id_vendor_type = 'EKS'");
		$this->template($data);		    	    
	}		
	...
	{		
		...
		$this->load->view('h1/report/template/temp_penerimaan_ksu',$data);
	}
}