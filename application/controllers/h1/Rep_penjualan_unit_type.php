...
class Rep_penjualan_unit_type extends CI_Controller {
	
	var $folder =   "h1/report";
	var $page		=		"rep_penjualan_unit_type";	
	var $isi		=		"laporan_1";	
	var $title  =   "Data Penjualan Unit per Type";
	...
	{						
		...
		$data['dt_dealer'] = $this->db->query("SELECT * FROM ms_dealer WHERE active = 1 ORDER BY nama_dealer ASC");		
		$this->template($data);		    	    
	}		
	public function	download(){				
		...
		$this->load->view("h1/report/template/temp_penjualan_unit_type",$data);
	}	
}