...
class Tagihan_dari_bj extends CI_Controller {

    var $tables =   "tr_proses_bbn";	
    var $tables_detail =   "tr_proses_bbn_detail";	
		var $folder =   "h1";
		var $page		=		"tagihan_dari_bj";
    var $pk     =   "no_invoice";
    var $title  =   "Tagihan Dari BJ";
	...
	public function detail()
	{
		...
		$data['dt_detail'] = $this->db->query("SELECT tr_pengajuan_bbn_detail.*,ms_tipe_kendaraan.tipe_ahm,ms_warna.*,$this->tables_detail.* FROM $this->tables_detail 				
