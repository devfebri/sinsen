...
class Rep_intransit extends CI_Controller {
	
	var $folder =   "h1/report";
	var $page		=		"rep_intransit";	
	var $isi		=		"laporan_1";	
	var $title  =   "Data Intransit Unit";
	...
	{						
		...
		$data['dt_warna'] = $this->db->query("SELECT * FROM ms_warna ORDER BY ms_warna.warna ASC");
		$this->template($data);		    	    
	}		
	public function	download(){				
		...
		$this->load->view("h1/report/template/temp_intransit",$data);
	}	
}