...
class Rep_penjualan_unit_dealer extends CI_Controller {
	
	var $folder =   "h1/report";
	var $page		=		"rep_penjualan_unit_dealer";	
	var $isi		=		"laporan_4";	
	var $title  =   "Penjualan Unit Dealer";
	...
	{								
		...
		$this->load->view('h1/report/template/temp_penjualan_unit_dealer',$data);
	}
}