...
class Aktual_sales_bbn extends CI_Controller {
	
	var $folder =   "h1/laporan";
	var $page		=		"aktual_sales_bbn";	
	var $title  =   "Laporan Aktual Sales BBN";
	...
	{				
      ...
      $html = $this->load->view('h1/laporan/aktual_sales_bbn', $data, true);
    ...
    $data['id_dealer']              = $this->input->post('id_dealer');            
		$this->load->view('h1/laporan/sales_v_bbn_excel',$data);
	}		
	public function	tes(){
		$mpdf                           = $this->pdf->load();
      $mpdf->allow_charset_conversion =true;  // Set by default to TRUE
