...
class M_business_control_h1 extends CI_Model
{
  ...
  function get_claim_md($id_dealer = null, $id_program_md = null)
  {
    $result = $this->db->query("SELECT id_claim_sp,tr_claim_dealer.id_dealer,tr_claim_dealer.id_program_md,tr_sales_program.id_program_ahm,periode_awal,periode_akhir,kode_dealer_md,nama_dealer
        ...
        ");
    return $result;
    // return $this->db->query("SELECT id_claim_sp,tr_claim_sales_program.id_program_md,
    //     id_program_ahm,tr_sales_program.periode_awal,tr_sales_program.periode_akhir,
    //     ms_dealer.kode_dealer_md,nama_dealer,ms_dealer.id_dealer
    //     FROM tr_claim_sales_program 
    //     JOIN tr_sales_program ON tr_sales_program.id_program_md=tr_claim_sales_program.id_program_md
    //     JOIN ms_dealer ON ms_dealer.id_dealer=tr_claim_sales_program.id_dealer
    //     $where
    //     ORDER BY tr_claim_sales_program.created_at DESC
    //   ");
  }
  ...
  public function get_program($grup_ahm = null)
  {
    ...
    $get_program = $this->db->query("SELECT id_program_md,id_program_ahm,judul_kegiatan,created_at FROM tr_sales_program
        $where
  ...
  {
    return $detail     = $this->db->query("SELECT *,tr_sales_order.no_mesin FROM tr_claim_dealer 
  ...
  function get_syarat_claim($id_claim, $id_program_md)
  {
    return $get_syarat = $this->db->query("SELECT tr_claim_dealer_syarat.id_claim,tr_claim_dealer_syarat.id,tr_claim_dealer_syarat.id_syarat_ketentuan,checklist_dealer,checklist_reject_md,tr_claim_dealer_syarat.alasan_reject,   
        tr_sales_program_syarat.syarat_ketentuan
  ...
  public function fetch_data($id_dealer, $start, $length, $search, $order = null, $limit = null, $id_program_md, $id_program_ahm, $filter_status = null, $status_in = null)
  {
    ...
    $order_by  = 'ORDER BY tr_claim_dealer.id_program_md,nama_dealer ASC';
    $searchs   = "WHERE 1=1 ";
    $having = '';
