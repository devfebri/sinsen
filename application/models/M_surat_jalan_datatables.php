...
class M_surat_jalan_datatables extends CI_Model
{
    ...
    {   
        ...
        $this->db->where("tr_surat_jalan.status != 'cancel' and tr_surat_jalan.status !='close'");
    ...
    public function count_all()
    {
        ...
        $this->db->from('tr_surat_jalan');
        $this->db->join('ms_dealer', 'tr_surat_jalan.id_dealer = ms_dealer.id_dealer');
        // $this->db->where_not_in('tr_surat_jalan.status', $array);
        $this->db->where("tr_surat_jalan.status != 'cancel' and tr_surat_jalan.status !='close'");
